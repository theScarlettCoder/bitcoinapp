! function (t) {
    ...
    ! function () {
        function t(t, e) {
            ...
            if (0 === t.indexOf(".")) {
                var i = e.split("/"),
                    ...
                    r = 0,
                    a = 0;
                t: for (var h = 0; s > h; h++) switch (o[h]) {
                    case "..":
                        if (!(n > r)) break t;
                        r++, a++;
                        break;
        ...
        function o(e) {
            function i(i, r) {
                ...
                i instanceof Array && (r = r || function () {}, r.apply(this, n(i, r, e)))
            }
            var o = {};
            return i
        }
        ...
        function n(i, o, n) {
            for (var a = [], h = r[n], l = 0, d = Math.min(i.length, o.length); d > l; l++) {
                var c, p = t(i[l], n);
                switch (p) {
                    case "require":
                        c = h && h.require || e;
    ...
    }(), i("echarts/chart/scatter", ["require", "./base", "../util/shape/Symbol", "../component/axis", "../component/grid", "../component/dataZoom", "../component/dataRange", "../config", "zrender/tool/util", "zrender/tool/color", "../chart"], function (t) {
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this.refresh(n)
        }
        var i = t("./base"),
            o = t("../util/shape/Symbol");
        t("../component/axis"), t("../component/grid"), t("../component/dataZoom"), t("../component/dataRange");
        var n = t("../config");
        n.scatter = {
            zlevel: 0,
            z: 2,
        ...
        return e.prototype = {
            ...
            _buildShape: function () {
                ...
                for (var e, i, o, s, a = this.component.legend, h = [], l = 0, d = t.length; d > l; l++)
                    if (e = t[l], i = e.name, e.type === n.CHART_TYPE_SCATTER) {
                        if (t[l] = this.reformOption(t[l]), this.legendHoverLink = t[l].legendHoverLink || this.legendHoverLink, this._sIndex2ShapeMap[l] = this.query(e, "symbol") || this._symbol[l % this._symbol.length], a) {
                            if (this.selectedMap[i] = a.isSelected(i), this._sIndex2ColorMap[l] = r.alpha(a.getColor(i), .5), o = a.getItemShape(i)) {
                                var s = this._sIndex2ShapeMap[l];
                                o.style.brushType = s.match("empty") ? "stroke" : "both", s = s.replace("empty", "").toLowerCase(), s.match("rectangle") && (o.style.x += Math.round((o.style.width - o.style.height) / 2), o.style.width = o.style.height), s.match("star") && (o.style.n = s.replace("star", "") - 0 || 5, s = "star"), s.match("image") && (o.style.image = s.replace(new RegExp("^image:\\/\\/"), ""), o.style.x += Math.round((o.style.width - o.style.height) / 2), o.style.width = o.style.height, s = "image"), o.style.iconType = s, a.setItemShape(i, o)
                            }
                        } else this.selectedMap[i] = !0, this._sIndex2ColorMap[l] = r.alpha(this.zr.getColor(l), .5);
                        this.selectedMap[i] && h.push(l)
                    } this._buildSeries(h), this.addShapeList()
            },
            _buildSeries: function (t) {
                if (0 !== t.length) {
                    for (var e, i, o, n, s, r, a, h, l = this.series, d = {}, c = 0, p = t.length; p > c; c++)
                        if (e = t[c], i = l[e], 0 !== i.data.length) {
                            s = this.component.xAxis.getAxis(i.xAxisIndex || 0), r = this.component.yAxis.getAxis(i.yAxisIndex || 0), d[e] = [];
                            for (var u = 0, g = i.data.length; g > u; u++) o = i.data[u], n = this.getDataFromOption(o, "-"), "-" === n || n.length < 2 || (a = s.getCoord(n[0]), h = r.getCoord(n[1]), d[e].push([a, h, u, o.name || ""]));
                            this.xMarkMap[e] = this._markMap(s, r, i.data, d[e]), this.buildMark(e)
            ...
            _markMap: function (t, e, i, o) {
                for (var n, s = {
                        ...
                        counter1: 0,
                        average1: 0
                    }, r = 0, a = o.length; a > r; r++) n = i[o[r][2]].value || i[o[r][2]], s.min0 > n[0] && (s.min0 = n[0], s.minY0 = o[r][1], s.minX0 = o[r][0]), s.max0 < n[0] && (s.max0 = n[0], s.maxY0 = o[r][1], s.maxX0 = o[r][0]), s.sum0 += n[0], s.counter0++, s.min1 > n[1] && (s.min1 = n[1], s.minY1 = o[r][1], s.minX1 = o[r][0]), s.max1 < n[1] && (s.max1 = n[1], s.maxY1 = o[r][1], s.maxX1 = o[r][0]), s.sum1 += n[1], s.counter1++;
            ...
            _buildPointList: function (t) {
                var e, i, o, n, s = this.series;
                for (var r in t)
                    if (e = s[r], i = t[r], e.large && e.data.length > e.largeThreshold) this.shapeList.push(this._getLargeSymbol(e, i, this.getItemStyleColor(this.query(e, "itemStyle.normal.color"), r, -1) || this._sIndex2ColorMap[r]));
                    else
                        for (var a = 0, h = i.length; h > a; a++) o = i[a], n = this._getSymbol(r, o[2], o[3], o[0], o[1]), n && this.shapeList.push(n)
            },
            _getSymbol: function (t, e, i, o, n) {
                ...
                if (l) {
                    if (s = isNaN(h[2]) ? this._sIndex2ColorMap[t] : l.getColor(h[2]), !s) return null
                } else s = this._sIndex2ColorMap[t];
                var d = this.getSymbolShape(a, t, h, e, i, o, n, this._sIndex2ShapeMap[t], s, "rgba(0,0,0,0)", "vertical");
            ...
            getMarkCoord: function (t, e) {
                var i, o = this.series[t],
                    n = this.xMarkMap[t],
                    s = this.component.xAxis.getAxis(o.xAxisIndex),
                    r = this.component.yAxis.getAxis(o.yAxisIndex);
                if (!e.type || "max" !== e.type && "min" !== e.type && "average" !== e.type) i = ["string" != typeof e.xAxis && s.getCoordByIndex ? s.getCoordByIndex(e.xAxis || 0) : s.getCoord(e.xAxis || 0), "string" != typeof e.yAxis && r.getCoordByIndex ? r.getCoordByIndex(e.yAxis || 0) : r.getCoord(e.yAxis || 0)];
                else {
                    var a = null != e.valueIndex ? e.valueIndex : 1;
                    i = [n[e.type + "X" + a], n[e.type + "Y" + a], n[e.type + "Line" + a], n[e.type + a]]
                }
                return i
            },
            refresh: function (t) {
        ...
        }, s.inherits(e, i), t("../chart").define("scatter", e), e
    }), i("echarts/chart/gauge", ["require", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "../util/accMath", "zrender/tool/util", "../chart"], function (t) {
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this.refresh(n)
        }
        var i = t("./base"),
        ...
        return e.prototype = {
            ...
            _buildShape: function () {
                ...
                for (var e = 0, i = t.length; i > e; e++) t[e].type === l.CHART_TYPE_GAUGE && (this.selectedMap[t[e].name] = !0, t[e] = this.reformOption(t[e]), this.legendHoverLink = t[e].legendHoverLink || this.legendHoverLink, this._buildSingleGauge(e), this.buildMark(e));
                this.addShapeList()
            },
            _buildSingleGauge: function (t) {
                ...
                }, this._paramsMap[t].totalAngle = this._paramsMap[t].startAngle - this._paramsMap[t].endAngle, this._colorMap(t), this._buildAxisLine(t), this._buildSplitLine(t), this._buildAxisTick(t), this._buildAxisLabel(t), this._buildPointer(t), this._buildTitle(t), this._buildDetail(t)
            },
            _buildAxisLine: function (t) {
                var e = this.series[t];
                if (e.axisLine.show)
                    for (var i, o, n = e.min, s = e.max - n, r = this._paramsMap[t], a = r.center, h = r.startAngle, l = r.totalAngle, c = r.colorArray, p = e.axisLine.lineStyle, u = this.parsePercent(p.width, r.radius[1]), g = r.radius[1], f = g - u, m = h, _ = 0, y = c.length; y > _; _++) o = h - l * (c[_][0] - n) / s, i = this._getSector(a, f, g, o, m, c[_][1], p, e.zlevel, e.z), m = o, i._animationAdd = "r", d.set(i, "seriesIndex", t), d.set(i, "dataIndex", _), this.shapeList.push(i)
            },
            _buildSplitLine: function (t) {
                var e = this.series[t];
                if (e.splitLine.show)
                    for (var i, o, n, r = this._paramsMap[t], a = e.splitNumber, h = e.min, l = e.max - h, d = e.splitLine, c = this.parsePercent(d.length, r.radius[1]), p = d.lineStyle, u = p.color, g = r.center, f = r.startAngle * Math.PI / 180, m = r.totalAngle * Math.PI / 180, _ = r.radius[1], y = _ - c, x = 0; a >= x; x++) i = f - m / a * x, o = Math.sin(i), n = Math.cos(i), this.shapeList.push(new s({
                        zlevel: e.zlevel,
                        z: e.z + 1,
                        hoverable: !1,
                        style: {
                            ...
                            xEnd: g[0] + n * y,
                            yEnd: g[1] - o * y,
                            strokeColor: "auto" === u ? this._getColor(t, h + l / a * x) : u,
                            lineType: p.type,
                            lineWidth: p.width,
                ...
                if (e.axisTick.show)
                    for (var i, o, n, r = this._paramsMap[t], a = e.splitNumber, h = e.min, l = e.max - h, d = e.axisTick, c = d.splitNumber, p = this.parsePercent(d.length, r.radius[1]), u = d.lineStyle, g = u.color, f = r.center, m = r.startAngle * Math.PI / 180, _ = r.totalAngle * Math.PI / 180, y = r.radius[1], x = y - p, v = 0, b = a * c; b >= v; v++) v % c !== 0 && (i = m - _ / b * v, o = Math.sin(i), n = Math.cos(i), this.shapeList.push(new s({
                        ...
                        style: {
                            ...
                            xEnd: f[0] + n * x,
                            yEnd: f[1] - o * x,
                            strokeColor: "auto" === g ? this._getColor(t, h + l / b * v) : g,
                            lineType: u.type,
                            lineWidth: u.width,
            ...
            _buildAxisLabel: function (t) {
                var e = this.series[t];
                if (e.axisLabel.show)
                    for (var i, o, s, r, a = e.splitNumber, h = e.min, l = e.max - h, d = e.axisLabel.textStyle, p = this.getFont(d), u = d.color, g = this._paramsMap[t], f = g.center, m = g.startAngle, _ = g.totalAngle, y = g.radius[1] - this.parsePercent(e.splitLine.length, g.radius[1]) - 5, x = 0; a >= x; x++) r = c.accAdd(h, c.accMul(c.accDiv(l, a), x)), i = m - _ / a * x, o = Math.sin(i * Math.PI / 180), s = Math.cos(i * Math.PI / 180), i = (i + 360) % 360, this.shapeList.push(new n({
                        zlevel: e.zlevel,
                        z: e.z + 1,
                        hoverable: !1,
                        style: {
            ...
            _buildPointer: function (t) {
                ...
                if (e.pointer.show) {
                    var i = e.max - e.min,
                        ...
                        c = this._getValue(t);
                    c = c < e.max ? c : e.max;
                    var p = (s.startAngle - s.totalAngle / i * (c - e.min)) * Math.PI / 180,
                    ...
                    d.pack(g, this.series[t], t, this.series[t].data[0], 0, this.series[t].data[0].name, c), this.shapeList.push(g), this.shapeList.push(new a({
                        zlevel: e.zlevel,
                        z: e.z + 2,
                        hoverable: !1,
                        style: {
                ...
                if (e.title.show) {
                    ...
                    if ("" !== o) {
                        ...
                        this.shapeList.push(new n({
                            zlevel: e.zlevel,
                            z: e.z + (Math.abs(d - l.center[0]) + Math.abs(c - l.center[1]) < 2 * a.fontSize ? 2 : 1),
                            hoverable: !1,
                            style: {
                                x: d,
                                y: c,
            ...
            _buildDetail: function (t) {
                ...
                if (e.detail.show) {
                    var i = e.detail,
                        ...
                        h = this._paramsMap[t],
                        l = this._getValue(t),
                        d = h.center[0] - i.width / 2 + this.parsePercent(o[0], h.radius[1]),
                        c = h.center[1] + this.parsePercent(o[1], h.radius[1]);
                    this.shapeList.push(new r({
                        zlevel: e.zlevel,
                        z: e.z + (Math.abs(d + i.width / 2 - h.center[0]) + Math.abs(c + i.height / 2 - h.center[1]) < s.fontSize ? 2 : 1),
                        hoverable: !1,
                        style: {
                            x: d,
                            y: c,
            ...
            _colorMap: function (t) {
                ...
                for (var s = [], r = 0, a = n.length; a > r; r++) s.push([n[r][0] * o + i, n[r][1]]);
                this._paramsMap[t].colorArray = s
            },
            _getColor: function (t, e) {
                null == e && (e = this._getValue(t));
                for (var i = this._paramsMap[t].colorArray, o = 0, n = i.length; n > o; o++)
        ...
        }, p.inherits(e, i), t("../chart").define("gauge", e), e
    }), i("echarts/chart/bar", ["require", "./base", "zrender/shape/Rectangle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (t) {
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this.refresh(n)
        }
        var i = t("./base"),
        ...
        return e.prototype = {
            ...
            _buildNormal: function (t, e, i, s, r) {
                for (var a, h, l, d, c, p, u, g, f, m, _, y, x = this.series, v = i[0][0], b = x[v], S = "horizontal" == r, T = this.component.xAxis, z = this.component.yAxis, C = S ? T.getAxis(b.xAxisIndex) : z.getAxis(b.yAxisIndex), L = this._mapSize(C, i), w = L.gap, E = L.barGap, M = L.barWidthMap, A = L.barMaxWidthMap, k = L.barWidth, O = L.barMinHeightMap, I = L.interval, P = this.deepQuery([this.ecTheme, n], "island.r"), R = 0, D = e; D > R && null != C.getNameByIndex(R); R++) {
                    S ? d = C.getCoordByIndex(R) - w / 2 : c = C.getCoordByIndex(R) + w / 2;
                    for (var H = 0, B = i.length; B > H; H++) {
                        var N = x[i[H][0]].yAxisIndex || 0,
                            F = x[i[H][0]].xAxisIndex || 0;
                        a = S ? z.getAxis(N) : T.getAxis(F), u = p = f = g = a.getCoord(0);
                        for (var Y = 0, W = i[H].length; W > Y; Y++) v = i[H][Y], b = x[v], _ = b.data[R], y = this.getDataFromOption(_, "-"), s[v] = s[v] || {
                            min: Number.POSITIVE_INFINITY,
                            max: Number.NEGATIVE_INFINITY,
                            sum: 0,
                            counter: 0,
                            average: 0
                        }, l = Math.min(A[v] || Number.MAX_VALUE, M[v] || k), "-" !== y && (y > 0 ? (h = Y > 0 ? a.getCoordSize(y) : S ? u - a.getCoord(y) : a.getCoord(y) - u, 1 === W && O[v] > h && (h = O[v]), S ? (p -= h, c = p) : (d = p, p += h)) : 0 > y ? (h = Y > 0 ? a.getCoordSize(y) : S ? a.getCoord(y) - f : f - a.getCoord(y), 1 === W && O[v] > h && (h = O[v]), S ? (c = g, g += h) : (g -= h, d = g)) : (h = 0, S ? (p -= h, c = p) : (d = p, p += h)), s[v][R] = S ? d + l / 2 : c - l / 2, s[v].min > y && (s[v].min = y, S ? (s[v].minY = c, s[v].minX = s[v][R]) : (s[v].minX = d + h, s[v].minY = s[v][R])), s[v].max < y && (s[v].max = y, S ? (s[v].maxY = c, s[v].maxX = s[v][R]) : (s[v].maxX = d + h, s[v].maxY = s[v][R])), s[v].sum += y, s[v].counter++, R % I === 0 && (m = this._getBarItem(v, R, C.getNameByIndex(R), d, c - (S ? 0 : l), S ? l : h, S ? h : l, S ? "vertical" : "horizontal"), this.shapeList.push(new o(m))));
                        for (var Y = 0, W = i[H].length; W > Y; Y++) v = i[H][Y], b = x[v], _ = b.data[R], y = this.getDataFromOption(_, "-"), l = Math.min(A[v] || Number.MAX_VALUE, M[v] || k), "-" == y && this.deepQuery([_, b, this.option], "calculable") && (S ? (p -= P, c = p) : (d = p, p += P), m = this._getBarItem(v, R, C.getNameByIndex(R), d, c - (S ? 0 : l), S ? l : P, S ? P : l, S ? "vertical" : "horizontal"), m.hoverable = !1, m.draggable = !1, m.style.lineWidth = 1, m.style.brushType = "stroke", m.style.strokeColor = b.calculableHolderColor || this.ecTheme.calculableHolderColor || n.calculableHolderColor, this.shapeList.push(new o(m)));
                        S ? d += l + E : c -= l + E
                    }
                }
                    ...
                    for (var h = 0, l = i[r].length; l > h; h++) {
                        ...
                        for (var y = 0, x = c.data.length; x > y; y++) {
                            ...
                            if (b instanceof Array) {
                                var S, T, z = u.getCoord(b[0]),
                                    C = m.getCoord(b[1]),
                                    L = [v, c],
                                    w = this.deepQuery(L, "barWidth") || 10,
                                    E = this.deepQuery(L, "barHeight");
                                null != E ? (S = "horizontal", b[0] > 0 ? (w = z - g, z -= w) : w = b[0] < 0 ? g - z : 0, T = this._getBarItem(d, y, b[0], z, C - E / 2, w, E, S)) : (S = "vertical", b[1] > 0 ? E = _ - C : b[1] < 0 ? (E = C - _, C -= E) : E = 0, T = this._getBarItem(d, y, b[0], z - w / 2, C, w, E, S)), this.shapeList.push(new o(T)), z = u.getCoord(b[0]), C = m.getCoord(b[1]), n[d].min0 > b[0] && (n[d].min0 = b[0], n[d].minY0 = C, n[d].minX0 = z), n[d].max0 < b[0] && (n[d].max0 = b[0], n[d].maxY0 = C, n[d].maxX0 = z), n[d].sum0 += b[0], n[d].counter0++, n[d].min1 > b[1] && (n[d].min1 = b[1], n[d].minY1 = C, n[d].minX1 = z), n[d].max1 < b[1] && (n[d].max1 = b[1], n[d].maxY1 = C, n[d].maxX1 = z), n[d].sum1 += b[1], n[d].counter1++
                            }
                        }
                    }
            ...
            _mapSize: function (t, e, i) {
                var o, n, s = this._findSpecialBarSzie(e, i),
                    r = s.barWidthMap,
                    a = s.barMaxWidthMap,
                    h = s.barMinHeightMap,
                    ...
                    u = 1;
                if (e.length != l) {
                    if (i) o = t.getGap(), c = 0, n = +(o / e.length).toFixed(2), 0 >= n && (u = Math.floor(e.length / o), n = 1);
                    else if (o = "string" == typeof p && p.match(/%$/) ? (t.getGap() * (100 - parseFloat(p)) / 100).toFixed(2) - 0 : t.getGap() - p, "string" == typeof c && c.match(/%$/) ? (c = parseFloat(c) / 100, n = +((o - d) / ((e.length - 1) * c + e.length - l)).toFixed(2), c = n * c) : (c = parseFloat(c), n = +((o - d - c * (e.length - 1)) / (e.length - l)).toFixed(2)), 0 >= n) return this._mapSize(t, e, !0)
                } else if (o = l > 1 ? "string" == typeof p && p.match(/%$/) ? +(t.getGap() * (100 - parseFloat(p)) / 100).toFixed(2) : t.getGap() - p : d, n = 0, c = l > 1 ? +((o - d) / (l - 1)).toFixed(2) : 0, 0 > c) return this._mapSize(t, e, !0);
                return this._recheckBarMaxWidth(e, r, a, h, o, n, c, u)
            },
            _findSpecialBarSzie: function (t, e) {
                for (var i, o, n, s, r = this.series, a = {}, h = {}, l = {}, d = 0, c = 0, p = 0, u = t.length; u > p; p++)
                    for (var g = {
                            barWidth: !1,
                            barMaxWidth: !1
                        }, f = 0, m = t[p].length; m > f; f++) {
                        var _ = t[p][f],
                            y = r[_];
                        if (!e) {
                            if (g.barWidth) a[_] = i;
                        ...
                        l[_] = this.query(y, "barMinHeight"), n = null != n ? n : this.query(y, "barGap"), s = null != s ? s : this.query(y, "barCategoryGap")
                    }
                return {
                    barWidthMap: a,
                    barMaxWidthMap: h,
            ...
            _getBarItem: function (t, e, i, o, n, r, h, l) {
                ...
                d = {
                    ...
                    style: {
                        ...
                        height: h,
                        brushType: "both",
                        color: this.getItemStyleColor(this.deepQuery(f, "itemStyle.normal.color") || g, t, e, u),
                        radius: m.barBorderRadius,
                        lineWidth: y,
                        strokeColor: m.barBorderColor
                    },
                    highlightStyle: {
                        color: this.getItemStyleColor(this.deepQuery(f, "itemStyle.emphasis.color"), t, e, u),
                ...
                var x = d.style;
                d.highlightStyle.color = d.highlightStyle.color || ("string" == typeof x.color ? a.lift(x.color, -.3) : x.color), x.x = Math.floor(x.x), x.y = Math.floor(x.y), x.height = Math.ceil(x.height), x.width = Math.ceil(x.width), y > 0 && x.height > y && x.width > y ? (x.y += y / 2, x.height -= y, x.x += y / 2, x.width -= y) : x.brushType = "fill", d.highlightStyle.textColor = d.highlightStyle.color, d = this.addLabel(d, p, u, i, l);
                for (var v = [x, d.highlightStyle], b = 0, S = v.length; S > b; b++) {
                    var T = v[b].textPosition;
                    if ("insideLeft" === T || "insideRight" === T || "insideTop" === T || "insideBottom" === T) {
                        var z = 5;
                        switch (T) {
                            case "insideLeft":
                                v[b].textX = x.x + z, v[b].textY = x.y + x.height / 2, v[b].textAlign = "left", v[b].textBaseline = "middle";
                                break;
                            case "insideRight":
                                v[b].textX = x.x + x.width - z, v[b].textY = x.y + x.height / 2, v[b].textAlign = "right", v[b].textBaseline = "middle";
                                break;
                            case "insideTop":
                                v[b].textX = x.x + x.width / 2, v[b].textY = x.y + z / 2, v[b].textAlign = "center", v[b].textBaseline = "top";
                                break;
                            case "insideBottom":
                                v[b].textX = x.x + x.width / 2, v[b].textY = x.y + x.height - z / 2, v[b].textAlign = "center", v[b].textBaseline = "bottom"
                        }
                        v[b].textPosition = "specific", v[b].textColor = v[b].textColor || "#fff"
                    }
                }
                return this.deepQuery([u, p, this.option], "calculable") && (this.setCalculable(d), d.draggable = !0), s.pack(d, c[t], t, c[t].data[e], e, i), d
            },
            getMarkCoord: function (t, e) {
                var i, o, n = this.series[t],
                    s = this.xMarkMap[t],
                ...
                if (!e.type || "max" !== e.type && "min" !== e.type && "average" !== e.type)
                    if (s.isHorizontal) {
                        i = "string" == typeof e.xAxis && r.getIndexByName ? r.getIndexByName(e.xAxis) : e.xAxis || 0;
                        var h = s[i];
                        h = null != h ? h : "string" != typeof e.xAxis && r.getCoordByIndex ? r.getCoordByIndex(e.xAxis || 0) : r.getCoord(e.xAxis || 0), o = [h, a.getCoord(e.yAxis || 0)]
                    } else {
                        i = "string" == typeof e.yAxis && a.getIndexByName ? a.getIndexByName(e.yAxis) : e.yAxis || 0;
                        var l = s[i];
                        l = null != l ? l : "string" != typeof e.yAxis && a.getCoordByIndex ? a.getCoordByIndex(e.yAxis || 0) : a.getCoord(e.yAxis || 0), o = [r.getCoord(e.xAxis || 0), l]
                    }
                else {
                    var d = null != e.valueIndex ? e.valueIndex : null != s.maxX0 ? "1" : "";
                    o = [s[e.type + "X" + d], s[e.type + "Y" + d], s[e.type + "Line" + d], s[e.type + d]]
                }
                return o
            },
            refresh: function (t) {
            ...
            addDataAnimation: function (t, e) {
                ...
                for (var o = this.series, n = {}, r = 0, a = t.length; a > r; r++) n[t[r][0]] = t[r];
                for (var h, l, d, c, p, u, g, f = 0, r = this.shapeList.length - 1; r >= 0; r--)
                    if (u = s.get(this.shapeList[r], "seriesIndex"), n[u] && !n[u][3] && "rectangle" === this.shapeList[r].type) {
                        if (g = s.get(this.shapeList[r], "dataIndex"), p = o[u], n[u][2] && g === p.data.length - 1) {
                        ...
                        "horizontal" === this.shapeList[r]._orient ? (c = this.component.yAxis.getAxis(p.yAxisIndex || 0).getGap(), d = n[u][2] ? -c : c, h = 0) : (l = this.component.xAxis.getAxis(p.xAxisIndex || 0).getGap(), h = n[u][2] ? l : -l, d = 0), this.shapeList[r].position = [0, 0], f++, this.zr.animate(this.shapeList[r].id, "").when(this.query(this.option, "animationDurationUpdate"), {
                            position: [h, d]
                        }).done(i).start()
                    } f || e && e()
            }
        }, r.inherits(e, i), t("../chart").define("bar", e), e
    }), i("echarts/chart/line", ["require", "./base", "zrender/shape/Polyline", "../util/shape/Icon", "../util/shape/HalfSmoothPolygon", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (t) {
        ...
        function i(t, e, i) {
            ...
            l.match("star") ? (h = l.replace("star", "") - 0 || 5, n -= 1, l = "star") : ("rectangle" === l || "arrow" === l) && (o += (r - a) / 2, r = a);
            var d = "";
            if (l.match("image") && (d = l.replace(new RegExp("^image:\\/\\/"), ""), l = "image", o += Math.round((r - a) / 2) - 1, r = a += 2), l = s.prototype.iconLibrary[l]) {
                var c = e.x,
                    p = e.y;
        ...
        return e.prototype = {
            ...
            _buildHorizontal: function (t, e, i, o) {
                for (var n, s, r, a, h, l, d, c, p, u = this.series, g = i[0][0], f = u[g], m = this.component.xAxis.getAxis(f.xAxisIndex || 0), _ = {}, y = 0, x = e; x > y && null != m.getNameByIndex(y); y++) {
                    s = m.getCoordByIndex(y);
                    for (var v = 0, b = i.length; b > v; v++) {
                        n = this.component.yAxis.getAxis(u[i[v][0]].yAxisIndex || 0), h = a = d = l = n.getCoord(0);
                        for (var S = 0, T = i[v].length; T > S; S++) g = i[v][S], f = u[g], c = f.data[y], p = this.getDataFromOption(c, "-"), _[g] = _[g] || [], o[g] = o[g] || {
                            min: Number.POSITIVE_INFINITY,
                            max: Number.NEGATIVE_INFINITY,
                            sum: 0,
                            counter: 0,
                            average: 0
                        }, "-" !== p ? (p >= 0 ? (a -= S > 0 ? n.getCoordSize(p) : h - n.getCoord(p), r = a) : 0 > p && (l += S > 0 ? n.getCoordSize(p) : n.getCoord(p) - d, r = l), _[g].push([s, r, y, m.getNameByIndex(y), s, h]), o[g].min > p && (o[g].min = p, o[g].minY = r, o[g].minX = s), o[g].max < p && (o[g].max = p, o[g].maxY = r, o[g].maxX = s), o[g].sum += p, o[g].counter++) : _[g].length > 0 && (this.finalPLMap[g] = this.finalPLMap[g] || [], this.finalPLMap[g].push(_[g]), _[g] = [])
                    }
                    a = this.component.grid.getY();
                    for (var z, v = 0, b = i.length; b > v; v++)
                        for (var S = 0, T = i[v].length; T > S; S++) g = i[v][S], f = u[g], c = f.data[y], p = this.getDataFromOption(c, "-"), "-" == p && this.deepQuery([c, f, this.option], "calculable") && (z = this.deepQuery([c, f], "symbolSize"), a += 2 * z + 5, r = a, this.shapeList.push(this._getCalculableItem(g, y, m.getNameByIndex(y), s, r, "horizontal")))
                }
                for (var C in _) _[C].length > 0 && (this.finalPLMap[C] = this.finalPLMap[C] || [], this.finalPLMap[C].push(_[C]), _[C] = []);
                this._calculMarkMapXY(o, i, "y"), this._buildBorkenLine(t, this.finalPLMap, m, "horizontal")
            },
            _buildVertical: function (t, e, i, o) {
                for (var n, s, r, a, h, l, d, c, p, u = this.series, g = i[0][0], f = u[g], m = this.component.yAxis.getAxis(f.yAxisIndex || 0), _ = {}, y = 0, x = e; x > y && null != m.getNameByIndex(y); y++) {
                    r = m.getCoordByIndex(y);
                    for (var v = 0, b = i.length; b > v; v++) {
                        n = this.component.xAxis.getAxis(u[i[v][0]].xAxisIndex || 0), h = a = d = l = n.getCoord(0);
                        for (var S = 0, T = i[v].length; T > S; S++) g = i[v][S], f = u[g], c = f.data[y], p = this.getDataFromOption(c, "-"), _[g] = _[g] || [], o[g] = o[g] || {
                            min: Number.POSITIVE_INFINITY,
                            max: Number.NEGATIVE_INFINITY,
                            sum: 0,
                            counter: 0,
                            average: 0
                        }, "-" !== p ? (p >= 0 ? (a += S > 0 ? n.getCoordSize(p) : n.getCoord(p) - h, s = a) : 0 > p && (l -= S > 0 ? n.getCoordSize(p) : d - n.getCoord(p), s = l), _[g].push([s, r, y, m.getNameByIndex(y), h, r]), o[g].min > p && (o[g].min = p, o[g].minX = s, o[g].minY = r), o[g].max < p && (o[g].max = p, o[g].maxX = s, o[g].maxY = r), o[g].sum += p, o[g].counter++) : _[g].length > 0 && (this.finalPLMap[g] = this.finalPLMap[g] || [], this.finalPLMap[g].push(_[g]), _[g] = [])
                    }
                    a = this.component.grid.getXend();
                    for (var z, v = 0, b = i.length; b > v; v++)
                        for (var S = 0, T = i[v].length; T > S; S++) g = i[v][S], f = u[g], c = f.data[y], p = this.getDataFromOption(c, "-"), "-" == p && this.deepQuery([c, f, this.option], "calculable") && (z = this.deepQuery([c, f], "symbolSize"), a -= 2 * z + 5, s = a, this.shapeList.push(this._getCalculableItem(g, y, m.getNameByIndex(y), s, r, "vertical")))
                }
                for (var C in _) _[C].length > 0 && (this.finalPLMap[C] = this.finalPLMap[C] || [], this.finalPLMap[C].push(_[C]), _[C] = []);
                this._calculMarkMapXY(o, i, "x"), this._buildBorkenLine(t, this.finalPLMap, m, "vertical")
            },
            _buildOther: function (t, e, i, o) {
                for (var n, s = this.series, r = {}, a = 0, h = i.length; h > a; a++)
                        ...
                        for (var f = 0, m = p.data.length; m > f; f++) {
                            ...
                            if (y instanceof Array) {
                                var x = n.getCoord(y[0]),
                                    v = u.getCoord(y[1]);
                                r[c].push([x, v, f, y[0], x, g]), o[c].min0 > y[0] && (o[c].min0 = y[0], o[c].minY0 = v, o[c].minX0 = x), o[c].max0 < y[0] && (o[c].max0 = y[0], o[c].maxY0 = v, o[c].maxX0 = x), o[c].sum0 += y[0], o[c].counter0++, o[c].min1 > y[1] && (o[c].min1 = y[1], o[c].minY1 = v, o[c].minX1 = x), o[c].max1 < y[1] && (o[c].max1 = y[1], o[c].maxY1 = v, o[c].maxX1 = x), o[c].sum1 += y[1], o[c].counter1++
                            }
                        }
                    }
                for (var b in r) r[b].length > 0 && (this.finalPLMap[b] = this.finalPLMap[b] || [], this.finalPLMap[b].push(r[b]), r[b] = []);
                this._calculMarkMapXY(o, i, "xy"), this._buildBorkenLine(t, this.finalPLMap, n, "other")
            },
            _buildBorkenLine: function (t, e, i, o) {
                for (var s, a = "other" == o ? "horizontal" : o, c = this.series, p = t.length - 1; p >= 0; p--) {
                    var u = t[p],
                        g = c[u],
                        f = e[u];
                    if (g.type === this.type && null != f)
                        for (var m = this._getBbox(u, a), _ = this._sIndex2ColorMap[u], y = this.query(g, "itemStyle.normal.lineStyle.width"), x = this.query(g, "itemStyle.normal.lineStyle.type"), v = this.query(g, "itemStyle.normal.lineStyle.color"), b = this.getItemStyleColor(this.query(g, "itemStyle.normal.color"), u, -1), S = null != this.query(g, "itemStyle.normal.areaStyle"), T = this.query(g, "itemStyle.normal.areaStyle.color"), z = 0, C = f.length; C > z; z++) {
                            var L = f[z],
                                w = "other" != o && this._isLarge(a, L);
                            if (w) L = this._getLargePointList(a, L, g.dataFilter);
                            else
                                for (var E = 0, M = L.length; M > E; E++) s = g.data[L[E][2]], (this.deepQuery([s, g, this.option], "calculable") || this.deepQuery([s, g], "showAllSymbol") || "categoryAxis" === i.type && i.isMainAxis(L[E][2]) && "none" != this.deepQuery([s, g], "symbol")) && this.shapeList.push(this._getSymbol(u, L[E][2], L[E][3], L[E][0], L[E][1], a));
                            var A = new n({
                                zlevel: g.zlevel,
                                z: g.z,
                                style: {
                            ...
                            if (h.pack(A, c[u], u, 0, z, c[u].name), this.shapeList.push(A), S) {
                                var k = new r({
                                    zlevel: g.zlevel,
                                    z: g.z,
                                    style: {
            ...
            _getLargePointList: function (t, e, i) {
                var o;
                o = "horizontal" === t ? this.component.grid.getWidth() : this.component.grid.getHeight();
                var n = e.length,
                    s = [];
                ...
                for (var r = [], a = 0; o > a; a++) {
                    ...
                    if (!(h >= l)) {
                        for (var d = h; l > d; d++) r[d - h] = "horizontal" === t ? e[d][1] : e[d][0];
                        r.length = l - h;
            ...
            _getCalculableItem: function (t, e, i, o, n, s) {
                var r = this.series,
                    h = r[t].calculableHolderColor || this.ecTheme.calculableHolderColor || a.calculableHolderColor,
                    l = this._getSymbol(t, e, i, o, n, s);
                return l.style.color = h, l.style.strokeColor = h, l.rotation = [0, 0], l.hoverable = !1, l.draggable = !1, l.style.text = void 0, l
            },
            _getSymbol: function (t, e, i, o, n, s) {
                var r = this.series,
                    a = r[t],
                    h = a.data[e],
                    l = this.getSymbolShape(a, t, h, e, i, o, n, this._sIndex2ShapeMap[t], this._sIndex2ColorMap[t], "#fff", "vertical" === s ? "horizontal" : "vertical");
                return l.zlevel = a.zlevel, l.z = a.z + 1, this.deepQuery([h, a, this.option], "calculable") && (this.setCalculable(l), l.draggable = !0), l
            },
            getMarkCoord: function (t, e) {
                var i = this.series[t],
                    o = this.xMarkMap[t],
                ...
                if (e.type && ("max" === e.type || "min" === e.type || "average" === e.type)) {
                    var r = null != e.valueIndex ? e.valueIndex : null != o.maxX0 ? "1" : "";
                    return [o[e.type + "X" + r], o[e.type + "Y" + r], o[e.type + "Line" + r], o[e.type + r]]
                }
                return ["string" != typeof e.xAxis && n.getCoordByIndex ? n.getCoordByIndex(e.xAxis || 0) : n.getCoord(e.xAxis || 0), "string" != typeof e.yAxis && s.getCoordByIndex ? s.getCoordByIndex(e.yAxis || 0) : s.getCoord(e.yAxis || 0)]
            },
            refresh: function (t) {
                t && (this.option = t, this.series = t.series), this.backupShapeList(), this._buildShape()
            },
            ontooltipHover: function (t, e) {
                for (var i, o, n = t.seriesIndex, s = t.dataIndex, r = n.length; r--;)
                    if (i = this.finalPLMap[n[r]])
                        for (var a = 0, h = i.length; h > a; a++) {
                            o = i[a];
                            for (var l = 0, d = o.length; d > l; l++) s === o[l][2] && e.push(this._getSymbol(n[r], o[l][2], o[l][3], o[l][0], o[l][1], "horizontal"))
                        }
            },
            addDataAnimation: function (t, e) {
                function i() {
                ...
                for (var n = this.series, s = {}, r = 0, a = t.length; a > r; r++) s[t[r][0]] = t[r];
                for (var h, l, d, c, p, u, g, f = 0, r = this.shapeList.length - 1; r >= 0; r--)
                    if (p = this.shapeList[r]._seriesIndex, s[p] && !s[p][3]) {
                        if (this.shapeList[r]._main && this.shapeList[r].style.pointList.length > 1) {
                            if (u = this.shapeList[r].style.pointList, l = Math.abs(u[0][0] - u[1][0]), c = Math.abs(u[0][1] - u[1][1]), g = "horizontal" === this.shapeList[r]._orient, s[p][2]) {
                                if ("half-smooth-polygon" === this.shapeList[r].type) {
                                    var m = u.length;
                                    this.shapeList[r].style.pointList[m - 3] = u[m - 2], this.shapeList[r].style.pointList[m - 3][g ? 0 : 1] = u[m - 4][g ? 0 : 1], this.shapeList[r].style.pointList[m - 2] = u[m - 1]
                                }
                                this.shapeList[r].style.pointList.pop(), g ? (h = l, d = 0) : (h = 0, d = -c)
                            } else {
                                if (this.shapeList[r].style.pointList.shift(), "half-smooth-polygon" === this.shapeList[r].type) {
                                    ...
                                    g ? _[0] = u[0][0] : _[1] = u[0][1], this.shapeList[r].style.pointList.push(_)
                                }
                                g ? (h = -l, d = 0) : (h = 0, d = c)
                            }
                            this.shapeList[r].style.controlPointList = null, this.zr.modShape(this.shapeList[r])
                        } else {
                            if (s[p][2] && this.shapeList[r]._dataIndex === n[p].data.length - 1) {
                                this.zr.delShape(this.shapeList[r].id);
                                continue
                            }
                        ...
                        this.shapeList[r].position = [0, 0], f++, this.zr.animate(this.shapeList[r].id, "").when(this.query(this.option, "animationDurationUpdate"), {
                            position: [h, d]
                        }).during(o).done(i).start()
                    } f || e && e()
            }
        }, s.prototype.iconLibrary.legendLineIcon = i, l.inherits(e, o), t("../chart").define("line", e), e
        ...
        return e.prototype = {
            ...
            _buildShape: function () {
                ...
                for (var a, d = 0, c = t.length; c > d; d++)
                    if (t[d].type === h.CHART_TYPE_PIE) {
                        if (t[d] = this.reformOption(t[d]), this.legendHoverLink = t[d].legendHoverLink || this.legendHoverLink, a = t[d].name || "", this.selectedMap[a] = e ? e.isSelected(a) : !0, !this.selectedMap[a]) continue;
                        i = this.parseCenter(this.zr, t[d].center), o = this.parseRadius(this.zr, t[d].radius), this._selectedMode = this._selectedMode || t[d].selectedMode, this._selected[d] = [], this.deepQuery([t[d], this.option], "calculable") && (r = {
                            zlevel: t[d].zlevel,
                            z: t[d].z,
                            hoverable: !1,
                            style: {
                                ...
                                brushType: "stroke",
                                lineWidth: 1,
                                strokeColor: t[d].calculableHolderColor || this.ecTheme.calculableHolderColor || h.calculableHolderColor
                            }
                        }, l.pack(r, t[d], d, void 0, -1), this.setCalculable(r), r = o[0] <= 10 ? new s(r) : new n(r), this.shapeList.push(r)), this._buildSinglePie(d), this.buildMark(d)
                    } this.addShapeList()
            },
            _buildSinglePie: function (t) {
                for (var e, i = this.series, o = i[t], n = o.data, s = this.component.legend, r = 0, a = 0, h = 0, l = Number.NEGATIVE_INFINITY, d = [], c = 0, p = n.length; p > c; c++) e = n[c].name, this.selectedMap[e] = s ? s.isSelected(e) : !0, this.selectedMap[e] && !isNaN(n[c].value) && (0 !== +n[c].value ? r++ : a++, h += +n[c].value, l = Math.max(l, +n[c].value));
                if (0 !== h) {
                    for (var u, g, f, m, _, y, x = 100, v = o.clockWise, b = (o.startAngle.toFixed(2) - 0 + 360) % 360, S = o.minAngle || .01, T = 360 - S * r - .01 * a, z = o.roseType, c = 0, p = n.length; p > c; c++)
                        if (e = n[c].name, this.selectedMap[e] && !isNaN(n[c].value)) {
                            if (g = s ? s.getColor(e) : this.zr.getColor(c), x = n[c].value / h, u = "area" != z ? v ? b - x * T - (0 !== x ? S : .01) : x * T + b + (0 !== x ? S : .01) : v ? b - 360 / p : 360 / p + b, u = u.toFixed(2) - 0, x = (100 * x).toFixed(2), f = this.parseCenter(this.zr, o.center), m = this.parseRadius(this.zr, o.radius), _ = +m[0], y = +m[1], "radius" === z ? y = n[c].value / l * (y - _) * .8 + .2 * (y - _) + _ : "area" === z && (y = Math.sqrt(n[c].value / l) * (y - _) + _), v) {
                                var C;
                                C = b, b = u, u = C
                            }
                            this._buildItem(d, t, c, x, n[c].selected, f, _, y, b, u, g), v || (b = u)
            ...
            _buildItem: function (t, e, i, o, n, s, r, a, h, d, c) {
                ...
                l.pack(g, p[e], e, p[e].data[i], i, p[e].data[i].name, o), t.push(g);
                var f = this.getLabel(e, i, o, s, u, c, !1),
                    m = this.getLabelLine(e, i, s, r, a, u, c, !1);
                m && (l.pack(m, p[e], e, p[e].data[i], i, p[e].data[i].name, o), t.push(m)), f && (l.pack(f, p[e], e, p[e].data[i], i, p[e].data[i].name, o), f._labelLine = m, t.push(f))
            },
            getSector: function (t, e, i, o, n, s, a, h, l, d) {
                var u = this.series,
                    ...
                    v = this.getItemStyleColor(y.color, t, e, f) || ("string" == typeof x ? p.lift(x, -.2) : x),
                    b = {
                        zlevel: g.zlevel,
                        z: g.z,
                ...
                if (o) {
                    ...
                    b.style.x += c.cos(S, !0) * T, b.style.y -= c.sin(S, !0) * T, this._selected[t][e] = !0
                } else this._selected[t][e] = !1;
                return this._selectedMode && (b.onclick = this.shapeHandler.onclick), this.deepQuery([f, g, this.option], "calculable") && (this.setCalculable(b), b.draggable = !0), (this._needLabel(g, f, !0) || this._needLabelLine(g, f, !0)) && (b.onmouseover = this.shapeHandler.onmouseover), b = new r(b)
            },
            getLabel: function (t, e, i, n, s, r, a) {
                ...
                if (this._needLabel(l, p, a)) {
                    var u, g, f, m = a ? "emphasis" : "normal",
                        ...
                        T = "middle";
                    y.position = y.position || _.normal.label.position, "center" === y.position ? (u = v, g = b, f = "center") : "inner" === y.position || "inside" === y.position ? (S = (S[0] + S[1]) * (y.distance || .5), u = Math.round(v + S * c.cos(s, !0)), g = Math.round(b - S * c.sin(s, !0)), r = "#fff", f = "center") : (S = S[1] - -_[m].labelLine.length, u = Math.round(v + S * c.cos(s, !0)), g = Math.round(b - S * c.sin(s, !0)), f = s >= 90 && 270 >= s ? "right" : "left"), "center" != y.position && "inner" != y.position && "inside" != y.position && (u += "left" === f ? 20 : -20), p.__labelX = u - ("left" === f ? 5 : -5), p.__labelY = g;
                    var z = new o({
                        zlevel: l.zlevel,
                        z: l.z + 1,
                        hoverable: !1,
                    ...
                    return z._radius = S, z._labelPosition = y.position || "outer", z._rect = z.getRect(z.style), z._seriesIndex = t, z._dataIndex = e, z
                }
            },
            getLabelText: function (t, e, i, o) {
                var n = this.series,
                    s = n[t],
                    r = s.data[e],
                    a = this.deepQuery([r, s], "itemStyle." + o + ".label.formatter");
                return a ? "function" == typeof a ? a.call(this.myChart, {
                    ...
                    value: r.value,
                    percent: i
                }) : "string" == typeof a ? (a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}"), a = a.replace("{a0}", s.name).replace("{b0}", r.name).replace("{c0}", r.value).replace("{d0}", i)) : void 0 : r.name
            },
            ...
            _autoLabelLayout: function (t, e, i) {
                for (var o = [], n = [], s = 0, r = t.length; r > s; s++)("outer" === t[s]._labelPosition || "outside" === t[s]._labelPosition) && (t[s]._rect._y = t[s]._rect.y, t[s]._rect.x < e[0] ? o.push(t[s]) : n.push(t[s]));
                this._layoutCalculate(o, e, i, -1), this._layoutCalculate(n, e, i, 1)
            },
            _layoutCalculate: function (t, e, i, o) {
                function n(e, i, o) {
                    for (var n = e; i > n; n++)
                        if (t[n]._rect.y += o, t[n].style.y += o, t[n]._labelLine && (t[n]._labelLine.style.pointList[1][1] += o, t[n]._labelLine.style.pointList[2][1] += o), n > e && i > n + 1 && t[n + 1]._rect.y > t[n]._rect.y + t[n]._rect.height) return void s(n, o / 2);
                    s(i - 1, o / 2)
                }
                ...
                function r(t, e, i, o, n) {
                    for (var s, r, a, h = i[0], l = i[1], d = n > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, c = 0, p = t.length; p > c; c++) r = Math.abs(t[c]._rect.y - l), a = t[c]._radius - o, s = o + a > r ? Math.sqrt((o + a + 20) * (o + a + 20) - Math.pow(t[c]._rect.y - l, 2)) : Math.abs(t[c]._rect.x + (n > 0 ? 0 : t[c]._rect.width) - h), e && s >= d && (s = d - 10), !e && d >= s && (s = d + 10), t[c]._rect.x = t[c].style.x = h + s * n, t[c]._labelLine && (t[c]._labelLine.style.pointList[2][0] = h + (s - 5) * n, t[c]._labelLine.style.pointList[1][0] = h + (s - 20) * n), d = s
                }
                t.sort(function (t, e) {
                    return t._rect.y - e._rect.y
                });
                for (var a, h = 0, l = t.length, d = [], c = [], p = 0; l > p; p++) a = t[p]._rect.y - h, 0 > a && n(p, l, -a, o), h = t[p]._rect.y + t[p]._rect.height;
            ...
            reformOption: function (t) {
                var e = d.merge;
                return t = e(e(t || {}, d.clone(this.ecTheme.pie || {})), d.clone(h.pie)), t.itemStyle.normal.label.textStyle = this.getTextStyle(t.itemStyle.normal.label.textStyle), t.itemStyle.emphasis.label.textStyle = this.getTextStyle(t.itemStyle.emphasis.label.textStyle), this.z = t.z, this.zlevel = t.zlevel, t
            },
            refresh: function (t) {
                t && (this.option = t, this.series = t.series), this.backupShapeList(), this._buildShape()
            },
            addDataAnimation: function (t, e) {
                ...
                for (var o = this.series, n = {}, s = 0, r = t.length; r > s; s++) n[t[s][0]] = t[s];
                var a = 0,
                    l = {},
                    d = {},
                    c = {},
                    p = this.shapeList;
                this.shapeList = [];
                for (var u, g, f, m = {}, s = 0, r = t.length; r > s; s++) u = t[s][0], g = t[s][2], f = t[s][3], o[u] && o[u].type === h.CHART_TYPE_PIE && (g ? (f || (l[u + "_" + o[u].data.length] = "delete"), m[u] = 1) : f ? m[u] = 0 : (l[u + "_-1"] = "delete", m[u] = -1), this._buildSinglePie(u));
                for (var _, y, s = 0, r = this.shapeList.length; r > s; s++) switch (u = this.shapeList[s]._seriesIndex, _ = this.shapeList[s]._dataIndex, y = u + "_" + _, this.shapeList[s].type) {
                    case "sector":
                ...
                for (var x, s = 0, r = p.length; r > s; s++)
                    if (u = p[s]._seriesIndex, n[u]) {
                        if (_ = p[s]._dataIndex + m[u], y = u + "_" + _, x = l[y], !x) continue;
                        if ("sector" === p[s].type) "delete" != x ? (a++, this.zr.animate(p[s].id, "style").when(400, {
                            startAngle: x.style.startAngle,
                            endAngle: x.style.endAngle
                        }).done(i).start()) : (a++, this.zr.animate(p[s].id, "style").when(400, m[u] < 0 ? {
                            ...
                            else switch (p[s].type) {
                                case "text":
                                    a++, x = d[y], this.zr.animate(p[s].id, "style").when(400, {
                                        x: x.style.x,
                                        y: x.style.y
                                    }).done(i).start();
                                    break;
                                case "polyline":
                                    a++, x = c[y], this.zr.animate(p[s].id, "style").when(400, {
            ...
            onclick: function (t) {
                ...
                if (this.isClick && t.target) {
                    this.isClick = !1;
                    for (var i, o = t.target, n = o.style, s = l.get(o, "seriesIndex"), r = l.get(o, "dataIndex"), a = 0, d = this.shapeList.length; d > a; a++)
                        if (this.shapeList[a].id === o.id) {
                            if (s = l.get(o, "seriesIndex"), r = l.get(o, "dataIndex"), n._hasSelected) o.style.x = o.style._x, o.style.y = o.style._y, o.style._hasSelected = !1, this._selected[s][r] = !1;
                            else {
                                var p = ((n.startAngle + n.endAngle) / 2).toFixed(2) - 0;
                                o.style._hasSelected = !0, this._selected[s][r] = !0, o.style._x = o.style.x, o.style._y = o.style.y, i = this.query(e[s], "selectedOffset"), o.style.x += c.cos(p, !0) * i, o.style.y -= c.sin(p, !0) * i
                            }
                            this.zr.modShape(o.id)
                        } else this.shapeList[a].style._hasSelected && "single" === this._selectedMode && (s = l.get(this.shapeList[a], "seriesIndex"), r = l.get(this.shapeList[a], "dataIndex"), this.shapeList[a].style.x = this.shapeList[a].style._x, this.shapeList[a].style.y = this.shapeList[a].style._y, this.shapeList[a].style._hasSelected = !1, this._selected[s][r] = !1, this.zr.modShape(this.shapeList[a].id));
        ...
        }, d.inherits(e, i), t("../chart").define("pie", e), e
    }), i("echarts/chart/funnel", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Polygon", "../config", "../util/ecData", "../util/number", "zrender/tool/util", "zrender/tool/color", "zrender/tool/area", "../chart"], function (t) {
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this.refresh(n)
        }
        var i = t("./base"),
        ...
        return e.prototype = {
            ...
            _buildShape: function () {
                ...
                for (var i, o = 0, n = t.length; n > o; o++)
                    if (t[o].type === r.CHART_TYPE_FUNNEL) {
                        if (t[o] = this.reformOption(t[o]), this.legendHoverLink = t[o].legendHoverLink || this.legendHoverLink, i = t[o].name || "", this.selectedMap[i] = e ? e.isSelected(i) : !0, !this.selectedMap[i]) continue;
            ...
            _buildSingleFunnel: function (t) {
                ...
                for (var s, r = 0, a = [], l = 0, d = o.length; d > l; l++) s = o[l].name, this.selectedMap[s] = e ? e.isSelected(s) : !0, this.selectedMap[s] && !isNaN(o[l].value) && (a.push(o[l]), r++);
                if (0 !== r) {
                    for (var c, p, u, g, f = this._buildFunnelCase(t), m = i.funnelAlign, _ = i.gap, y = r > 1 ? (n.height - (r - 1) * _) / r : n.height, x = n.y, v = "descending" === i.sort ? this._getItemWidth(t, a[0].value) : h.parsePercent(i.minSize, n.width), b = "descending" === i.sort ? 1 : 0, S = n.centerX, T = [], l = 0, d = a.length; d > l; l++)
                        if (s = a[l].name, this.selectedMap[s] && !isNaN(a[l].value)) {
                            switch (c = d - 2 >= l ? this._getItemWidth(t, a[l + b].value) : "descending" === i.sort ? h.parsePercent(i.minSize, n.width) : h.parsePercent(i.maxSize, n.width), m) {
                                case "left":
                                    p = n.x;
                                    break;
                                case "right":
                            ...
                            u = this._buildItem(t, a[l]._index, e ? e.getColor(s) : this.zr.getColor(a[l]._index), p, x, v, c, y, m), x += y + _, g = u.style.pointList, T.unshift([g[0][0] - 10, g[0][1]]), T.push([g[1][0] + 10, g[1][1]]), 0 === l && (0 === v ? (g = T.pop(), "center" == m && (T[0][0] += 10), "right" == m && (T[0][0] = g[0]), T[0][1] -= "center" == m ? 10 : 15, 1 == d && (g = u.style.pointList)) : (T[T.length - 1][1] -= 5, T[0][1] -= 5)), v = c
                        } f && (T.unshift([g[3][0] - 10, g[3][1]]), T.push([g[2][0] + 10, g[2][1]]), 0 === v ? (g = T.pop(), "center" == m && (T[0][0] += 10), "right" == m && (T[0][0] = g[0]), T[0][1] += "center" == m ? 10 : 15) : (T[T.length - 1][1] += 5, T[0][1] += 5), f.style.pointList = T)
                }
            },
                    ...
                    var i = this._paramsMap[t].location,
                        ...
                        n = {
                            ...
                            style: {
                                ...
                                brushType: "stroke",
                                lineWidth: 1,
                                strokeColor: e.calculableHolderColor || this.ecTheme.calculableHolderColor || r.calculableHolderColor
                            }
                        };
                    return a.pack(n, e, t, void 0, -1), this.setCalculable(n), n = new s(n), this.shapeList.push(n), n
                }
            },
            _getLocation: function (t) {
                var e = this.series[t],
                    ...
                    r = null == e.width ? i - n - this.parsePercent(e.x2, i) : this.parsePercent(e.width, i);
                return {
                    x: n,
                    y: s,
                    width: r,
                    height: null == e.height ? o - s - this.parsePercent(e.y2, o) : this.parsePercent(e.height, o),
                    centerX: n + r / 2
                }
            },
            _mapData: function (t) {
                ...
                for (var o = this.series[t], n = l.clone(o.data), s = 0, r = n.length; r > s; s++) n[s]._index = s;
                return "none" != o.sort && n.sort("descending" === o.sort ? e : i), n
            },
            _buildItem: function (t, e, i, o, n, s, r, h, l) {
                ...
                a.pack(u, d[t], t, d[t].data[e], e, d[t].data[e].name), this.shapeList.push(u);
                var g = this.getLabel(t, e, i, o, n, s, r, h, l);
                a.pack(g, d[t], t, d[t].data[e], e, d[t].data[e].name), this.shapeList.push(g), this._needLabel(c, p, !1) || (g.invisible = !0);
                var f = this.getLabelLine(t, e, i, o, n, s, r, h, l);
                this.shapeList.push(f), this._needLabelLine(c, p, !1) || (f.invisible = !0);
                var m = [],
                    _ = [];
                return this._needLabelLine(c, p, !0) && (m.push(f.id), _.push(f.id)), this._needLabel(c, p, !0) && (m.push(g.id), _.push(u.id)), u.hoverConnect = m, g.hoverConnect = _, u
            },
            ...
            getPolygon: function (t, e, i, o, n, r, a, h, l) {
                ...
                return this.deepQuery([u, p, this.option], "calculable") && (this.setCalculable(x), x.draggable = !0), new s(x)
            },
            getLabel: function (t, e, i, n, s, r, a, h, p) {
                var u, g = this.series[t],
                    f = g.data[e],
                    ...
                    T = this.getFont(v),
                    z = i;
                x.position = x.position || _.normal.label.position, "inner" === x.position || "inside" === x.position || "center" === x.position ? (u = p, z = Math.max(r, a) / 2 > c.getTextWidth(S, T) ? "#fff" : d.reverse(i)) : u = "left" === x.position ? "right" : "left";
                var C = {
                    zlevel: g.zlevel,
                    z: g.z + 1,
                    style: {
                ...
                return y = "emphasis", x = _[y].label || x, v = x.textStyle || v, b = _[y].labelLine.length || b, x.position = x.position || _.normal.label.position, S = this.getLabelText(t, e, y), T = this.getFont(v), z = i, "inner" === x.position || "inside" === x.position || "center" === x.position ? (u = p, z = Math.max(r, a) / 2 > c.getTextWidth(S, T) ? "#fff" : d.reverse(i)) : u = "left" === x.position ? "right" : "left", C.highlightStyle = {
                    x: this._getLabelPoint(x.position, n, m, r, a, b, p),
                    color: v.color || z,
                    text: S,
                    textAlign: v.align || u,
            ...
            getLabelText: function (t, e, i) {
                var o = this.series,
                    n = o[t],
                    s = n.data[e],
                    r = this.deepQuery([s, n], "itemStyle." + i + ".label.formatter");
                return r ? "function" == typeof r ? r.call(this.myChart, {
                    ...
                    name: s.name,
                    value: s.value
                }) : "string" == typeof r ? r = r.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{a0}", n.name).replace("{b0}", s.name).replace("{c0}", s.value) : void 0 : s.name
            },
            getLabelLine: function (t, e, i, o, s, r, a, h, d) {
                ...
                return f = "emphasis", m = g[f].labelLine || m, _ = g[f].labelLine.length || _, y = m.lineStyle || y, x = g[f].label || x, x.position = x.position, v.highlightStyle = {
                    xEnd: this._getLabelPoint(x.position, o, u, r, a, _, d),
                    strokeColor: y.color || i,
                    lineType: y.type,
                    lineWidth: y.width
            ...
            _getLabelPoint: function (t, e, i, o, n, s, r) {
                switch (t = "inner" === t || "inside" === t ? "center" : t) {
                    case "center":
                        return "center" == r ? e + o / 2 : "left" == r ? e + 10 : e + o - 10;
                    case "left":
                        return "auto" === s ? i.x - 10 : "center" == r ? i.centerX - Math.max(o, n) / 2 - s : "right" == r ? e - (n > o ? n - o : 0) - s : i.x - s;
                    default:
                        return "auto" === s ? i.x + i.width + 10 : "center" == r ? i.centerX + Math.max(o, n) / 2 + s : "right" == r ? i.x + i.width + s : e + Math.max(o, n) + s
                }
            },
            _getLabelLineStartPoint: function (t, e, i, o, n) {
                return "center" == n ? e.centerX : o > i ? t + Math.min(i, o) / 2 : t + Math.max(i, o) / 2
            },
            _needLabel: function (t, e, i) {
                return this.deepQuery([e, t], "itemStyle." + (i ? "emphasis" : "normal") + ".label.show")
            },
        ...
        }, l.inherits(e, i), t("../chart").define("funnel", e), e
        ...
        a.version = "2.2.7", a.dependencies = {
            ...
            return s || (s = l++, e.setAttribute(c, s)), d[s] && d[s].dispose(), d[s] = new i(e), d[s].id = s, d[s].canvasSupported = h, d[s].setTheme(o), d[s]
        }, a.getInstanceById = function (t) {
            return d[t]
        }, s.merge(e.prototype, r.Dispatcher.prototype, !0);
        var p = t("zrender/config").EVENT,
            u = ["CLICK", "DBLCLICK", "MOUSEOVER", "MOUSEOUT", "DRAGSTART", "DRAGEND", "DRAGENTER", "DRAGOVER", "DRAGLEAVE", "DROP"];
        return i.prototype = {
            _init: function () {
                var e = this,
                    i = t("zrender").init(this.dom);
                this._zr = i, this._messageCenter.dispatch = function (t, i, o, n) {
                    o = o || {}, o.type = t, o.event = i, e._messageCenter.dispatchWithContext(t, o, n), e._messageCenterOutSide.dispatchWithContext(t, o, n)
            ...
            __onevent: function (t) {
                    ...
                    case n.EVENT.TOOLTIP_OUT_GRID:
                        if (e) {
                            if (this._connected) {
                                ...
                                s && (t.x = (t.event.zrenderX - s.getX()) / s.getWidth(), t.y = (t.event.zrenderY - s.getY()) / s.getHeight())
                            }
                        } else {
                            var s = this.component.grid;
                ...
                if (this._connected && e && this._curEventType === t.type) {
                    for (var r in this._connected) this._connected[r].connectedEventHandler(t);
            ...
            _ondataRange: function (t) {
                this._clearEffect(), this._status.needRefresh = !1, o(this, "ondataRange", t, this._status), this._status.needRefresh && this._zr.refreshNextFrame()
            },
            ...
            _noDataCheck: function (t) {
                for (var e = t.series, i = 0, o = e.length; o > i; i++)
                    if (e[i].type == n.CHART_TYPE_MAP || e[i].data && e[i].data.length > 0 || e[i].markPoint && e[i].markPoint.data && e[i].markPoint.data.length > 0 || e[i].markLine && e[i].markLine.data && e[i].markLine.data.length > 0 || e[i].nodes && e[i].nodes.length > 0 || e[i].links && e[i].links.length > 0 || e[i].matrix && e[i].matrix.length > 0 || e[i].eventList && e[i].eventList.length > 0) return !1;
                var s = this._option && this._option.noDataLoadingOption || this._themeConfig.noDataLoadingOption || n.noDataLoadingOption || {
                    text: this._option && this._option.noDataText || this._themeConfig.noDataText || n.noDataText,
                    effect: this._option && this._option.noDataEffect || this._themeConfig.noDataEffect || n.noDataEffect
                };
            ...
            _render: function (e) {
                if (this._mergeGlobalConifg(e), !this._noDataCheck(e)) {
                    ...
                    for (var a, l, d, c = ["title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar"], p = 0, u = c.length; u > p; p++) l = c[p], d = this.component[l], e[l] ? (d ? d.refresh && d.refresh(e) : (a = r.get(/^[xy]Axis$/.test(l) ? "axis" : l), d = new a(this._themeConfig, this._messageCenter, this._zr, e, this, l), this.component[l] = d), this._chartList.push(d)) : d && (d.dispose(), this.component[l] = null, delete this.component[l]);
                    for (var g, f, m, _ = {}, p = 0, u = e.series.length; u > p; p++) f = e.series[p].type, f ? _[f] || (_[f] = !0, g = s.get(f), g ? (this.chart[f] ? (m = this.chart[f], m.refresh(e)) : m = new g(this._themeConfig, this._messageCenter, this._zr, e, this), this._chartList.push(m), this.chart[f] = m) : console.error(f + " has not been required.")) : console.error("series[" + p + "] chart type has not been defined.");
                    for (f in this.chart) f == n.CHART_TYPE_ISLAND || _[f] || (this.chart[f].dispose(), this.chart[f] = null, delete this.chart[f]);
                    ...
                    e.renderAsImage && h ? (x ? x.src = this.getDataURL(e.renderAsImage) : (x = this.getImage(e.renderAsImage), x.id = y, x.style.position = "absolute", x.style.left = 0, x.style.top = 0, this.dom.firstChild.appendChild(x)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : x && x.parentNode.removeChild(x), x = null, this._option = e
                }
            },
            restore: function () {
                this._clearEffect(), this._option = s.clone(this._optionRestore), this._disposeChartList(), this._island.clear(), this._toolbox.reset(this._option, !0), this._render(this._option)
            },
            refresh: function (t) {
                this._clearEffect(), t = t || {};
                var e = t.option;
                !this._refreshInside && e && (e = this.getOption(), s.merge(e, t.option, !0), s.merge(this._optionRestore, t.option, !0), this._toolbox.reset(e)), this._island.refresh(e), this._toolbox.refresh(e), this._zr.clearAnimation();
            ...
            _mergeGlobalConifg: function (e) {
                for (var i = ["backgroundColor", "calculable", "calculableColor", "calculableHolderColor", "nameConnector", "valueConnector", "animation", "animationThreshold", "animationDuration", "animationDurationUpdate", "animationEasing", "addDataAnimation", "symbolList", "DRAG_ENABLE_TIME"], o = i.length; o--;) {
                    var s = i[o];
                    null == e[s] && (e[s] = null != this._themeConfig[s] ? this._themeConfig[s] : n[s])
                }
                var r = e.color;
                r && r.length || (r = this._themeConfig.color || n.color), this._zr.getColor = function (e) {
                ...
                function t(t) {
                    ...
                    if (o)
                        if (o instanceof Array)
                            for (var n = o.length; n--;) e[t][n].data = s.clone(o[n].data);
            ...
            _setTimelineOption: function (e) {
                ...
                var i = t("./component/timeline"),
                    o = new i(this._themeConfig, this._messageCenter, this._zr, e, this);
            ...
            addData: function (t, e, i, o, r) {
                function a() {
                    if (c._zr) {
                        ...
                        for (var t = 0, e = L.length; e > t; t++) L[t].motionlessOnce = l.addDataAnimation && L[t].addDataAnimation;
                        c._messageCenter.dispatch(n.EVENT.REFRESH, null, {
                            option: l
                        }, c)
                    }
                }
                for (var h = t instanceof Array ? t : [
                        [t, e, i, o, r]
                    ], l = this.getOption(), d = this._optionRestore, c = this, p = 0, u = h.length; u > p; p++) {
                    t = h[p][0], e = h[p][1], i = h[p][2], o = h[p][3], r = h[p][4];
                    var g = d.series[t],
                        f = i ? "unshift" : "push",
                        m = i ? "pop" : "shift";
                    if (g) {
                        var _ = g.data,
                            y = l.series[t].data;
                        if (_[f](e), y[f](e), o || (_[m](), e = y[m]()), null != r) {
                            var x, v;
                            if (g.type === n.CHART_TYPE_PIE && (x = d.legend) && (v = x.data)) {
                                var b = l.legend.data;
                                if (v[f](r), b[f](r), !o) {
                                    var S = s.indexOf(v, e.name); - 1 != S && v.splice(S, 1), S = s.indexOf(b, e.name), -1 != S && b.splice(S, 1)
                                }
                            } else if (null != d.xAxis && null != d.yAxis) {
                                var T, z, C = g.xAxisIndex || 0;
                                (null == d.xAxis[C].type || "category" === d.xAxis[C].type) && (T = d.xAxis[C].data, z = l.xAxis[C].data, T[f](r), z[f](r), o || (T[m](), z[m]())), C = g.yAxisIndex || 0, "category" === d.yAxis[C].type && (T = d.yAxis[C].data, z = l.yAxis[C].data, T[f](r), z[f](r), o || (T[m](), z[m]()))
                            }
                        }
                ...
                for (var L = this._chartList, w = 0, E = function () {
                        w--, 0 === w && a()
                    }, p = 0, u = L.length; u > p; p++) l.addDataAnimation && L[p].addDataAnimation && (w++, L[p].addDataAnimation(h, E));
            ...
            _addMark: function (t, e, i) {
                ...
                if (n && (o = n[t])) {
                    ...
                    for (var d in e) "data" === d ? (h.data = h.data.concat(e.data), l.data = l.data.concat(e.data)) : "object" != typeof e[d] || null == h[d] ? h[d] = l[d] = e[d] : (s.merge(h[d], e[d], !0), s.merge(l[d], e[d], !0));
            ...
            _delMark: function (t, e, i) {
                var o, n, s, r = this._option.series;
                ...
                if (a > -1) {
                    s.splice(a, 1), this._optionRestore.series[t][i].data.splice(a, 1);
                    var c = this.chart[o.type];
            ...
            getConnectedDataURL: function (e) {
                ...
                for (var h in this._connected) i = this._connected[h].getDom(), o[h] = {
                    ...
                    right: i.offsetLeft + i.offsetWidth,
                    bottom: i.offsetTop + i.offsetHeight
                }, n = Math.min(n, o[h].left), s = Math.min(s, o[h].top), r = Math.max(r, o[h].right), a = Math.max(a, o[h].bottom);
                var l = document.createElement("div");
                l.style.position = "absolute", l.style.left = "-4000px", l.style.width = r - n + "px", l.style.height = a - s + "px", document.body.appendChild(l);
                var d = t("zrender").init(l),
                    c = t("zrender/shape/Image");
                for (var h in o) d.addShape(new c({
                    style: {
                        x: o[h].left - n,
                        y: o[h].top - s,
                        image: o[h].img
            ...
            showLoading: function (e) {
                ...
                var o = e.textStyle || {};
                e.textStyle = o;
                var r = s.merge(s.merge(s.clone(o), this._themeConfig.textStyle), n.textStyle);
                o.textFont = r.fontStyle + " " + r.fontWeight + " " + r.fontSize + "px " + r.fontFamily, o.text = e.text || this._option && this._option.loadingText || this._themeConfig.loadingText || n.loadingText, null != e.x && (o.x = e.x), null != e.y && (o.y = e.y), e.effectOption = e.effectOption || {}, e.effectOption.textStyle = o;
                var a = e.effect;
                return ("string" == typeof a || null == a) && (a = i[e.effect || this._option && this._option.loadingEffect || this._themeConfig.loadingEffect || n.loadingEffect] || i.spin), this._zr.showLoading(new a(e.effectOption)), this
            },
            ...
            setTheme: function (e) {
                ...
                if (!h) {
                    ...
                    i && i.fontFamily && i.fontFamily2 && (i.fontFamily = i.fontFamily2), i = n.textStyle, i.fontFamily = i.fontFamily2
                }
            ...
            _clearEffect: function () {
                this._zr.modLayer(n.EFFECT_ZLEVEL, {
                    motionBlur: !1
        ...
        return e.prototype = {
            ...
            buildPath: function (t, e) {
                var i = e.pointList,
                    o = i.length;
                if (0 !== o)
                    for (var n, s, r, a, h, l = 1e4, d = Math.ceil(o / l), c = i[0] instanceof Array, p = e.size ? e.size : 2, u = p, g = p / 2, f = 2 * Math.PI, m = 0; d > m; m++) {
                        t.beginPath(), n = m * l, s = n + l, s = s > o ? o : s;
                        for (var _ = n; s > _; _++)
                            if (e.random && (r = e["randomMap" + _ % 20] / 100, u = p * r * r, g = u / 2), c ? (a = i[_][0], h = i[_][1]) : (a = i[_].x, h = i[_].y), 3 > u) t.rect(a - g, h - g, u, u);
        ...
        function e(t, e, o, n, s, r) {
            i.call(this, t, e, o, n, s), this.axisType = r, this._axisList = [], this.refresh(n)
        }
        var i = t("./base"),
        ...
        return e.prototype = {
            ...
            axisBase: {
                _buildAxisLine: function () {
                    ...
                    var s = i.style;
                    "" !== this.option.name && (s.text = this.option.name, s.textPosition = this.option.nameLocation, s.textFont = this.getFont(this.option.nameTextStyle), this.option.nameTextStyle.align && (s.textAlign = this.option.nameTextStyle.align), this.option.nameTextStyle.baseline && (s.textBaseline = this.option.nameTextStyle.baseline), this.option.nameTextStyle.color && (s.textColor = this.option.nameTextStyle.color)), s.strokeColor = this.option.axisLine.lineStyle.color, s.lineWidth = t, this.isHorizontal() ? s.yStart = s.yEnd = this.subPixelOptimize(s.yEnd, t) : s.xStart = s.xEnd = this.subPixelOptimize(s.xEnd, t), s.lineType = this.option.axisLine.lineStyle.type, i = new o(i), this.shapeList.push(i)
                },
                _axisLabelClickable: function (t, e) {
                    return t ? (s.pack(e, void 0, -1, void 0, -1, e.style.text), e.hoverable = !0, e.clickable = !0, e.highlightStyle = {
                ...
                refixAxisShape: function (t, e) {
                    if (this.option.axisLine.onZero) {
                        ...
                        if (this.isHorizontal() && null != e)
                            for (var o = 0, n = this.shapeList.length; n > o; o++) "axisLine" === this.shapeList[o]._axisShape ? (this.shapeList[o].style.yStart = this.shapeList[o].style.yEnd = this.subPixelOptimize(e, this.shapeList[o].stylelineWidth), this.zr.modShape(this.shapeList[o].id)) : "axisTick" === this.shapeList[o]._axisShape && (i = this.shapeList[o].style.yEnd - this.shapeList[o].style.yStart, this.shapeList[o].style.yStart = e - i, this.shapeList[o].style.yEnd = e, this.zr.modShape(this.shapeList[o].id));
                        if (!this.isHorizontal() && null != t)
                            for (var o = 0, n = this.shapeList.length; n > o; o++) "axisLine" === this.shapeList[o]._axisShape ? (this.shapeList[o].style.xStart = this.shapeList[o].style.xEnd = this.subPixelOptimize(t, this.shapeList[o].stylelineWidth), this.zr.modShape(this.shapeList[o].id)) : "axisTick" === this.shapeList[o]._axisShape && (i = this.shapeList[o].style.xEnd - this.shapeList[o].style.xStart, this.shapeList[o].style.xStart = t, this.shapeList[o].style.xEnd = t + i, this.zr.modShape(this.shapeList[o].id))
                    }
                },
        ...
        }, r.inherits(e, i), t("../component").define("axis", e), e
        ...
        return e.prototype = {
            ...
            refixAxisShape: function (t) {
                for (var e, i, o, s = t.xAxis._axisList.concat(t.yAxis ? t.yAxis._axisList : []), r = s.length; r--;) o = s[r], o.type == n.COMPONENT_TYPE_AXIS_VALUE && o._min < 0 && o._max >= 0 && (o.isHorizontal() ? e = o.getCoord(0) : i = o.getCoord(0));
        ...
        }, s.inherits(e, i), t("../component").define("grid", e), e
        ...
        return e.prototype = {
            ...
            _getZoom: function () {
                ...
                for (var d, h = 0, l = t.length; l > h; h++)
                    if (d = t[h], d.type == r.CHART_TYPE_LINE || d.type == r.CHART_TYPE_BAR || d.type == r.CHART_TYPE_SCATTER || d.type == r.CHART_TYPE_K) {
                        for (var c = 0, p = o.length; p > c; c++)
                            ...
                            if (n[c] == (d.yAxisIndex || 0)) {
                                s.push(h);
                                break
                            } null == this.zoomOption.xAxisIndex && null == this.zoomOption.yAxisIndex && d.data && this.getDataFromOption(d.data[0]) instanceof Array && (d.type == r.CHART_TYPE_SCATTER || d.type == r.CHART_TYPE_LINE || d.type == r.CHART_TYPE_BAR) && s.push(h)
                    } var u = null != this._zoom.start ? this._zoom.start : null != this.zoomOption.start ? this.zoomOption.start : 0,
                    g = null != this._zoom.end ? this._zoom.end : null != this.zoomOption.end ? this.zoomOption.end : 100;
                u > g && (u += g, g = u - g, u -= g);
            ...
            _backupData: function () {
                ...
                for (var n = this.option.yAxis, s = this._zoom.yAxisIndex, i = 0, o = s.length; o > i; i++) this._originalData.yAxis[s[i]] = n[s[i]].data;
                for (var a, h = this.option.series, l = this._zoom.seriesIndex, i = 0, o = l.length; o > i; i++) a = h[l[i]], this._originalData.series[l[i]] = a.data, a.data && this.getDataFromOption(a.data[0]) instanceof Array && (a.type == r.CHART_TYPE_SCATTER || a.type == r.CHART_TYPE_LINE || a.type == r.CHART_TYPE_BAR) && (this._backupScale(), this._calculScatterMap(l[i]))
            },
            _calculScatterMap: function (e) {
                ...
                var s = new o(this.ecTheme, null, !1, {
                        xAxis: n,
                        series: this.option.series
                    }, this, "xAxis"),
                    r = this.option.series[e].xAxisIndex || 0;
                this._zoom.scatterMap[e].x = s.getAxis(r).getExtremum(), s.dispose(), n = h.clone(this.option.yAxis), "category" == n[0].type && (n[0].type = "value"), n[1] && "category" == n[1].type && (n[1].type = "value"), s = new o(this.ecTheme, null, !1, {
                    yAxis: n,
                    series: this.option.series
                }, this, "yAxis"), r = this.option.series[e].yAxisIndex || 0, this._zoom.scatterMap[e].y = s.getAxis(r).getExtremum(), s.dispose()
            },
            _buildBackground: function () {
                ...
                for (var i = 0, s = this._originalData.xAxis, a = this._zoom.xAxisIndex, h = 0, l = a.length; l > h; h++) i = Math.max(i, s[a[h]].length);
                for (var d = this._originalData.yAxis, c = this._zoom.yAxisIndex, h = 0, l = c.length; l > h; h++) i = Math.max(i, d[c[h]].length);
                for (var p, u = this._zoom.seriesIndex[0], g = this._originalData.series[u], f = Number.MIN_VALUE, m = Number.MAX_VALUE, h = 0, l = g.length; l > h; h++) p = this.getDataFromOption(g[h], 0), this.option.series[u].type == r.CHART_TYPE_K && (p = p[1]), isNaN(p) && (p = 0), f = Math.max(f, p), m = Math.min(m, p);
                var _ = f - m,
                    y = [],
                    x = t / (i - (i > 1 ? 1 : 0)),
                    v = e / (i - (i > 1 ? 1 : 0)),
                    b = 1;
                "horizontal" == this.zoomOption.orient && 1 > x ? b = Math.floor(3 * i / t) : "vertical" == this.zoomOption.orient && 1 > v && (b = Math.floor(3 * i / e));
                for (var h = 0, l = i; l > h; h += b) p = this.getDataFromOption(g[h], 0), this.option.series[u].type == r.CHART_TYPE_K && (p = p[1]), isNaN(p) && (p = 0), y.push("horizontal" == this.zoomOption.orient ? [this._location.x + x * h, this._location.y + e - 1 - Math.round((p - m) / _ * (e - 10))] : [this._location.x + 1 + Math.round((p - m) / _ * (t - 10)), this._location.y + v * (l - h - 1)]);
                "horizontal" == this.zoomOption.orient ? (y.push([this._location.x + t, this._location.y + e]), y.push([this._location.x, this._location.y + e])) : (y.push([this._location.x, this._location.y]), y.push([this._location.x, this._location.y + e])), this.shapeList.push(new n({
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
                        pointList: y,
            ...
            _syncData: function (t) {
                ...
                for (var a in this._originalData) {
                    ...
                    for (var h in e) s = e[h], null != s && (n = s.length, i = Math.floor(this._zoom.start / 100 * n), o = Math.ceil(this._zoom.end / 100 * n), this.getDataFromOption(s[0]) instanceof Array && this.option[a][h].type != r.CHART_TYPE_K ? (this._setScale(), this.option[a][h].data = this._synScatterData(h, s)) : this.option[a][h].data = s.slice(i, o))
                }
                this._isSilence || !this.zoomOption.realtime && !t || this.messageCenter.dispatch(r.EVENT.DATA_ZOOM, null, {
                    zoom: this._zoom
                }, this.myChart)
            },
            _synScatterData: function (t, e) {
                ...
                "horizontal" == this.zoomOption.orient ? (i = h.x.max - h.x.min, o = this._zoom.start / 100 * i + h.x.min, n = this._zoom.end / 100 * i + h.x.min, i = h.y.max - h.y.min, s = this._zoom.start2 / 100 * i + h.y.min, r = this._zoom.end2 / 100 * i + h.y.min) : (i = h.x.max - h.x.min, o = this._zoom.start2 / 100 * i + h.x.min, n = this._zoom.end2 / 100 * i + h.x.min, i = h.y.max - h.y.min, s = this._zoom.start / 100 * i + h.y.min, r = this._zoom.end / 100 * i + h.y.min);
                var l;
                (l = h.x.dataMappingMethods) && (o = l.coord2Value(o), n = l.coord2Value(n)), (l = h.y.dataMappingMethods) && (s = l.coord2Value(s), r = l.coord2Value(r));
                for (var d, c = 0, p = e.length; p > c; c++) d = e[c].value || e[c], d[0] >= o && d[0] <= n && d[1] >= s && d[1] <= r && a.push(e[c]);
                return a
            },
            _setScale: function () {
                ...
                for (var i in e)
                    for (var o = 0, n = e[i].length; n > o; o++) e[i][o].scale = t || e[i][o]._scale
            },
            _backupScale: function () {
                ...
                for (var e in t)
                    for (var i = 0, o = t[e].length; o > i; i++) t[e][i]._scale = t[e][i].scale
            },
            _getDetail: function () {
                ...
                if ("time" == p) {
                    g = u + f * this._zoom.end / 100, u += f * this._zoom.start / 100;
            ...
            ondragend: function (t, e) {
                this.isDragend && t.target && (!this.zoomOption.realtime && this._syncData(), e.dragOut = !0, e.dragIn = !0, this._isSilence || this.zoomOption.realtime || this.messageCenter.dispatch(r.EVENT.DATA_ZOOM, null, {
                    zoom: this._zoom
            ...
            rectZoom: function (t) {
                ...
                var o, n = (i.x - e.x) / e.width,
                    s = 1 - (i.x + i.width - e.x) / e.width,
                    r = 1 - (i.y + i.height - e.y) / e.height,
                    a = (i.y - e.y) / e.height;
                return "horizontal" == this.zoomOption.orient ? (o = this._zoom.end - this._zoom.start, this._zoom.start += o * n, this._zoom.end -= o * s, o = this._zoom.end2 - this._zoom.start2, this._zoom.start2 += o * r, this._zoom.end2 -= o * a) : (o = this._zoom.end - this._zoom.start, this._zoom.start += o * r, this._zoom.end -= o * a, o = this._zoom.end2 - this._zoom.start2, this._zoom.start2 += o * n, this._zoom.end2 -= o * s), this._syncShape(), this._syncData(!0), this._zoom
            },
            syncBackupData: function (t) {
                for (var e, i, o = this._originalData.series, n = t.series, s = 0, r = n.length; r > s; s++) {
                    i = n[s].data || n[s].eventList, e = o[s] ? Math.floor(this._zoom.start / 100 * o[s].length) : 0;
                    for (var a = 0, h = i.length; h > a; a++) o[s] && (o[s][a + e] = i[a])
                }
            },
        ...
        return t
    }), i("echarts/component/dataRange", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "../util/shape/HandlePolygon", "../config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "../component"], function (t) {
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s);
            var a = this;
            ...
            }, this._selectedMap = {}, this._range = {}, this.refresh(n), e.bind(r.EVENT.HOVER, this._onhoverlink)
        }
        var i = t("./base"),
            o = t("zrender/shape/Text"),
        ...
        return e.prototype = {
            ...
            _buildItem: function () {
                var t, e, i, s, r = this._valueTextList,
                    a = r.length,
                ...
                var m = !0;
                this.dataRangeOption.text && (m = !1, this.dataRangeOption.text[0] && (i = this._getTextShape(d, c, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? d += l.getTextWidth(this.dataRangeOption.text[0], h) + this._textGap : (c += f + this._textGap, i.style.y += f / 2 + this._textGap, i.style.textBaseline = "bottom"), this.shapeList.push(new o(i))));
                for (var _ = 0; a > _; _++) t = r[_], s = this.getColorByIndex(_), e = this._getItemShape(d, c, p, u, this._selectedMap[_] ? s : "#ccc"), e._idx = _, e.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (e.clickable = !0, e.onclick = this._dataRangeSelected), this.shapeList.push(new n(e)), m && (i = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
                        x: d + p + 5,
                        y: c,
                        color: this._selectedMap[_] ? this.dataRangeOption.textStyle.color : "#ccc",
                        text: r[_],
                        textFont: h,
                        textBaseline: "top"
                    },
                ...
                }, "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (i.style.x -= p + 10, i.style.textAlign = "right"), i._idx = _, i.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (i.clickable = !0, i.onclick = this._dataRangeSelected), this.shapeList.push(new o(i))), "horizontal" == this.dataRangeOption.orient ? d += p + (m ? 5 : 0) + (m ? l.getTextWidth(t, h) : 0) + g : c += u + g;
                !m && this.dataRangeOption.text[1] && ("horizontal" == this.dataRangeOption.orient ? d = d - g + this._textGap : c = c - g + this._textGap, i = this._getTextShape(d, c, this.dataRangeOption.text[1]), "horizontal" != this.dataRangeOption.orient && (i.style.y -= 5, i.style.textBaseline = "top"), this.shapeList.push(new o(i)))
            },
            _buildGradient: function () {
                var e, i, s = this.getFont(this.dataRangeOption.textStyle),
                    ...
                    p = 10,
                    u = !0;
                this.dataRangeOption.text && (u = !1, this.dataRangeOption.text[0] && (i = this._getTextShape(r, a, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? r += l.getTextWidth(this.dataRangeOption.text[0], s) + this._textGap : (a += c + this._textGap, i.style.y += c / 2 + this._textGap, i.style.textBaseline = "bottom"), this.shapeList.push(new o(i))));
                for (var g = t("zrender/tool/color"), f = 1 / (this.dataRangeOption.color.length - 1), m = [], _ = 0, y = this.dataRangeOption.color.length; y > _; _++) m.push([_ * f, this.dataRangeOption.color[_]]);
                "horizontal" == this.dataRangeOption.orient ? (e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
                        x: r,
                    ...
                    hoverable: !1
                }, a += d * p + this._textGap), this.shapeList.push(new n(e)), this._calculableLocation = e.style, this.dataRangeOption.calculable && (this._buildFiller(), this._bulidMask(), this._bulidHandle()), this._buildIndicator(), !u && this.dataRangeOption.text[1] && (i = this._getTextShape(r, a, this.dataRangeOption.text[1]), this.shapeList.push(new o(i)))
            },
            _buildIndicator: function () {
                var t, e, i = this._calculableLocation.x,
                    o = this._calculableLocation.y,
                    n = this._calculableLocation.width,
                    r = this._calculableLocation.height,
                    a = 5;
                "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (t = [
                    [i, o + r],
                    [i - a, o + r + a],
                    [i + a, o + r + a]
                ], e = "bottom") : (t = [
                    ...
                    [i - a, o - a],
                    [i + a, o - a]
                ], e = "top") : "right" != this.dataRangeOption.x ? (t = [
                    [i + n, o],
                    [i + n + a, o - a],
                    [i + n + a, o + a]
                ], e = "right") : (t = [
                    ...
                    style: {
                        ...
                        __rect: {
                            ...
                            width: a * ("horizontal" == this.dataRangeOption.orient ? 2 : 1),
                            height: a * ("horizontal" == this.dataRangeOption.orient ? 1 : 2)
                        }
                    },
                    highlightStyle: {
                        brushType: "fill",
            ...
            _buildFiller: function () {
                this._fillerShape = {
                    ...
                    _type: "filler"
                }, this._fillerShape = new n(this._fillerShape), this.shapeList.push(this._fillerShape)
            },
            _bulidHandle: function () {
                var t, e, i, o, n, r, a, h, d = this._calculableLocation.x,
                    ...
                    m = Math.max(l.getTextWidth(this._textFormat(this.dataRangeOption.max), g), l.getTextWidth(this._textFormat(this.dataRangeOption.min), g)) + 2;
                "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (t = [
                    [d, c],
                    [d, c + u + f],
                    [d - f, c + u + f],
                    ...
                    width: m + f,
                    height: f
                }) : (m += f, "right" != this.dataRangeOption.x ? (t = [
                    [d, c],
                    [d + p + f, c],
                    [d + p + f, c - f],
                    [d + p, c - 1],
                    [d, c - 1]
                ], e = d + p + m / 2 + f / 2, i = c - f / 2, o = {
                    x: d + p,
                    y: c - f,
                    width: m + f,
                    height: f
            ...
            _bulidMask: function () {
                ...
                this._startMask = {
                    ...
                    hoverable: !1
                }, this._startMask = new n(this._startMask), this._endMask = new n(this._endMask), this.shapeList.push(this._startMask), this.shapeList.push(this._endMask)
            },
            _buildBackground: function () {
            ...
            _getItemGroupLocation: function () {
                ...
                if ("horizontal" == this.dataRangeOption.orient) {
                    if (this.dataRangeOption.text || this._isContinuity()) s = (this._isContinuity() ? o * d + i : e * (o + i)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? l.getTextWidth(this.dataRangeOption.text[0], a) + this._textGap : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? l.getTextWidth(this.dataRangeOption.text[1], a) + this._textGap : 0);
                    else {
                        o += 5;
                        for (var c = 0; e > c; c++) s += o + l.getTextWidth(t[c], a) + i
                    }
                    s -= i, r = Math.max(h, n)
                } else {
                    var p;
                    if (this.dataRangeOption.text || this._isContinuity()) r = (this._isContinuity() ? n * d + i : e * (n + i)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? this._textGap + h : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? this._textGap + h : 0), p = Math.max(l.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", a), l.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", a)), s = Math.max(o, p);
                    else {
                        r = (n + i) * e, o += 5, p = 0;
                        for (var c = 0; e > c; c++) p = Math.max(p, l.getTextWidth(t[c], a));
                        s = o + p
                    }
                    r -= i
                }
                var u, g = this.reformCssArray(this.dataRangeOption.padding),
                    f = this.zr.getWidth();
                switch (this.dataRangeOption.x) {
                    ...
                    case "right":
                        ...
                        break;
                    default:
                        u = this.parsePercent(this.dataRangeOption.x, f), u = isNaN(u) ? 0 : u
                }
                var m, _ = this.zr.getHeight();
                switch (this.dataRangeOption.y) {
                    ...
                    case "center":
                        ...
                        break;
                    default:
                        m = this.parsePercent(this.dataRangeOption.y, _), m = isNaN(m) ? 0 : m
                }
                if (this.dataRangeOption.calculable) {
                    var y = Math.max(l.getTextWidth(this.dataRangeOption.max, a), l.getTextWidth(this.dataRangeOption.min, a)) + h;
                    "horizontal" == this.dataRangeOption.orient ? (y > u && (u = y), u + s + y > f && (u -= y)) : (h > m && (m = h), m + r + h > _ && (m -= h))
                }
                return {
                    x: u,
                    y: m,
            ...
            _getTextShape: function (t, e, i) {
                return {
                    ...
                    z: this.getZBase(),
                    style: {
                        x: "horizontal" == this.dataRangeOption.orient ? t : this._itemGroupLocation.x + this._itemGroupLocation.width / 2,
                        y: "horizontal" == this.dataRangeOption.orient ? this._itemGroupLocation.y + this._itemGroupLocation.height / 2 : e,
            ...
            __ondrift: function (t, e, i) {
                var o = this._calculableLocation.x,
                    ...
                    r = this._calculableLocation.height;
                return "horizontal" == this.dataRangeOption.orient ? t.style.x + e <= o ? t.style.x = o : t.style.x + e + t.style.width >= o + s ? t.style.x = o + s - t.style.width : t.style.x += e : t.style.y + i <= n ? t.style.y = n : t.style.y + i + t.style.height >= n + r ? t.style.y = n + r - t.style.height : t.style.y += i, "filler" == t._type ? this._syncHandleShape() : this._syncFillerShape(t), this.dataRangeOption.realtime && this._dispatchDataRange(), !0
            },
            __ondragend: function () {
                this.isDragend = !0
            },
            ondragend: function (t, e) {
                this.isDragend && t.target && (e.dragOut = !0, e.dragIn = !0, this.dataRangeOption.realtime || this._dispatchDataRange(), e.needRefresh = !1, this.isDragend = !1)
            },
            _syncShapeFromRange: function () {
                var t = this.dataRangeOption.range || {},
                    e = t.start,
                    i = t.end;
                if (e > i && (e = [i, i = e][0]), this._range.end = null != e ? e : null != this._range.end ? this._range.end : 0, this._range.start = null != i ? i : null != this._range.start ? this._range.start : 100, 100 != this._range.start || 0 !== this._range.end) {
                    if ("horizontal" == this.dataRangeOption.orient) {
                        var o = this._fillerShape.style.width;
                        this._fillerShape.style.x += o * (100 - this._range.start) / 100, this._fillerShape.style.width = o * (this._range.start - this._range.end) / 100
                    } else {
                        var n = this._fillerShape.style.height;
                        this._fillerShape.style.y += n * (100 - this._range.start) / 100, this._fillerShape.style.height = n * (this._range.start - this._range.end) / 100
                    }
            ...
            __dataRangeSelected: function (t) {
                ...
                var o, n;
                this._useCustomizedSplit() ? (o = this._splitList[i].max, n = this._splitList[i].min) : (o = (this._colorList.length - i) * this._gap + this.dataRangeOption.min, n = o - this._gap), this.messageCenter.dispatch(r.EVENT.DATA_RANGE_SELECTED, t.event, {
            ...
            __dispatchHoverLink: function (t) {
                var e, i;
                if (this.dataRangeOption.calculable) {
                    var o, n = this.dataRangeOption.max - this.dataRangeOption.min;
                    o = "horizontal" == this.dataRangeOption.orient ? (1 - (h.getX(t.event) - this._calculableLocation.x) / this._calculableLocation.width) * n : (1 - (h.getY(t.event) - this._calculableLocation.y) / this._calculableLocation.height) * n, e = o - .05 * n, i = o + .05 * n
                } else if (this._useCustomizedSplit()) {
                    var s = t.target._idx;
                    i = this._splitList[s].max, e = this._splitList[s].min
                } else {
                    var s = t.target._idx;
                    i = (this._colorList.length - s) * this._gap + this.dataRangeOption.min, e = i - this._gap
                }
                this.messageCenter.dispatch(r.EVENT.DATA_RANGE_HOVERLINK, t.event, {
                    valueMin: e,
                    valueMax: i
                }, this.myChart)
            },
            __onhoverlink: function (t) {
                if (this.dataRangeOption.show && this.dataRangeOption.hoverLink && this._indicatorShape && t && null != t.seriesIndex && null != t.dataIndex) {
                    var e = t.value;
                    if ("" === e || isNaN(e)) return;
                    e < this.dataRangeOption.min ? e = this.dataRangeOption.min : e > this.dataRangeOption.max && (e = this.dataRangeOption.max), this._indicatorShape.position = "horizontal" == this.dataRangeOption.orient ? [(this.dataRangeOption.max - e) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.width, 0] : [0, (this.dataRangeOption.max - e) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.height], this._indicatorShape.style.text = this._textFormat(t.value), this._indicatorShape.style.color = this.getColor(e), this.zr.addHoverShape(this._indicatorShape)
                }
            },
            _textFormat: function (t, e) {
                var i = this.dataRangeOption;
                if (t !== -Number.MAX_VALUE && (t = (+t).toFixed(i.precision)), null != e && e !== Number.MAX_VALUE && (e = (+e).toFixed(i.precision)), i.formatter) {
                    if ("string" == typeof i.formatter) return i.formatter.replace("{value}", t === -Number.MAX_VALUE ? "min" : t).replace("{value2}", e === Number.MAX_VALUE ? "max" : e);
                    if ("function" == typeof i.formatter) return i.formatter.call(this.myChart, t, e)
                }
                return null == e ? t : t === -Number.MAX_VALUE ? "< " + e : e === Number.MAX_VALUE ? "> " + t : t + " - " + e
            },
            _isContinuity: function () {
                var t = this.dataRangeOption;
                return !(t.splitList ? t.splitList.length > 0 : t.splitNumber > 0) || t.calculable
            },
            ...
            _buildColorList: function (t) {
                if (this._colorList = d.getGradientColors(this.dataRangeOption.color, Math.max((t - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1), 0) + 1), this._colorList.length > t) {
                    for (var e = this._colorList.length, i = [this._colorList[0]], o = e / (t - 1), n = 1; t - 1 > n; n++) i.push(this._colorList[Math.floor(n * o)]);
                    i.push(this._colorList[e - 1]), this._colorList = i
                }
                if (this._useCustomizedSplit())
                    for (var s = this._splitList, n = 0, e = s.length; e > n; n++) s[n].color && (this._colorList[n] = s[n].color)
            },
            _buildGap: function (t) {
                if (!this._useCustomizedSplit()) {
                    var e = this.dataRangeOption.precision;
                    for (this._gap = (this.dataRangeOption.max - this.dataRangeOption.min) / t; this._gap.toFixed(e) - 0 != this._gap && 5 > e;) e++;
                    this.dataRangeOption.precision = e, this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / t).toFixed(e) - 0
                }
            },
            _buildDataList: function (t) {
                for (var e = this._valueTextList = [], i = this.dataRangeOption, o = this._useCustomizedSplit(), n = 0; t > n; n++) {
                    this._selectedMap[n] = !0;
                    var s = "";
                    if (o) {
                        var r = this._splitList[t - 1 - n];
                        s = null != r.label ? r.label : null != r.single ? this._textFormat(r.single) : this._textFormat(r.min, r.max)
                    } else s = this._textFormat(n * this._gap + i.min, (n + 1) * this._gap + i.min);
                    e.unshift(s)
                }
            },
            _buildSplitList: function () {
                if (this._useCustomizedSplit())
                    for (var t = this.dataRangeOption.splitList, e = this._splitList = [], i = 0, o = t.length; o > i; i++) {
                        var n = t[i];
                        if (!n || null == n.start && null == n.end) throw new Error("Empty item exists in splitList!");
                        var s = {
                            label: n.label,
                            color: n.color
                        };
                        s.min = n.start, s.max = n.end, s.min > s.max && (s.min = [s.max, s.max = s.min][0]), s.min === s.max && (s.single = s.max), null == s.min && (s.min = -Number.MAX_VALUE), null == s.max && (s.max = Number.MAX_VALUE), e.push(s)
                    }
            },
            refresh: function (t) {
                if (t) {
                    this.option = t, this.option.dataRange = this.reformOption(this.option.dataRange);
                    var e = this.dataRangeOption = this.option.dataRange;
                    if (!this._useCustomizedSplit() && (null == e.min || null == e.max)) throw new Error("option.dataRange.min or option.dataRange.max has not been defined.");
                    this.myChart.canvasSupported || (e.realtime = !1);
                    var i = this._isContinuity() ? 100 : this._useCustomizedSplit() ? e.splitList.length : e.splitNumber;
            ...
            getColor: function (t) {
                ...
                if (this._useCustomizedSplit()) {
                    ...
                    if (t < this.dataRangeOption.min ? t = this.dataRangeOption.min : t > this.dataRangeOption.max && (t = this.dataRangeOption.max), this.dataRangeOption.calculable && (t - (this._gap * this._range.start + this.dataRangeOption.min) > 5e-5 || t - (this._gap * this._range.end + this.dataRangeOption.min) < -5e-5)) return null;
                    e = this._colorList.length - Math.ceil((t - this.dataRangeOption.min) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._colorList.length), e == this._colorList.length && e--
                }
                return this._selectedMap[e] ? this._colorList[e] : null
            },
            getColorByIndex: function (t) {
                return t >= this._colorList.length ? t = this._colorList.length - 1 : 0 > t && (t = 0), this._colorList[t]
            },
            onbeforDispose: function () {
                this.messageCenter.unbind(r.EVENT.HOVER, this._onhoverlink)
            }
        }, a.inherits(e, i), t("../component").define("dataRange", e), e
        ...
        function o(t, i, o, s) {
            if (i.hasOwnProperty(o)) {
                var r = t[o];
                "object" != typeof r || _[y.call(r)] || e(r) ? !s && o in t || (t[o] = i[o]) : n(t[o], i[o], s)
            }
        }
        ...
        function s() {
            if (!p)
                if (t("../dep/excanvas"), window.G_vmlCanvasManager) {
                    ...
                    e.style.position = "absolute", e.style.top = "-1000px", document.body.appendChild(e), p = G_vmlCanvasManager.initElement(e).getContext("2d")
        ...
        function l(t, e, i) {
            if (t && e) {
                ...
                for (var o = [], n = 0, s = t.length; s > n; n++) o.push(e.call(i, t[n], n, t));
                return o
            }
        }
        ...
        function d(t, e, i) {
            if (t && e) {
                ...
                for (var o = [], n = 0, s = t.length; s > n; n++) e.call(i, t[n], n, t) && o.push(t[n]);
                return o
            }
        }
        ...
        function a(t, e, i, o, n, s, r) {
            F || (F = Y.getContext());
            for (var a = F.createRadialGradient(t, e, i, o, n, s), h = 0, l = r.length; l > h; h++) a.addColorStop(r[h][0], r[h][1]);
            return a.__nonRecursion = !0, a
        }

        function h(t, e, i, o, n) {
            F || (F = Y.getContext());
            for (var s = F.createLinearGradient(t, e, i, o), r = 0, a = n.length; a > r; r++) s.addColorStop(n[r][0], n[r][1]);
            return s.__nonRecursion = !0, s
        }

        function l(t, e, i) {
            t = g(t), e = g(e), t = A(t), e = A(e);
            for (var o = [], n = (e[0] - t[0]) / i, s = (e[1] - t[1]) / i, r = (e[2] - t[2]) / i, a = (e[3] - t[3]) / i, h = 0, l = t[0], d = t[1], p = t[2], u = t[3]; i > h; h++) o[h] = c([I(Math.floor(l), [0, 255]), I(Math.floor(d), [0, 255]), I(Math.floor(p), [0, 255]), u.toFixed(4) - 0], "rgba"), l += n, d += s, p += r, u += a;
        ...
        function u(t, e) {
            ...
            var i = A(t),
                o = i[3];
            return "undefined" == typeof o && (o = 1), t.indexOf("hsb") > -1 ? i = R(i) : t.indexOf("hsl") > -1 && (i = D(i)), e.indexOf("hsb") > -1 || e.indexOf("hsv") > -1 ? i = B(i) : e.indexOf("hsl") > -1 && (i = N(i)), i[3] = o, c(i, e)
        }
        ...
        function C(t) {
            if (Z[t] && (t = Z[t]), t = z(t), t = t.replace(/hsv/i, "hsb"), /^#[\da-f]{3}$/i.test(t)) {
        ...
        function L(t, e) {
            ...
            for (var o = A(t), n = 0; 3 > n; n++) o[n] = 1 === i ? o[n] * (1 - e) | 0 : (255 - o[n]) * e + o[n] | 0;
            return "rgb(" + o.join(",") + ")"
        }
        ...
        function E(t, e, i) {
            ...
            for (var o = 2 * i - 1, n = A(g(t)), s = A(g(e)), r = n[3] - s[3], a = ((o * r === -1 ? o : (o + r) / (1 + o * r)) + 1) / 2, h = 1 - a, l = [], d = 0; 3 > d; d++) l[d] = n[d] * a + s[d] * h;
            var p = n[3] * i + s[3] * (1 - i);
            return p = Math.max(0, Math.min(1, p)), 1 === n[3] && 1 === s[3] ? c(l, "rgb") : (l[3] = p, c(l, "rgba"))
        }
        ...
        function A(t) {
            ...
            var i, o, n, s = [];
            if (e[2]) i = e[2].replace("#", "").split(""), n = [i[0] + i[1], i[2] + i[3], i[4] + i[5]], s = O(n, function (t) {
                return I(parseInt(t, 16), [0, 255])
            });
            else if (e[4]) {
                var r = e[4].split(",");
                o = r[3], n = r.slice(0, 3), s = O(n, function (t) {
                ...
                var a = (e[5] || e[6]).split(","),
                    ...
                    l = a[1],
                    d = a[2];
                o = a[3], s = O([l, d], function (t) {
                    return I(parseFloat(t) / 100, [0, 1])
                }), s.unshift(h), "undefined" != typeof o && s.push(I(parseFloat(o), [0, 1]))
            }
            return s
        }
        ...
        function R(t) {
            ...
            if (0 === s) e = 255 * r, i = 255 * r, o = 255 * r;
                ...
                var h = 0 | a,
                    ...
                    u = 0,
                    g = 0;
                0 === h ? (p = r, u = c, g = l) : 1 === h ? (p = d, u = r, g = l) : 2 === h ? (p = l, u = r, g = c) : 3 === h ? (p = l, u = d, g = r) : 4 === h ? (p = c, u = l, g = r) : (p = r, u = l, g = d), e = 255 * p, i = 255 * u, o = 255 * g
            }
            return [e, i, o]
        }
        ...
        function B(t) {
            ...
            if (0 === h) e = 0, i = 0;
                ...
                var d = ((a - o) / 6 + h / 2) / h,
                    c = ((a - n) / 6 + h / 2) / h,
                    p = ((a - s) / 6 + h / 2) / h;
                o === a ? e = p - c : n === a ? e = 1 / 3 + d - p : s === a && (e = 2 / 3 + c - d), 0 > e && (e += 1), e > 1 && (e -= 1)
            }
    ...
    }), i("echarts/util/shape/GaugePointer", ["require", "zrender/shape/Base", "zrender/tool/util", "./normalIsCover"], function (t) {
        function e(t) {
            i.call(this, t)
        }
        var i = t("zrender/shape/Base"),
        ...
        return e.prototype = {
            ...
            buildPath: function (t, e) {
                ...
                n = e.angle - Math.PI / 2, t.moveTo(s, r), t.lineTo(e.x + Math.cos(n) * o, e.y - Math.sin(n) * o), t.lineTo(e.x + Math.cos(e.angle) * i, e.y - Math.sin(e.angle) * i), t.lineTo(e.x - Math.cos(n) * o, e.y + Math.sin(n) * o), t.lineTo(s, r)
            },
            getRect: function (t) {
        ...
        return o.prototype = {
            ...
            brush: function (t, i) {
                ...
                if (i && (o = this.getHighlightStyle(o, this.highlightStyle || {})), "undefined" != typeof o.text && o.text !== !1) {
                    ...
                    var n, s = (o.text + "").split("\n"),
                        r = e.getTextHeight("国", o.textFont),
                        a = this.getRect(o),
                        h = o.x;
                    n = "top" == o.textBaseline ? a.y : "bottom" == o.textBaseline ? a.y + r : a.y + r / 2;
                    for (var l = 0, d = s.length; d > l; l++) {
                        if (o.maxWidth) switch (o.brushType) {
                            ...
                            case "stroke":
                                ...
                                break;
                            case "both":
                                t.fillText(s[l], h, n, o.maxWidth), t.strokeText(s[l], h, n, o.maxWidth);
                                break;
                            default:
                                t.fillText(s[l], h, n, o.maxWidth)
            ...
            getRect: function (t) {
                ...
                var s;
                return s = "top" == t.textBaseline ? t.y : "bottom" == t.textBaseline ? t.y - o : t.y - o / 2, t.__rect = {
                    x: n,
                    y: s,
                    width: i,
                    height: o
        ...
        return i.prototype = {
            ...
            _buildRadiusPath: function (t, e) {
                var i, o, n, s, r = e.x,
                    ...
                    l = e.height,
                    d = e.radius;
                "number" == typeof d ? i = o = n = s = d : d instanceof Array ? 1 === d.length ? i = o = n = s = d[0] : 2 === d.length ? (i = n = d[0], o = s = d[1]) : 3 === d.length ? (i = d[0], o = s = d[1], n = d[2]) : (i = d[0], o = d[1], n = d[2], s = d[3]) : i = o = n = s = 0;
                var c;
                i + o > h && (c = i + o, i *= h / c, o *= h / c), n + s > h && (c = n + s, n *= h / c, s *= h / c), o + n > l && (c = o + n, o *= l / c, n *= l / c), i + s > l && (c = i + s, i *= l / c, s *= l / c), t.moveTo(r + i, a), t.lineTo(r + h - o, a), 0 !== o && t.quadraticCurveTo(r + h, a, r + h, a + o), t.lineTo(r + h, a + l - n), 0 !== n && t.quadraticCurveTo(r + h, a + l, r + h - n, a + l), t.lineTo(r + s, a + l), 0 !== s && t.quadraticCurveTo(r, a + l, r, a + l - s), t.lineTo(r, a + i), 0 !== i && t.quadraticCurveTo(r, a, r + i, a)
            },
            buildPath: function (t, e) {
        ...
        return l.prototype = {
            ...
            buildPath: function (t, i) {
                ...
                var d = e.cos(a),
                    c = e.sin(a);
                t.moveTo(d * s + o, c * s + n), t.lineTo(d * r + o, c * r + n), t.arc(o, n, r, a, h, !l), t.lineTo(e.cos(h) * s + o, e.sin(h) * s + n), 0 !== s && t.arc(o, n, s, h, a, l), t.closePath()
            },
            getRect: function (t) {
                if (t.__rect) return t.__rect;
                var n = t.x,
                    ...
                    g = t.clockWise;
                return g || (p = -p, u = -u), d > 1 ? i.arc(n, l, d, p, u, !g, s, a) : (s[0] = a[0] = n, s[1] = a[1] = l), i.arc(n, l, c, p, u, !g, r, h), o.min(s, s, r), o.max(a, a, h), t.__rect = {
                    x: s[0],
                    y: s[1],
                    width: a[0] - s[0],
                    height: a[1] - s[1]
        ...
        return s.prototype = {
            ...
            buildPath: function (t, e) {
                ...
                if (!(o.length < 2)) {
                    ...
                    if (e.smooth && "spline" !== e.smooth) {
                        ...
                        for (var a, h, l, d = 0; s - 1 > d; d++) a = r[2 * d], h = r[2 * d + 1], l = o[d + 1], t.bezierCurveTo(a[0], a[1], h[0], h[1], l[0], l[1])
                    } else if ("spline" === e.smooth && (o = i(o), s = o.length), e.lineType && "solid" != e.lineType) {
                        if ("dashed" == e.lineType || "dotted" == e.lineType) {
                            var c = (e.lineWidth || 1) * ("dashed" == e.lineType ? 5 : 1);
                            t.moveTo(o[0][0], o[0][1]);
                            for (var d = 1; s > d; d++) n(t, o[d - 1][0], o[d - 1][1], o[d][0], o[d][1], c)
                        }
                    } else {
                        t.moveTo(o[0][0], o[0][1]);
            ...
            updateControlPoints: function (t) {
                t.controlPointList = o(t.pointList, t.smooth, !1, t.smoothConstraint)
            },
            getRect: function (e) {
        ...
        function e(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o + e.height), t.lineTo(i + 5 * n, o + 14 * s), t.lineTo(i + e.width, o + 3 * s), t.lineTo(i + 13 * n, o), t.lineTo(i + 2 * n, o + 11 * s), t.lineTo(i, o + e.height), t.moveTo(i + 6 * n, o + 10 * s), t.lineTo(i + 14 * n, o + 2 * s), t.moveTo(i + 10 * n, o + 13 * s), t.lineTo(i + e.width, o + 13 * s), t.moveTo(i + 13 * n, o + 10 * s), t.lineTo(i + 13 * n, o + e.height)
        }
        ...
        function i(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o + e.height), t.lineTo(i + 5 * n, o + 14 * s), t.lineTo(i + e.width, o + 3 * s), t.lineTo(i + 13 * n, o), t.lineTo(i + 2 * n, o + 11 * s), t.lineTo(i, o + e.height), t.moveTo(i + 6 * n, o + 10 * s), t.lineTo(i + 14 * n, o + 2 * s), t.moveTo(i + 10 * n, o + 13 * s), t.lineTo(i + e.width, o + 13 * s)
        }
        ...
        function o(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i + 4 * n, o + 15 * s), t.lineTo(i + 9 * n, o + 13 * s), t.lineTo(i + 14 * n, o + 8 * s), t.lineTo(i + 11 * n, o + 5 * s), t.lineTo(i + 6 * n, o + 10 * s), t.lineTo(i + 4 * n, o + 15 * s), t.moveTo(i + 5 * n, o), t.lineTo(i + 11 * n, o), t.moveTo(i + 5 * n, o + s), t.lineTo(i + 11 * n, o + s), t.moveTo(i, o + 2 * s), t.lineTo(i + e.width, o + 2 * s), t.moveTo(i, o + 5 * s), t.lineTo(i + 3 * n, o + e.height), t.lineTo(i + 13 * n, o + e.height), t.lineTo(i + e.width, o + 5 * s)
        }
        ...
        function n(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o + 3 * s), t.lineTo(i + 6 * n, o + 3 * s), t.moveTo(i + 3 * n, o), t.lineTo(i + 3 * n, o + 6 * s), t.moveTo(i + 3 * n, o + 8 * s), t.lineTo(i + 3 * n, o + e.height), t.lineTo(i + e.width, o + e.height), t.lineTo(i + e.width, o + 3 * s), t.lineTo(i + 8 * n, o + 3 * s)
        }
        ...
        function s(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i + 6 * n, o), t.lineTo(i + 2 * n, o + 3 * s), t.lineTo(i + 6 * n, o + 6 * s), t.moveTo(i + 2 * n, o + 3 * s), t.lineTo(i + 14 * n, o + 3 * s), t.lineTo(i + 14 * n, o + 11 * s), t.moveTo(i + 2 * n, o + 5 * s), t.lineTo(i + 2 * n, o + 13 * s), t.lineTo(i + 14 * n, o + 13 * s), t.moveTo(i + 10 * n, o + 10 * s), t.lineTo(i + 14 * n, o + 13 * s), t.lineTo(i + 10 * n, o + e.height)
        }
        ...
        function r(t, e) {
            var i = e.x,
                ...
                s = e.height / 16,
                r = e.width / 2;
            t.lineWidth = 1.5, t.arc(i + r, o + r, r - n, 0, 2 * Math.PI / 3), t.moveTo(i + 3 * n, o + e.height), t.lineTo(i + 0 * n, o + 12 * s), t.lineTo(i + 5 * n, o + 11 * s), t.moveTo(i, o + 8 * s), t.arc(i + r, o + r, r - n, Math.PI, 5 * Math.PI / 3), t.moveTo(i + 13 * n, o), t.lineTo(i + e.width, o + 4 * s), t.lineTo(i + 11 * n, o + 5 * s)
        }
        ...
        function a(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o), t.lineTo(i, o + e.height), t.lineTo(i + e.width, o + e.height), t.moveTo(i + 2 * n, o + 14 * s), t.lineTo(i + 7 * n, o + 6 * s), t.lineTo(i + 11 * n, o + 11 * s), t.lineTo(i + 15 * n, o + 2 * s)
        }
        ...
        function h(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o), t.lineTo(i, o + e.height), t.lineTo(i + e.width, o + e.height), t.moveTo(i + 3 * n, o + 14 * s), t.lineTo(i + 3 * n, o + 6 * s), t.lineTo(i + 4 * n, o + 6 * s), t.lineTo(i + 4 * n, o + 14 * s), t.moveTo(i + 7 * n, o + 14 * s), t.lineTo(i + 7 * n, o + 2 * s), t.lineTo(i + 8 * n, o + 2 * s), t.lineTo(i + 8 * n, o + 14 * s), t.moveTo(i + 11 * n, o + 14 * s), t.lineTo(i + 11 * n, o + 9 * s), t.lineTo(i + 12 * n, o + 9 * s), t.lineTo(i + 12 * n, o + 14 * s)
        }
        ...
        function l(t, e) {
            var i = e.x,
                ...
                s = e.height - 2,
                r = Math.min(n, s) / 2;
            o += 2, t.moveTo(i + r + 3, o + r - 3), t.arc(i + r + 3, o + r - 3, r - 1, 0, -Math.PI / 2, !0), t.lineTo(i + r + 3, o + r - 3), t.moveTo(i + r, o), t.lineTo(i + r, o + r), t.arc(i + r, o + r, r, -Math.PI / 2, 2 * Math.PI, !0), t.lineTo(i + r, o + r), t.lineWidth = 1.5
        }
        ...
        function d(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            o -= s, t.moveTo(i + 1 * n, o + 2 * s), t.lineTo(i + 15 * n, o + 2 * s), t.lineTo(i + 14 * n, o + 3 * s), t.lineTo(i + 2 * n, o + 3 * s), t.moveTo(i + 3 * n, o + 6 * s), t.lineTo(i + 13 * n, o + 6 * s), t.lineTo(i + 12 * n, o + 7 * s), t.lineTo(i + 4 * n, o + 7 * s), t.moveTo(i + 5 * n, o + 10 * s), t.lineTo(i + 11 * n, o + 10 * s), t.lineTo(i + 10 * n, o + 11 * s), t.lineTo(i + 6 * n, o + 11 * s), t.moveTo(i + 7 * n, o + 14 * s), t.lineTo(i + 9 * n, o + 14 * s), t.lineTo(i + 8 * n, o + 15 * s), t.lineTo(i + 7 * n, o + 15 * s)
        }
        ...
        function p(t, e) {
            var i = e.x,
                ...
                s = e.height,
                r = Math.min(n, s) / 2;
            t.moveTo(i + n, o + s / 2), t.arc(i + r, o + r, r, 0, 2 * Math.PI), t.arc(i + r, o, r, Math.PI / 4, Math.PI / 5 * 4), t.arc(i, o + r, r, -Math.PI / 3, Math.PI / 3), t.arc(i + n, o + s, r, Math.PI, Math.PI / 2 * 3), t.lineWidth = 1.5
        }

        function u(t, e) {
            for (var i = e.x, o = e.y, n = e.width, s = e.height, r = Math.round(s / 3), a = Math.round((r - 2) / 2), h = 3; h--;) t.rect(i, o + r * h + a, n, 2)
        }

        function g(t, e) {
            for (var i = e.x, o = e.y, n = e.width, s = e.height, r = Math.round(n / 3), a = Math.round((r - 2) / 2), h = 3; h--;) t.rect(i + r * h + a, o, 2, s)
        }
        ...
        function m(t, e) {
            var i = e.x,
                ...
                n = e.width / 16,
                s = e.height / 16;
            t.moveTo(i, o), t.lineTo(i, o + e.height), t.lineTo(i + e.width, o + e.height), t.lineTo(i + e.width, o), t.lineTo(i, o), t.moveTo(i + 4 * n, o), t.lineTo(i + 4 * n, o + 8 * s), t.lineTo(i + 12 * n, o + 8 * s), t.lineTo(i + 12 * n, o), t.moveTo(i + 6 * n, o + 11 * s), t.lineTo(i + 6 * n, o + 13 * s), t.lineTo(i + 10 * n, o + 13 * s), t.lineTo(i + 10 * n, o + 11 * s), t.lineTo(i + 6 * n, o + 11 * s)
        }
        ...
        function _(t, e) {
            var i = e.x,
                ...
                n = e.width,
                s = e.height;
            t.moveTo(i, o + s / 2), t.lineTo(i + n, o + s / 2), t.moveTo(i + n / 2, o), t.lineTo(i + n / 2, o + s)
        }
        ...
        function v(t, e) {
            var i = e.width / 2,
                ...
                s = e.y + o,
                r = Math.min(i, o);
            t.moveTo(n, s - r), t.lineTo(n + r, s + r), t.lineTo(n - r, s + r), t.lineTo(n, s - r), t.closePath()
        }
        ...
        function b(t, e) {
            var i = e.width / 2,
                ...
                s = e.y + o,
                r = Math.min(i, o);
            t.moveTo(n, s - r), t.lineTo(n + r, s), t.lineTo(n, s + r), t.lineTo(n - r, s), t.lineTo(n, s - r), t.closePath()
        }
        ...
        function L(t, e) {
            var i = e.x,
                ...
                s = e.height / 2,
                r = Math.min(n, s);
            t.arc(i + n, o + s, r, Math.PI / 5 * 4, Math.PI / 5), t.lineTo(i + n, o + s + 1.5 * r), t.closePath()
        }

        function w(e, i, o) {
            var n = t("zrender/shape/Image");
            this._imageShape = this._imageShape || new n({
                style: {}
            });
        ...
        return E.prototype = {
            ...
            isCover: function (t, e) {
                ...
                return t >= o.x - n && t <= o.x + o.width + n && e >= o.y - n && e <= o.y + o.height + n
            }
        }, M.inherits(E, A), E
            ...
            buildPath: function (e, i) {
                ...
                if (!(n.length < 2))
                    if (i.smooth) {
                        ...
                        for (var r, a, h, l = n.length, d = 0; l - 3 > d; d++) r = s[2 * d], a = s[2 * d + 1], h = n[d + 1], e.bezierCurveTo(r[0], r[1], a[0], a[1], h[0], h[1]);
                        e.lineTo(n[l - 2][0], n[l - 2][1]), e.lineTo(n[l - 1][0], n[l - 1][1]), e.lineTo(n[0][0], n[0][1])
        ...
        return s.prototype = {
            ...
            buildPath: function (t, e) {
                ...
                if (!(s.length < 2)) {
                    if (e.smooth && "spline" !== e.smooth) {
                        ...
                        for (var a, h, l, d = s.length, c = 0; d > c; c++) a = r[2 * c], h = r[2 * c + 1], l = s[(c + 1) % d], t.bezierCurveTo(a[0], a[1], h[0], h[1], l[0], l[1])
                    } else if ("spline" === e.smooth && (s = i(s, !0)), e.lineType && "solid" != e.lineType) {
                        if ("dashed" == e.lineType || "dotted" == e.lineType) {
                            var p = e._dashLength || (e.lineWidth || 1) * ("dashed" == e.lineType ? 5 : 1);
                            e._dashLength = p, t.moveTo(s[0][0], s[0][1]);
                            for (var c = 1, u = s.length; u > c; c++) n(t, s[c - 1][0], s[c - 1][1], s[c][0], s[c][1], p);
                            n(t, s[s.length - 1][0], s[s.length - 1][1], s[0][0], s[0][1], p)
                        }
                    } else {
                        t.moveTo(s[0][0], s[0][1]);
                        for (var c = 1, u = s.length; u > c; c++) t.lineTo(s[c][0], s[c][1]);
            ...
            getRect: function (t) {
                if (t.__rect) return t.__rect;
                for (var e = Number.MAX_VALUE, i = Number.MIN_VALUE, o = Number.MAX_VALUE, n = Number.MIN_VALUE, s = t.pointList, r = 0, a = s.length; a > r; r++) s[r][0] < e && (e = s[r][0]), s[r][0] > i && (i = s[r][0]), s[r][1] < o && (o = s[r][1]), s[r][1] > n && (n = s[r][1]);
                var h;
        ...
        function o(t, e, i, o) {
            ...
            switch (n) {
                ...
                case "sector":
                    ...
                    return e.clockWise || (s = -s, l = -l), g(e.x, e.y, e.r0, e.r, s, l, !e.clockWise, i, o);
                case "path":
                    return e.pathArray && b(e.pathArray, Math.max(e.lineWidth, 5), e.brushType, i, o);
                case "polygon":
                case "star":
                case "isogon":
        ...
        function r(t, e, i, o, n, s, r) {
            ...
            var a = Math.max(n, 5),
                h = 0,
                l = t;
            if (r > e + a && r > o + a || e - a > r && o - a > r || s > t + a && s > i + a || t - a > s && i - a > s) return !1;
        ...
        function a(t, e, i, o, n, s, r, a, h, l, d) {
            if (0 === h) return !1;
            var c = Math.max(h, 5);
            if (d > e + c && d > o + c && d > s + c && d > a + c || e - c > d && o - c > d && s - c > d && a - c > d || l > t + c && l > i + c && l > n + c && l > r + c || t - c > l && i - c > l && n - c > l && r - c > l) return !1;
        ...
        function h(t, e, i, o, n, s, r, a, h) {
            if (0 === r) return !1;
            var l = Math.max(r, 5);
            if (h > e + l && h > o + l && h > s + l || e - l > h && o - l > h && s - l > h || a > t + l && a > i + l && a > n + l || t - l > a && i - l > a && n - l > a) return !1;
        ...
        function l(t, i, o, n, s, r, a, h, l) {
            ...
            return 0 > u && (u += O), u >= n && s >= u || u + O >= n && s >= u + O
        }
        ...
        function y(t, e, i, o, n, s, r, a, h, l) {
            if (l > e && l > o && l > s && l > a || e > l && o > l && s > l && a > l) return 0;
            var d = L.cubicRootAt(e, o, s, a, l, I);
            if (0 === d) return 0;
            for (var c, p, u = 0, g = -1, f = 0; d > f; f++) {
                var m = I[f],
                    y = L.cubicAt(t, i, n, r, m);
                h > y || (0 > g && (g = L.cubicExtrema(e, o, s, a, P), P[1] < P[0] && g > 1 && _(), c = L.cubicAt(e, o, s, a, P[0]), g > 1 && (p = L.cubicAt(e, o, s, a, P[1]))), u += 2 == g ? m < P[0] ? e > c ? 1 : -1 : m < P[1] ? c > p ? 1 : -1 : p > a ? 1 : -1 : m < P[0] ? e > c ? 1 : -1 : c > a ? 1 : -1)
            }
            return u
        }
            ...
            for (var c = 0, p = 0; 2 > p; p++) {
                ...
                if (u + t > a) {
                    var g = Math.atan2(h, u),
                        d = r ? 1 : -1;
                    0 > g && (g = O + g), (g >= n && s >= g || g + O >= n && s >= g + O) && (g > Math.PI / 2 && g < 1.5 * Math.PI && (d = -d), c += d)
                }
            }
            return c
        }
        ...
        function b(t, e, i, o, n) {
            var s = 0,
                ...
                f = !0;
            i = i || "fill";
            for (var _ = "stroke" === i || "both" === i, b = "fill" === i || "both" === i, S = 0; S < t.length; S++) {
                var T = t[S],
                    z = T.points;
                if (g || "M" === T.command) {
                    if (S > 0 && (b && (s += m(d, c, p, u, o, n)), 0 !== s)) return !0;
                    p = z[z.length - 2], u = z[z.length - 1], g = !1, f && "A" !== T.command && (f = !1, d = p, c = u)
                }
                switch (T.command) {
                    case "M":
                        d = z[0], c = z[1];
                    ...
                    case "L":
                        ...
                        break;
                    case "C":
                        if (_ && a(d, c, z[0], z[1], z[2], z[3], z[4], z[5], e, o, n)) return !0;
                        b && (s += y(d, c, z[0], z[1], z[2], z[3], z[4], z[5], o, n)), d = z[4], c = z[5];
                        break;
                    case "Q":
                        if (_ && h(d, c, z[0], z[1], z[2], z[3], e, o, n)) return !0;
                        b && (s += x(d, c, z[0], z[1], z[2], z[3], o, n)), d = z[2], c = z[3];
                        break;
                    case "A":
                        var C = z[0],
                            L = z[1],
                        ...
                        b && (s += v(C, L, E, M, M + A, 1 - z[7], I, n)), d = Math.cos(M + A) * w + C, c = Math.sin(M + A) * E + L;
                        break;
                    case "z":
        ...
        function S(t, e) {
            ...
            for (var o = 0, n = 0, s = t.length; s > n; n++) o = Math.max(z.measureText(t[n]).width, o);
            ...
            this.selectedMap = {}, this.lastShapeList = [], this.shapeHandler = {
                ...
                ondragover: function (t) {
                    ...
                    var i = e.highlightStyle,
                        ...
                        n = i.strokeColor,
                        r = i.lineWidth;
                    i.brushType = "stroke", i.strokeColor = s.ecTheme.calculableColor || l.calculableColor, i.lineWidth = "icon" === e.type ? 30 : 10, s.zr.addHoverShape(e), setTimeout(function () {
                        i && (i.brushType = o, i.strokeColor = n, i.lineWidth = r)
                    }, 20)
                },
                ondrop: function (t) {
        ...
        return i.prototype = {
            ...
            ondrop: function (t, e) {
                if (this.isDrop && t.target && !e.dragIn) {
                    ...
                    if (-1 === r) {
                        if (d.get(n, "seriesIndex") == s) return e.dragOut = e.dragIn = e.needRefresh = !0, void(this.isDrop = !1);
                        i = {
                            value: d.get(n, "value"),
                            name: d.get(n, "name")
                        }, this.type === l.CHART_TYPE_PIE && i.value < 0 && (i.value = 0);
                        for (var c = !1, p = a[s].data, g = 0, f = p.length; f > g; g++) p[g].name === i.name && "-" === p[g].value && (a[s].data[g].value = i.value, c = !0);
                        !c && a[s].data.push(i), h && h.add(i.name, n.style.color || n.style.strokeColor)
                    } else i = a[s].data[r] || "-", null != i.value ? (a[s].data[r].value = "-" != i.value ? u.accAdd(a[s].data[r].value, d.get(n, "value")) : d.get(n, "value"), (this.type === l.CHART_TYPE_FUNNEL || this.type === l.CHART_TYPE_PIE) && (h && 1 === h.getRelatedAmount(i.name) && this.component.legend.del(i.name), i.name += this.option.nameConnector + d.get(n, "name"), h && h.add(i.name, n.style.color || n.style.strokeColor))) : a[s].data[r] = "-" != i ? u.accAdd(a[s].data[r], d.get(n, "value")) : d.get(n, "value");
            ...
            _buildPosition: function () {
                ...
                for (var t, e, i, o, n = this.series, s = {
                        top: [],
                        bottom: [],
                        left: [],
                        right: [],
                        other: []
                    }, r = 0, a = n.length; a > r; r++) n[r].type === this.type && (n[r] = this.reformOption(n[r]), this.legendHoverLink = n[r].legendHoverLink || this.legendHoverLink, t = n[r].xAxisIndex, e = n[r].yAxisIndex, i = this.component.xAxis.getAxis(t), o = this.component.yAxis.getAxis(e), i.type === l.COMPONENT_TYPE_AXIS_CATEGORY ? s[i.getPosition()].push(r) : o.type === l.COMPONENT_TYPE_AXIS_CATEGORY ? s[o.getPosition()].push(r) : s.other.push(r));
                for (var h in s) s[h].length > 0 && this._buildSinglePosition(h, s[h]);
                this.addShapeList()
            },
            ...
            _mapData: function (t) {
                for (var e, i, o, n, s = this.series, r = 0, a = {}, h = "__kener__stack__", d = this.component.legend, c = [], p = 0, u = 0, g = t.length; g > u; u++) {
                    if (e = s[t[u]], o = e.name, this._sIndex2ShapeMap[t[u]] = this._sIndex2ShapeMap[t[u]] || this.query(e, "symbol") || this._symbol[u % this._symbol.length], d) {
                        if (this.selectedMap[o] = d.isSelected(o), this._sIndex2ColorMap[t[u]] = d.getColor(o), n = d.getItemShape(o)) {
                            var f = n.style;
                            if (this.type == l.CHART_TYPE_LINE) f.iconType = "legendLineIcon", f.symbol = this._sIndex2ShapeMap[t[u]];
                            else if (e.itemStyle.normal.barBorderWidth > 0) {
                                var m = n.highlightStyle;
                                f.brushType = "both", f.x += 1, f.y += 1, f.width -= 2, f.height -= 2, f.strokeColor = m.strokeColor = e.itemStyle.normal.barBorderColor, m.lineWidth = 3
                            }
                            d.setItemShape(o, n)
                        }
                    } else this.selectedMap[o] = !0, this._sIndex2ColorMap[t[u]] = this.zr.getColor(t[u]);
                    this.selectedMap[o] && (i = e.stack || h + t[u], null == a[i] ? (a[i] = r, c[r] = [t[u]], r++) : c[a[i]].push(t[u])), p = Math.max(p, e.data.length)
                }
                return {
                    locationMap: c,
                    maxDataLength: p
                ...
                for (var o = this.series, n = 0, s = e.length; s > n; n++)
                    for (var r = 0, a = e[n].length; a > r; r++) {
                        var h = e[n][r],
                            ...
                            c = t[h];
                        if ("-1" != i.indexOf("x")) {
                            c["counter" + l] > 0 && (c["average" + l] = c["sum" + l] / c["counter" + l]);
                            var p = this.component.xAxis.getAxis(o[h].xAxisIndex || 0).getCoord(c["average" + l]);
                            c["averageLine" + l] = [
                                [p, d.getYend()],
                                [p, d.getY()]
                            ], c["minLine" + l] = [
                        ...
                        if (l = "xy" == i ? 1 : "", "-1" != i.indexOf("y")) {
                            c["counter" + l] > 0 && (c["average" + l] = c["sum" + l] / c["counter" + l]);
                            var u = this.component.yAxis.getAxis(o[h].yAxisIndex || 0).getCoord(c["average" + l]);
                            c["averageLine" + l] = [
                                [d.getX(), u],
                                [d.getXend(), u]
                            ], c["minLine" + l] = [
            ...
            addLabel: function (t, e, i, o, n) {
                ...
                if (r.show) {
                    var d = t.style;
                    d.text = this._getLabelText(e, i, o, "normal"), d.textPosition = null == r.position ? "horizontal" === n ? "right" : "top" : r.position, d.textColor = h.color, d.textFont = this.getFont(h), d.textAlign = h.align, d.textBaseline = h.baseline
                }
                if (a.show) {
                    var c = t.highlightStyle;
                    c.text = this._getLabelText(e, i, o, "emphasis"), c.textPosition = r.show ? t.style.textPosition : null == a.position ? "horizontal" === n ? "right" : "top" : a.position, c.textColor = l.color, c.textFont = this.getFont(l), c.textAlign = l.align, c.textBaseline = l.baseline
                }
                return t
            },
            _getLabelText: function (t, e, i, o) {
                ...
                return n ? "function" == typeof n ? n.call(this.myChart, {
                    seriesName: t.name,
                    series: t,
                    name: i,
                    value: s,
                    data: e,
                    status: o
                }) : "string" == typeof n ? n = n.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{a0}", t.name).replace("{b0}", i).replace("{c0}", this.numAddCommas(s)) : void 0 : s instanceof Array ? null != s[2] ? this.numAddCommas(s[2]) : s[0] + " , " + s[1] : this.numAddCommas(s)
            },
            ...
            _buildMarkPoint: function (t) {
                for (var e, i, o = (this.markAttachStyle || {})[t], n = this.series[t], s = m.clone(n.markPoint), r = 0, a = s.data.length; a > r; r++) e = s.data[r], i = this.getMarkCoord(t, e), e.x = null != e.x ? e.x : i[0], e.y = null != e.y ? e.y : i[1], !e.type || "max" !== e.type && "min" !== e.type || (e.value = i[3], e.name = e.name || e.type, e.symbolSize = e.symbolSize || _.getTextWidth(i[3], this.getFont()) / 2 + 5);
                for (var h = this._markPoint(t, s), r = 0, a = h.length; a > r; r++) {
                    var d = h[r];
                ...
                if (this.type === l.CHART_TYPE_FORCE || this.type === l.CHART_TYPE_CHORD)
                    for (var r = 0, a = h.length; a > r; r++) this.zr.addShape(h[r])
            },
            _buildMarkLine: function (t) {
                for (var e, i = (this.markAttachStyle || {})[t], o = this.series[t], n = m.clone(o.markLine), s = 0, r = n.data.length; r > s; s++) {
                    var a = n.data[s];
                    !a.type || "max" !== a.type && "min" !== a.type && "average" !== a.type ? e = [this.getMarkCoord(t, a[0]), this.getMarkCoord(t, a[1])] : (e = this.getMarkCoord(t, a), n.data[s] = [m.clone(a), {}], n.data[s][0].name = a.name || a.type, n.data[s][0].value = "average" !== a.type ? e[3] : +e[3].toFixed(null != n.precision ? n.precision : this.deepQuery([this.ecTheme, l], "markLine.precision")), e = e[2], a = [{}, {}]), null != e && null != e[0] && null != e[1] && (n.data[s][0].x = null != a[0].x ? a[0].x : e[0][0], n.data[s][0].y = null != a[0].y ? a[0].y : e[0][1], n.data[s][1].x = null != a[1].x ? a[1].x : e[1][0], n.data[s][1].y = null != a[1].y ? a[1].y : e[1][1])
                }
                ...
                if (c) {
                    var p = new h({
                        ...
                        u = d[0];
                    if (u) {
                        m.merge(p.style, u.style), m.merge(p.highlightStyle = {}, u.highlightStyle), p.style.brushType = "stroke", p.zlevel = o.zlevel, p.z = o.z + 1, p.hoverable = !1;
                    ...
                    if (this.type === l.CHART_TYPE_FORCE || this.type === l.CHART_TYPE_CHORD)
                        for (var s = 0, r = d.length; r > s; s++) this.zr.addShape(d[s])
                }
            },
            _markPoint: function (t, e) {
                ...
                var n, s, r, a, h, c, p, u = [],
                    ...
                    y = this.zr.getWidth(),
                    x = this.zr.getHeight();
                if (e.large) n = this.getLargeMarkPointShape(t, e), n._mark = "largePoint", n && u.push(n);
                else
                    for (var v = 0, b = g.length; b > v; v++) null != g[v].x && null != g[v].y && (r = null != g[v].value ? g[v].value : "", _ && (s = _.getColor(i.name)), f && (s = isNaN(r) ? s : f.getColor(r), a = [g[v], e], h = this.deepQuery(a, "itemStyle.normal.color") || s, c = this.deepQuery(a, "itemStyle.emphasis.color") || h, null == h && null == c) || (s = null == s ? this.zr.getColor(t) : s, g[v].tooltip = g[v].tooltip || e.tooltip || {
                        trigger: "item"
                    }, g[v].name = null != g[v].name ? g[v].name : "", g[v].value = r, n = this.getSymbolShape(e, t, g[v], v, g[v].name, this.parsePercent(g[v].x, y), this.parsePercent(g[v].y, x), "pin", s, "rgba(0,0,0,0)", "horizontal"), n._mark = "point", p = this.deepMerge([g[v], e], "effect"), p.show && (n.effect = p), i.type === l.CHART_TYPE_MAP && (n._geo = this.getMarkGeo(g[v])), d.pack(n, i, t, g[v], v, g[v].name, r), u.push(n)));
                return u
            },
            _markLine: function () {
                function t(t, e) {
                ...
                return function (i, o) {
                    var n = this.series[i],
                        ...
                        r = s.dataRange,
                        a = s.legend;
                    m.merge(m.merge(o, m.clone(this.ecTheme.markLine || {})), m.clone(l.markLine));
                    var h = a ? a.getColor(n.name) : this.zr.getColor(i);
                    t(o, "symbol"), t(o, "symbolSize"), t(o, "symbolRotate");
                    for (var c = o.data, p = [], u = this.zr.getWidth(), g = this.zr.getHeight(), _ = 0; _ < c.length; _++) {
                        var y = c[_];
                        if (e(y[0]) && e(y[1])) {
                            ...
                            y[0].tooltip = x.tooltip || o.tooltip || {
                                trigger: "item"
                            }, y[0].name = y[0].name || "", y[1].name = y[1].name || "", y[0].value = S, p.push({
                                points: [
                                    [this.parsePercent(y[0].x, u), this.parsePercent(y[0].y, g)],
                                    [this.parsePercent(y[1].x, u), this.parsePercent(y[1].y, g)]
                                ],
                                rawData: y,
                                color: b
                            })
                    ...
                    if (C) {
                        var L = new f;
                        L.maxTurningAngle = this.query(o, "bundling.maxTurningAngle") / 180 * Math.PI, p = L.run(p)
                    }
                    o.name = n.name;
                    for (var w = [], _ = 0, E = p.length; E > _; _++) {
                        ...
                        O.show && (k.effect = O, k.effect.large = o.large), n.type === l.CHART_TYPE_MAP && (k._geo = [this.getMarkGeo(y[0]), this.getMarkGeo(y[1])]), d.pack(k, n, i, y[0], _, y[0].name + ("" !== y[1].name ? " > " + y[1].name : ""), S), w.push(k)
                    }
                    return w
                }
            }(),
            ...
            getSymbolShape: function (t, e, i, s, r, a, h, l, c, p, u) {
                ...
                m = "function" == typeof m ? m(f) : m, "number" == typeof m && (m = [m, m]);
                var _ = this.deepQuery(g, "symbolRotate"),
                    y = this.deepMerge(g, "itemStyle.normal"),
                    x = this.deepMerge(g, "itemStyle.emphasis"),
                    v = null != y.borderWidth ? y.borderWidth : y.lineStyle && y.lineStyle.width;
                null == v && (v = l.match("empty") ? 2 : 0);
                var b = null != x.borderWidth ? x.borderWidth : x.lineStyle && x.lineStyle.width;
                null == b && (b = v + 2);
                ...
                return l.match("image") && (L.style.image = l.replace(new RegExp("^image:\\/\\/"), ""), L = new o({
                    style: L.style,
                    highlightStyle: L.highlightStyle,
                    clickable: this.deepQuery(g, "clickable")
                })), null != _ && (L.rotation = [_ * Math.PI / 180, a, h]), l.match("star") && (L.style.iconType = "star", L.style.n = l.replace("empty", "").replace("star", "") - 0 || 5), "none" === l && (L.invisible = !0, L.hoverable = !1), L = this.addLabel(L, t, i, r, u), l.match("empty") && (null == L.style.textColor && (L.style.textColor = L.style.strokeColor), null == L.highlightStyle.textColor && (L.highlightStyle.textColor = L.highlightStyle.strokeColor)), d.pack(L, t, e, i, s, r), L._x = a, L._y = h, L._dataIndex = s, L._seriesIndex = e, L
            },
            getMarkLineShape: function (t, e, i, o, n, r, h) {
                var l = null != i[0].value ? i[0].value : "-",
                    ...
                    p = [i[0].symbolSize || t.symbolSize[0], i[1].symbolSize || t.symbolSize[1]];
                p[0] = "function" == typeof p[0] ? p[0](l) : p[0], p[1] = "function" == typeof p[1] ? p[1](d) : p[1];
                var u = [this.query(i[0], "symbolRotate") || t.symbolRotate[0], this.query(i[1], "symbolRotate") || t.symbolRotate[1]],
                    g = [i[0], i[1], t],
                    f = this.deepMerge(g, "itemStyle.normal");
                ...
                var S = r ? a : s,
                    T = new S({
                        style: {
                            ...
                            brushType: "both",
                            lineType: _.type,
                            shadowColor: _.shadowColor || _.color || f.borderColor || f.color || h,
                        ...
                        highlightStyle: {
                            ...
                            strokeColor: y.color || _.color || m.borderColor || f.borderColor || m.color || f.color || h,
                            lineWidth: v,
                            symbolBorderColor: m.borderColor || f.borderColor || m.color || f.color || h,
                            symbolBorder: null == m.borderWidth ? f.borderWidth + 2 : m.borderWidth
                        },
                        clickable: this.deepQuery(g, "clickable")
                    }),
                    z = T.style;
                return r ? (z.pointList = n, z.smooth = b) : (z.xStart = n[0][0], z.yStart = n[0][1], z.xEnd = n[1][0], z.yEnd = n[1][1], z.curveness = b, T.updatePoints(T.style)), T = this.addLabel(T, t, i[0], i[0].name + " : " + i[1].name)
            },
            getLargeMarkPointShape: function (t, e) {
                var i, o, n, s, a, h, l = this.series[t],
                    d = this.component,
                    c = e.data,
                    p = d.dataRange,
                    u = d.legend,
                    g = [c[0], e];
                if (u && (o = u.getColor(l.name)), !p || (n = null != c[0].value ? c[0].value : "", o = isNaN(n) ? o : p.getColor(n), s = this.deepQuery(g, "itemStyle.normal.color") || o, a = this.deepQuery(g, "itemStyle.emphasis.color") || s, null != s || null != a)) {
            ...
            addShapeList: function () {
                var t, e, i = this.option.animationThreshold / (this.canvasSupported ? 2 : 4),
                    ...
                    n = this.shapeList,
                    s = o.length > 0,
                    r = s ? this.query(this.option, "animationDurationUpdate") : this.query(this.option, "animationDuration"),
                ...
                if (this.option.animation && !this.option.renderAsImage && n.length < i && !this.motionlessOnce) {
                    for (var c = 0, p = o.length; p > c; c++) e = this._getAnimationKey(o[c]), e.match("undefined") ? this.zr.delShape(o[c].id) : (e += o[c].type, h[e] ? this.zr.delShape(o[c].id) : h[e] = o[c]);
                    for (var c = 0, p = n.length; p > c; c++) e = this._getAnimationKey(n[c]), e.match("undefined") ? this.zr.addShape(n[c]) : (e += n[c].type, d[e] = n[c]);
                    for (e in h) d[e] || this.zr.delShape(h[e].id);
                    for (e in d) h[e] ? (this.zr.delShape(h[e].id), this._animateMod(h[e], d[e], r, a, 0, s)) : (t = this.type != l.CHART_TYPE_LINE && this.type != l.CHART_TYPE_RADAR || 0 === e.indexOf("icon") ? 0 : r / 2, this._animateMod(!1, d[e], r, a, t, s));
                    this.zr.refresh(), this.animationEffect()
                } else {
                    this.motionlessOnce = !1, this.zr.delShape(o);
                    for (var c = 0, p = n.length; p > c; c++) this.zr.addShape(n[c])
                }
            },
            _getAnimationKey: function (t) {
                return this.type != l.CHART_TYPE_MAP && this.type != l.CHART_TYPE_TREEMAP && this.type != l.CHART_TYPE_VENN && this.type != l.CHART_TYPE_TREE ? d.get(t, "seriesIndex") + "_" + d.get(t, "dataIndex") + (t._mark ? t._mark : "") + (this.type === l.CHART_TYPE_RADAR ? d.get(t, "special") : "") : d.get(t, "seriesIndex") + "_" + d.get(t, "dataIndex") + (t._mark ? t._mark : "undefined")
            },
            _animateMod: function (t, e, i, o, n, s) {
                switch (e.type) {
                    ...
                    case "sector":
                    case "circle":
                        s ? "sector" === e.type ? c.sector(this.zr, t, e, i, o) : this.zr.addShape(e) : c.ring(this.zr, t, e, i + (d.get(e, "dataIndex") || 0) % 20 * 100, o);
                        break;
                    case "text":
                        c.text(this.zr, t, e, i, o);
                        break;
                    case "polygon":
                        s ? c.pointList(this.zr, t, e, i, o) : c.polygon(this.zr, t, e, i, o);
                        break;
                    case "ribbon":
            ...
            animationMark: function (t, e, i) {
                for (var i = i || this.shapeList, o = 0, n = i.length; n > o; o++) i[o]._mark && this._animateMod(!1, i[o], t, e, 0, !0);
            ...
            animationEffect: function (t) {
                if (!t && this.clearEffectShape(), t = t || this.shapeList, null != t) {
                    ...
                    for (var i, o = 0, n = t.length; n > o; o++) i = t[o], i._mark && i.effect && i.effect.show && p[i._mark] && (p[i._mark](this.zr, this.effectList, i, e), this.effectList[this.effectList.length - 1]._mark = i._mark)
                }
            },
            ...
            addMark: function (t, e, i) {
                ...
                if (this.selectedMap[o.name]) {
                    ...
                    if (o[i].data = e.data, this["_build" + i.replace("m", "M")](t), this.option.animation && !this.option.renderAsImage) this.animationMark(n, s, this.shapeList.slice(a));
                    else {
            ...
            delMark: function (t, e, i) {
                ...
                var o = this.series[t];
                if (this.selectedMap[o.name]) {
                    for (var n = !1, s = [this.shapeList, this.effectList], r = 2; r--;)
                        for (var a = 0, h = s[r].length; h > a; a++)
                            if (s[r][a]._mark == i && d.get(s[r][a], "seriesIndex") == t && d.get(s[r][a], "name") == e) {
        ...
        var n = t("../mixin/Eventful"),
            s = "function" == typeof window.addEventListener ? function (t) {
        ...
        var i = t("./tool/util"),
            ...
            l = {},
            d = {};
        d.version = "2.1.1", d.init = function (t) {
            var e = new c(n(), t);
            return l[e.id] = e, e
        ...
        var c = function (i, o) {
            this.id = i, this.env = t("./tool/env"), this.storage = new a, this.painter = new r(o, this.storage), this.handler = new s(o, this.storage, this.painter), this.animation = new h({
                stage: {
                    update: e(this)
                }
        ...
        return c.prototype.getId = function () {
            ...
            if (t.__animators) {
                for (var e = t.__animators, i = e.length, o = 0; i > o; o++) e[o].stop();
                e.length = 0
            }
            return this
        ...
        function e(t, e, o, n, r) {
            i.call(this, t, e, o, n, r), this._nameConnector, this._valueConnector, this._zrHeight = this.zr.getHeight(), this._zrWidth = this.zr.getWidth();
            var h = this;
            h.shapeHandler.onmousewheel = function (t) {
                ...
                var l = s.get(e, "name");
                e.style.text = l + ":" + n, s.set(e, "value", n), s.set(e, "name", l), h.zr.modShape(e.id), h.zr.refreshNextFrame(), a.stop(i)
            }
        }
        var i = t("./base"),
        ...
        return e.prototype = {
            ...
            resize: function () {
                ...
                if (1 !== i || 1 !== o) {
                    ...
                    for (var n = 0, s = this.shapeList.length; s > n; n++) this.zr.modShape(this.shapeList[n].id, {
                        style: {
            ...
            add: function (t) {
                ...
                "#fff" === h.style.color && (h.style.color = t.style.strokeColor), this.setCalculable(h), h.dragEnableTime = 0, s.pack(h, {
                    name: n
                }, -1, i, -1, e), h = new o(h), this.shapeList.push(h), this.zr.addShape(h)
            },
            del: function (t) {
        ...
        }, r.inherits(e, i), t("../chart").define("island", e), e
        ...
        return e.prototype = {
            ...
            _buildItem: function () {
                ...
                switch (s && (f.hoverable = !0, f.clickable = !0, f.onclick = function () {
                ...
                this.titleOption.textAlign && (g.style.textAlign = f.style.textAlign = this.titleOption.textAlign), this.shapeList.push(new o(g)), "" !== n && this.shapeList.push(new o(f))
            },
            _buildBackground: function () {
            ...
            _getItemGroupLocation: function () {
                var t, e = this.reformCssArray(this.titleOption.padding),
                    ...
                    h = a.getTextHeight(i, n) + ("" === o ? 0 : this.titleOption.itemGap + a.getTextHeight(o, s)),
                    l = this.zr.getWidth();
        ...
        }, r.inherits(e, i), t("../component").define("title", e), e
        ...
        e.prototype = {
            ...
            _buildItem: function () {
                var t, e, i, n, s, a, h, c, p = this.legendOption.data,
                    u = p.length,
                ...
                "vertical" === this.legendOption.orient && "right" === this.legendOption.x && (_ = this._itemGroupLocation.x + this._itemGroupLocation.width - x);
                for (var S = 0; u > S; S++) s = l.merge(p[S].textStyle || {}, g), a = this.getFont(s), t = this._getName(p[S]), h = this._getFormatterName(t), "" !== t ? (e = p[S].icon || this._getSomethingByName(t).type, c = this.getColor(t), "horizontal" === this.legendOption.orient ? 200 > f - _ && x + 5 + d.getTextWidth(h, a) + (S === u - 1 || "" === p[S + 1] ? 0 : b) >= f - _ && (_ = this._itemGroupLocation.x, y += v + b) : 200 > m - y && v + (S === u - 1 || "" === p[S + 1] ? 0 : b) >= m - y && ("right" === this.legendOption.x ? _ -= this._itemGroupLocation.maxWidth + b : _ += this._itemGroupLocation.maxWidth + b, y = this._itemGroupLocation.y), i = this._getItemShapeByType(_, y, x, v, this._selectedMap[t] && this._hasDataMap[t] ? c : "#ccc", e, c), i._name = t, i = new r(i), n = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
                        x: _ + x + 5,
                        y: y + v / 2,
                        color: this._selectedMap[t] ? "auto" === s.color ? c : s.color : "#ccc",
                        text: h,
                        textFont: a,
                        textBaseline: "middle"
                    },
                ...
                if ("horizontal" === this.legendOption.orient) {
                    ...
                    for (var m = 0; e > m; m++)
                        if ("" !== this._getName(t[m])) {
                            var _ = d.getTextWidth(this._getFormatterNameFromData(t[m]), t[m].textStyle ? this.getFont(l.merge(t[m].textStyle || {}, s)) : r);
                            g + o + _ + i > p ? (g -= i, a = Math.max(a, g), h += n + i, g = 0) : (g += o + _ + i, a = Math.max(a, g - i))
                        } else g -= i, a = Math.max(a, g), h += n + i, g = 0
                } else {
                    for (var m = 0; e > m; m++) f = Math.max(f, d.getTextWidth(this._getFormatterNameFromData(t[m]), t[m].textStyle ? this.getFont(l.merge(t[m].textStyle || {}, s)) : r));
                    f += o, a = f;
                    for (var m = 0; e > m; m++) "" !== this._getName(t[m]) ? g + n + i > u ? (a += f + i, g -= i, h = Math.max(h, g), g = 0) : (g += n + i, h = Math.max(h, g - i)) : (a += f + i, g -= i, h = Math.max(h, g), g = 0)
                }
            ...
            _getSomethingByName: function (t) {
                for (var e, i = this.option.series, o = 0, n = i.length; n > o; o++) {
                    ...
                    if (i[o].type === h.CHART_TYPE_PIE || i[o].type === h.CHART_TYPE_RADAR || i[o].type === h.CHART_TYPE_CHORD || i[o].type === h.CHART_TYPE_FORCE || i[o].type === h.CHART_TYPE_FUNNEL || i[o].type === h.CHART_TYPE_TREEMAP) {
                        e = i[o].categories || i[o].data || i[o].nodes;
                        for (var s = 0, r = e.length; r > s; s++)
                            if (e[s].name === t) return {
                                type: i[o].type,
                                series: i[o],
                                seriesIndex: o,
                                data: e[s],
            ...
            _getItemShapeByType: function (t, e, i, o, n, s, r) {
                ...
                switch (s) {
                    ...
                    case "scatter":
                        ...
                        break;
                    case "k":
                        d.style.brushType = "both", d.highlightStyle.lineWidth = 3, d.highlightStyle.color = d.style.color = this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.color") || "#fff", d.style.strokeColor = "#ccc" != n ? this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.lineStyle.color") || "#ff3200" : n;
                        break;
                    case "image":
                        d.style.iconType = "image", d.style.image = a, "#ccc" === n && (d.style.opacity = .5)
                }
                return d
            },
            ...
            refresh: function (t) {
                if (t) {
                    ...
                    var e, i, o, n, s = this.legendOption.data || [];
                    ...
                    for (var a = 0, l = s.length; l > a; a++) e = this._getName(s[a]), "" !== e && (i = this._getSomethingByName(e), i.series ? (this._hasDataMap[e] = !0, n = !i.data || i.type !== h.CHART_TYPE_PIE && i.type !== h.CHART_TYPE_FORCE && i.type !== h.CHART_TYPE_FUNNEL ? [i.series] : [i.data, i.series], o = this.getItemStyleColor(this.deepQuery(n, "itemStyle.normal.color"), i.seriesIndex, i.dataIndex, i.data), o && i.type != h.CHART_TYPE_K && this.setColor(e, o), this._selectedMap[e] = null != this._selectedMap[e] ? this._selectedMap[e] : !0) : this._hasDataMap[e] = !1)
                }
                this.clear(), this._buildShape()
            },
            getRelatedAmount: function (t) {
                for (var e, i = 0, o = this.option.series, n = 0, s = o.length; s > n; n++)
                    if (o[n].name === t && i++, o[n].type === h.CHART_TYPE_PIE || o[n].type === h.CHART_TYPE_RADAR || o[n].type === h.CHART_TYPE_CHORD || o[n].type === h.CHART_TYPE_FORCE || o[n].type === h.CHART_TYPE_FUNNEL) {
                        e = o[n].type != h.CHART_TYPE_FORCE ? o[n].data : o[n].categories;
                        for (var r = 0, a = e.length; a > r; r++) e[r].name === t && "-" != e[r].value && i++
                    } return i
            },
            ...
            add: function (t, e) {
                for (var i = this.legendOption.data, o = 0, n = i.length; n > o; o++)
        ...
        var c = {
            ...
            eventRiver: function (t, e) {
                var i = e.x,
                    ...
                    n = e.width,
                    s = e.height;
                t.moveTo(i, o + s), t.bezierCurveTo(i + n, o + s, i, o + 4, i + n, o + 4), t.lineTo(i + n, o), t.bezierCurveTo(i, o, i + n, o + s - 4, i, o + s - 4), t.lineTo(i, o + s)
            },
            k: function (t, e) {
                var i = e.x,
                    o = e.y,
            ...
            bar: function (t, e) {
                var i = e.x,
                    ...
                    s = e.height - 2,
                    r = 3;
                t.moveTo(i + r, o), t.lineTo(i + n - r, o), t.quadraticCurveTo(i + n, o, i + n, o + r), t.lineTo(i + n, o + s - r), t.quadraticCurveTo(i + n, o + s, i + n - r, o + s), t.lineTo(i + r, o + s), t.quadraticCurveTo(i, o + s, i, o + s - r), t.lineTo(i, o + r), t.quadraticCurveTo(i, o, i + r, o)
            },
            force: function (t, e) {
            ...
            radar: function (t, e) {
                var i = 6,
                    ...
                    l = n + s * Math.sin(a);
                t.moveTo(h, l), a += r;
                for (var d = 0, c = i - 1; c > d; d++) t.lineTo(o + s * Math.cos(a), n + s * Math.sin(a)), a += r;
                t.lineTo(h, l)
            }
        };
        ...
        function e(t, e, i, n, s) {
            ...
            if (r._onclick = function (t) {
                    ...
                    r.myChart._setOption(e, t.notMerge, !0), r.messageCenter.dispatch(a.EVENT.TIMELINE_CHANGED, null, {
                        currentIndex: r.currentIndex,
                        data: null != t.data[r.currentIndex].name ? t.data[r.currentIndex].name : t.data[r.currentIndex]
                    }, r.myChart)
                }, r._onFrame = function () {
        ...
        function i(t, e) {
            var i = 2,
                ...
                a = e.height - i,
                h = e.symbol;
            if ("last" === h) t.moveTo(o + r - 2, n + a / 3), t.lineTo(o + r - 2, n), t.lineTo(o + 2, n + a / 2), t.lineTo(o + r - 2, n + a), t.lineTo(o + r - 2, n + a / 3 * 2), t.moveTo(o, n), t.lineTo(o, n);
            else if ("next" === h) t.moveTo(o + 2, n + a / 3), t.lineTo(o + 2, n), t.lineTo(o + r - 2, n + a / 2), t.lineTo(o + 2, n + a), t.lineTo(o + 2, n + a / 3 * 2), t.moveTo(o, n), t.lineTo(o, n);
            else if ("play" === h)
                if ("stop" === e.status) t.moveTo(o + 2, n), t.lineTo(o + r - 2, n + a / 2), t.lineTo(o + 2, n + a), t.lineTo(o + 2, n);
                else {
                ...
                var d = "";
                d = h.replace(new RegExp("^image:\\/\\/"), ""), h = s.prototype.iconLibrary.image, h(t, {
                    x: o,
                    y: n,
                    width: r,
                    height: a,
        ...
        return e.prototype = {
            ...
            _getLocation: function () {
                ...
                null == e.width ? (t = o - n - s, s = o - s) : (t = this.parsePercent(e.width, o), s = n + t);
                var r, a, h = this.zr.getHeight(),
                    l = this.parsePercent(e.height, h);
                return null != e.y ? (r = this.parsePercent(e.y, h), a = r + l) : (a = h - this.parsePercent(e.y2, h), r = a - l), {
                    x: n + i[3],
                    y: r + i[0],
                    x2: s - i[1],
                    y2: a - i[2],
                ...
                if ("auto" === i) {
                    ...
                    if (s > 3) {
                        ...
                        for (i = 0; !h && s > i;) {
                            i++, h = !0;
                            for (var d = i; s > d; d += i) {
                                if (r = t[d].x - t[d - i].x, 0 !== e.label.rotate) a = o;
                                else if (n[d].textStyle) a = l.getTextWidth(t[d].name, t[d].textFont);
                                else {
                                    var c = t[d].name + "",
            ...
            _getChainPoint: function () {
                ...
                if (u > 1) {
                    var f = p / u;
                    if (f = f > 50 ? 50 : 20 > f ? 5 : f, p -= 2 * f, "number" === i.type)
                ...
                for (var _, y, x, v, b, S = [], m = 0; u > m; m++) d = g[m], _ = l[m].symbol && l[m].symbol.toLowerCase() || o, _.match("empty") ? (_ = _.replace("empty", ""), x = !0) : x = !1, _.match("star") && (y = _.replace("star", "") - 0 || 5, _ = "star"), e = l[m].textStyle ? h.merge(l[m].textStyle || {}, r) : r, v = e.align || "center", s ? (v = s > 0 ? "right" : "left", b = [s * Math.PI / 180, d, c - 5]) : b = !1, S.push({
                    x: d,
                    n: y,
                    isEmpty: x,
                    symbol: _,
            ...
            _buildControl: function () {
                ...
                if ("none" !== e.controlPosition) {
                    var n, r = o.itemSize,
                        a = o.itemGap;
                    "left" === e.controlPosition ? (n = this._location.x, this._location.x += 3 * (r + a)) : (n = this._location.x2 - (3 * (r + a) - a), this._location.x2 -= 3 * (r + a));
                    ...
                    this._ctrLastShape = new s(d), this._ctrLastShape.onclick = function () {
                        t.last()
                    }, this.shapeList.push(this._ctrLastShape), n += r + a, this._ctrPlayShape = new s(h.clone(d)), this._ctrPlayShape.style.brushType = "fill", this._ctrPlayShape.style.symbol = "play", this._ctrPlayShape.style.status = this.timelineOption.autoPlay ? "playing" : "stop", this._ctrPlayShape.style.x = n, this._ctrPlayShape.onclick = function () {
                        "stop" === t._ctrPlayShape.style.status ? t.play() : t.stop()
                    }, this.shapeList.push(this._ctrPlayShape), n += r + a, this._ctrNextShape = new s(h.clone(d)), this._ctrNextShape.style.symbol = "next", this._ctrNextShape.style.x = n, this._ctrNextShape.onclick = function () {
                        t.next()
            ...
            _buildHandle: function () {
                ...
                e = 5 > e ? 5 : e, this._handleShape = {
                    ...
                    ondrift: this._ondrift,
                    ondragend: this._ondragend
                }, this._handleShape = new s(this._handleShape), this.shapeList.push(this._handleShape)
            },
            _syncHandleShape: function () {
            ...
            _findChainIndex: function (t) {
                ...
                for (var o = 0; i - 1 > o; o++)
                    if (t >= e[o].x && t <= e[o + 1].x) return Math.abs(t - e[o].x) < Math.abs(t - e[o + 1].x) ? o : o + 1
            },
            ...
            __ondrift: function (t, e) {
                ...
                var s = o[i],
                    r = s.symbolSize + 2;
                if (t.style.iconType = s.symbol, t.style.n = s.n, t.style.textX = t.style.x + r / 2, t.style.y = this._location.y + this._location.height / 4 - r, t.style.width = 2 * r, t.style.height = 2 * r, t.style.text = s.name, i === this.currentIndex) return !0;
        ...
        }, s.prototype.iconLibrary.timelineControl = i, h.inherits(e, o), t("../component").define("timeline", e), e
        ...
        return i.prototype = {
            ...
            brush: function (t, e, i) {
                ...
                if (this._imageCache || (this._imageCache = {}), "string" == typeof n) {
                    var r = n;
                    this._imageCache[r] ? n = this._imageCache[r] : (n = new Image, n.onload = function () {
                        n.onload = null, s.modSelf(), i()
                    }, n.src = r, this._imageCache[r] = n)
                }
                if (n) {
        ...
        function e(t, e, s, r, a) {
            ...
            h._onmousemove = function (t) {
                ...
                h._mousein = !1
            }, this._tDom.className = "echarts-tooltip", this._tDom.style.position = "absolute", this.hasAppend = !1, this._axisLineShape && this.zr.delShape(this._axisLineShape.id), this._axisLineShape = new n({
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                invisible: !0,
                hoverable: !1
        ...
        return e.prototype = {
            ...
            _show: function (t, e, i, o) {
                ...
                t && ("function" == typeof t && (t = t([e, i])), t instanceof Array && (e = t[0], i = t[1])), e + s > this._zrWidth && (e -= s + 40), i + n > this._zrHeight && (i -= n - 20), 20 > i && (i = 0), this._tDom.style.cssText = this._gCssText + this._defaultCssText + (o ? o : "") + "left:" + e + "px;top:" + i + "px;", (10 > n || 10 > s) && setTimeout(this._refixed, 20), this.showing = !0
            },
            __refixed: function () {
                if (this._tDom) {
                    var t = "",
            ...
            _getNearestDataIndex: function (t, e) {
                ...
                if ("x" === t) {
                    for (var s, r, a = this.component.grid.getXend(), h = e.getCoordByIndex(i); a > h && (r = h, o >= h);) s = h, h = e.getCoordByIndex(++i);
                    return 0 >= i ? i = 0 : r - o >= o - s ? i -= 1 : null == e.getNameByIndex(i) && (i -= 1), i
                }
                for (var l, c, p = this.component.grid.getY(), h = e.getCoordByIndex(i); h > p && (l = h, h >= n);) c = h, h = e.getCoordByIndex(++i);
            ...
            _showAxisTrigger: function (t, e, i) {
                ...
                var o, n, s, r, h = this.option.series,
                    l = [],
                    c = [],
                    p = "";
                if ("axis" === this.option.tooltip.trigger) {
                    if (!this.option.tooltip.show) return;
                    n = this.option.tooltip.formatter, s = this.option.tooltip.position
                }
                ...
                if (f) {
                    ...
                    for (var _ = 0, y = h.length; y > _; _++) this._isSelected(h[_].name) && h[_][f + "Index"] === m && "axis" === this.deepQuery([h[_], this.option], "tooltip.trigger") && (r = this.query(h[_], "tooltip.showContent") || r, n = this.query(h[_], "tooltip.formatter") || n, s = this.query(h[_], "tooltip.position") || s, p += this._style(this.query(h[_], "tooltip")), null != h[_].stack && "xAxis" == f ? (l.unshift(h[_]), c.unshift(_)) : (l.push(h[_]), c.push(_)));
                    this.messageCenter.dispatch(a.EVENT.TOOLTIP_HOVER, this._event, {
                        seriesIndex: c,
                        dataIndex: i
                    }, this.myChart);
                    var x;
                    "xAxis" == f ? (u = this.subPixelOptimize(o.getCoordByIndex(i), this._axisLineWidth), g = d.getY(this._event), x = [u, this.component.grid.getY(), u, this.component.grid.getYend()]) : (u = d.getX(this._event), g = this.subPixelOptimize(o.getCoordByIndex(i), this._axisLineWidth), x = [this.component.grid.getX(), g, this.component.grid.getXend(), g]), this._styleAxisPointer(l, x[0], x[1], x[2], x[3], o.getGap(), u, g)
                ...
                if (l.length > 0) {
                    if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != c[0]) {
                        ...
                        if ("function" == typeof n) {
                            for (var S = [], _ = 0, y = l.length; y > _; _++) v = l[_].data[i], b = this.getDataFromOption(v, "-"), S.push({
                                seriesIndex: c[_],
                                seriesName: l[_].name || "",
                                series: l[_],
                                dataIndex: i,
                            ...
                            this._curTicket = "axis:" + i, this._tDom.innerHTML = n.call(this.myChart, S, this._curTicket, this._setContent)
                        } else if ("string" == typeof n) {
                            this._curTicket = 0 / 0, n = n.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}");
                            for (var _ = 0, y = l.length; y > _; _++) n = n.replace("{a" + _ + "}", this._encodeHTML(l[_].name || "")), n = n.replace("{b" + _ + "}", this._encodeHTML(o.getNameByIndex(i))), v = l[_].data[i], v = this.getDataFromOption(v, "-"), n = n.replace("{c" + _ + "}", v instanceof Array ? v : this.numAddCommas(v));
                            this._tDom.innerHTML = n
                        } else {
                            this._curTicket = 0 / 0, n = this._encodeHTML(o.getNameByIndex(i));
                            for (var _ = 0, y = l.length; y > _; _++) n += "<br/>" + this._encodeHTML(l[_].name || "") + " : ", v = l[_].data[i], v = this.getDataFromOption(v, "-"), n += v instanceof Array ? v : this.numAddCommas(v);
                            this._tDom.innerHTML = n
                        }
                    }
                    if (r === !1 || !this.option.tooltip.showContent) return;
                    this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(s, u + 10, g + 10, p)
                }
            },
            _showPolarTrigger: function (t, e) {
                if (null == this.component.polar || null == t || null == e || 0 > e) return !1;
                var i, o, n, s = this.option.series,
                    r = [],
                    a = [],
                    h = "";
                if ("axis" === this.option.tooltip.trigger) {
                ...
                for (var l = this.option.polar[t].indicator[e].text, c = 0, p = s.length; p > c; c++) this._isSelected(s[c].name) && s[c].polarIndex === t && "axis" === this.deepQuery([s[c], this.option], "tooltip.trigger") && (n = this.query(s[c], "tooltip.showContent") || n, i = this.query(s[c], "tooltip.formatter") || i, o = this.query(s[c], "tooltip.position") || o, h += this._style(this.query(s[c], "tooltip")), r.push(s[c]), a.push(c));
                if (r.length > 0) {
                    for (var u, g, f, m = [], c = 0, p = r.length; p > c; c++) {
                        u = r[c].data;
                        for (var _ = 0, y = u.length; y > _; _++) g = u[_], this._isSelected(g.name) && (g = null != g ? g : {
                            name: "",
                            value: {
                                dataIndex: "-"
                            }
                        }, f = this.getDataFromOption(g.value[e]), m.push({
                            seriesIndex: a[c],
                            seriesName: r[c].name || "",
                            series: r[c],
                            dataIndex: e,
            ...
            _showItemTrigger: function (t) {
                if (this._curTarget) {
                    var e, i, o, n = h.get(this._curTarget, "series"),
                    ...
                    if ("island" != this._curTarget._type) {
                        var _ = t ? "axis" : "item";
                        this.option.tooltip.trigger === _ && (e = this.option.tooltip.formatter, i = this.option.tooltip.position), this.query(n, "tooltip.trigger") === _ && (o = this.query(n, "tooltip.showContent") || o, e = this.query(n, "tooltip.formatter") || e, i = this.query(n, "tooltip.position") || i, m += this._style(this.query(n, "tooltip"))), o = this.query(r, "tooltip.showContent") || o, e = this.query(r, "tooltip.formatter") || e, i = this.query(r, "tooltip.position") || i, m += this._style(this.query(r, "tooltip"))
                    } else this._lastItemTriggerId = 0 / 0, o = this.deepQuery(f, "tooltip.showContent"), e = this.deepQuery(f, "tooltip.islandFormatter"), i = this.deepQuery(f, "tooltip.islandPosition");
                    this._lastDataIndex = -1, this._lastSeriesIndex = -1, this._lastItemTriggerId !== this._curTarget.id && (this._lastItemTriggerId = this._curTarget.id, "function" == typeof e ? (this._curTicket = (n.name || "") + ":" + l, this._tDom.innerHTML = e.call(this.myChart, {
                        seriesIndex: s,
                        seriesName: n.name || "",
                        series: n,
                        dataIndex: l,
                        ...
                        6: s,
                        7: l
                    }, this._curTicket, this._setContent)) : "string" == typeof e ? (this._curTicket = 0 / 0, e = e.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), e = e.replace("{a0}", this._encodeHTML(n.name || "")).replace("{b0}", this._encodeHTML(c)).replace("{c0}", p instanceof Array ? p : this.numAddCommas(p)), e = e.replace("{d}", "{d0}").replace("{d0}", u || ""), e = e.replace("{e}", "{e0}").replace("{e0}", h.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = e) : (this._curTicket = 0 / 0, this._tDom.innerHTML = n.type === a.CHART_TYPE_RADAR && u ? this._itemFormatter.radar.call(this, n, c, p, u) : n.type === a.CHART_TYPE_EVENTRIVER ? this._itemFormatter.eventRiver.call(this, n, c, p, r) : "" + (null != n.name ? this._encodeHTML(n.name) + "<br/>" : "") + ("" === c ? "" : this._encodeHTML(c) + " : ") + (p instanceof Array ? p : this.numAddCommas(p))));
                    var y = d.getX(this._event),
                        x = d.getY(this._event);
                    this.deepQuery(f, "tooltip.axisPointer.show") && this.component.grid ? this._styleAxisPointer([n], this.component.grid.getX(), x, this.component.grid.getXend(), x, 0, y, x) : this._hide(), o !== !1 && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(i, y + 20, x - 20, m))
                }
            },
            _itemFormatter: {
                radar: function (t, e, i, o) {
                    ...
                    for (var s = 0; s < o.length; s++) n += this._encodeHTML(o[s].text) + " : " + this.numAddCommas(i[s]) + "<br />";
                    return n
                },
                chord: function (t, e, i, o, n) {
                    ...
                    return "" + (null != t.name ? this._encodeHTML(t.name) + "<br/>" : "") + s + " -> " + r + " (" + this.numAddCommas(i) + ")<br />" + r + " -> " + s + " (" + this.numAddCommas(n) + ")"
                },
                eventRiver: function (t, e, i, o) {
                    var n = "";
                    n += this._encodeHTML("" === t.name ? "" : t.name + " : "), n += this._encodeHTML(e), n += "" === n ? "" : "<br />", o = o.evolution;
                    for (var s = 0, r = o.length; r > s; s++) n += '<div style="padding-top:5px;">', o[s].detail && (o[s].detail.img && (n += '<img src="' + o[s].detail.img + '" style="float:left;width:40px;height:40px;">'), n += '<div style="margin-left:45px;">' + o[s].time + "<br/>", n += '<a href="' + o[s].detail.link + '" target="_blank">', n += o[s].detail.text + "</a></div>", n += "</div>");
                    return n
                }
            },
            _styleAxisPointer: function (t, e, i, o, n, s, r, a) {
                if (t.length > 0) {
                    var h, l, d = this.option.tooltip.axisPointer,
                        c = d.type,
                        p = {
                            line: {},
                            cross: {},
                    ...
                    for (var g = 0, f = t.length; f > g; g++) h = t[g], l = this.query(h, "tooltip.axisPointer.type"), c = l || c, l && (p[l].color = this.query(h, "tooltip.axisPointer." + l + "Style.color") || p[l].color, p[l].width = this.query(h, "tooltip.axisPointer." + l + "Style.width") || p[l].width, p[l].type = this.query(h, "tooltip.axisPointer." + l + "Style.type") || p[l].type);
                    if ("line" === c) {
                        var m = p.line.width,
                            _ = e == o;
                        ...
                        this._axisCrossShape.style = {
                            ...
                            text: ("( " + this.component.xAxis.getAxis(0).getValueFromCoord(r) + " , " + this.component.yAxis.getAxis(0).getValueFromCoord(a) + " )").replace("  , ", " ").replace(" ,  ", " "),
                            textPosition: "specific",
                            strokeColor: p.cross.color,
                            lineWidth: y,
                            lineType: p.cross.type
                        }, this.component.grid.getXend() - r > 100 ? (this._axisCrossShape.style.textAlign = "left", this._axisCrossShape.style.textX = r + 10) : (this._axisCrossShape.style.textAlign = "right", this._axisCrossShape.style.textX = r - 10), a - this.component.grid.getY() > 50 ? (this._axisCrossShape.style.textBaseline = "bottom", this._axisCrossShape.style.textY = a - 10) : (this._axisCrossShape.style.textBaseline = "top", this._axisCrossShape.style.textY = a + 10), this._axisCrossShape.invisible = !1, this.zr.modShape(this._axisCrossShape.id)
                    } else "shadow" === c && ((null == p.shadow.width || "auto" === p.shadow.width || isNaN(p.shadow.width)) && (p.shadow.width = s), e === o ? Math.abs(this.component.grid.getX() - e) < 2 ? (p.shadow.width /= 2, e = o += p.shadow.width / 2) : Math.abs(this.component.grid.getXend() - e) < 2 && (p.shadow.width /= 2, e = o -= p.shadow.width / 2) : i === n && (Math.abs(this.component.grid.getY() - i) < 2 ? (p.shadow.width /= 2, i = n += p.shadow.width / 2) : Math.abs(this.component.grid.getYend() - i) < 2 && (p.shadow.width /= 2, i = n -= p.shadow.width / 2)), this._axisShadowShape.style = {
                        xStart: e,
                        yStart: i,
                        xEnd: o,
                        yEnd: n,
            ...
            __onmousemove: function (t) {
                if (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), !this._mousein || !this._enterable) {
                    ...
                    if (e) {
                        ...
                        var n;
                        if (this._needAxisTrigger && this.component.polar && -1 != (n = this.component.polar.isInside([i, o])))
                            for (var s = this.option.series, h = 0, l = s.length; l > h; h++)
                                if (s[h].polarIndex === n && "axis" === this.deepQuery([s[h], this.option], "tooltip.trigger")) {
                                    this._curTarget = null;
                                    break
                                } this._showingTicket = setTimeout(this._tryShow, this._showDelay)
                    } else this._curTarget = !1, this._event = t.event, this._event.zrenderX = i, this._event.zrenderY = o, this._needAxisTrigger && this.component.grid && c.isInside(r, this.component.grid.getArea(), i, o) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, o]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(a.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart), this._hidingTicket = setTimeout(this._hide, this._hideDelay))
                }
            },
            ...
            ontooltipHover: function (t, e) {
                if (!this._lastTipShape || this._lastTipShape && this._lastTipShape.dataIndex != t.dataIndex) {
                    ...
                    for (var i = 0, o = e.length; o > i; i++) e[i].zlevel = this.getZlevelBase(), e[i].z = this.getZBase(), e[i].style = g.prototype.getHighlightStyle(e[i].style, e[i].highlightStyle), e[i].draggable = !1, e[i].hoverable = !1, e[i].clickable = !1, e[i].ondragend = null, e[i].ondragover = null, e[i].ondrop = null, this.shapeList.push(e[i]), this.zr.addShape(e[i]);
                    this._lastTipShape = {
                            ...
                            if (c) {
                                ...
                                switch (d.type) {
                                    ...
                                    case a.CHART_TYPE_SCATTER:
                                        for (var p = t.dataIndex, n = 0, s = _.length; s > n; n++)
                                            if (null == _[n]._mark && h.get(_[n], "seriesIndex") == e && h.get(_[n], "dataIndex") == p) {
                                                this._curTarget = _[n], f = _[n].style.x, m = d.type != a.CHART_TYPE_K ? _[n].style.y : _[n].style.y[0];
                                                break
                                            } break;
                                    case a.CHART_TYPE_RADAR:
                                        for (var p = t.dataIndex, n = 0, s = _.length; s > n; n++)
                                            if ("polygon" === _[n].type && h.get(_[n], "seriesIndex") == e && h.get(_[n], "dataIndex") == p) {
                                                this._curTarget = _[n];
                                                var g = this.component.polar.getCenter(r.polarIndex || 0);
                                                f = g[0], m = g[1];
                                                break
                                            } break;
                                    case a.CHART_TYPE_PIE:
                                        for (var y = t.name, n = 0, s = _.length; s > n; n++)
                                            if ("sector" === _[n].type && h.get(_[n], "seriesIndex") == e && h.get(_[n], "name") == y) {
                                                this._curTarget = _[n];
                                                var x = this._curTarget.style,
                                                    v = (x.startAngle + x.endAngle) / 2 * Math.PI / 180;
                                                f = this._curTarget.style.x + Math.cos(v) * x.r / 1.5, m = this._curTarget.style.y - Math.sin(v) * x.r / 1.5;
                                                break
                                            } break;
                                    case a.CHART_TYPE_MAP:
                                        for (var y = t.name, b = r.mapType, n = 0, s = _.length; s > n; n++)
                                            if ("text" === _[n].type && _[n]._mapType === b && _[n].style._name === y) {
                                                this._curTarget = _[n], f = this._curTarget.style.x + this._curTarget.position[0], m = this._curTarget.style.y + this._curTarget.position[1];
                                                break
                                            } break;
                                    case a.CHART_TYPE_CHORD:
                                        for (var y = t.name, n = 0, s = _.length; s > n; n++)
                                            if ("sector" === _[n].type && h.get(_[n], "name") == y) {
                                                this._curTarget = _[n];
                                                var x = this._curTarget.style,
                                                    v = (x.startAngle + x.endAngle) / 2 * Math.PI / 180;
                                                return f = this._curTarget.style.x + Math.cos(v) * (x.r - 2), m = this._curTarget.style.y - Math.sin(v) * (x.r - 2), void this.zr.trigger(l.EVENT.MOUSEMOVE, {
                                                    zrenderX: f,
                                                    zrenderY: m
                                                })
                                            } break;
                                    case a.CHART_TYPE_FORCE:
                                        for (var y = t.name, n = 0, s = _.length; s > n; n++)
                                            if ("circle" === _[n].type && h.get(_[n], "name") == y) {
                                                this._curTarget = _[n], f = this._curTarget.position[0], m = this._curTarget.position[1];
                                                break
                                            }
                                }
                                null != f && null != m && (this._event = {
                                    zrenderX: f,
                                    zrenderY: m
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            var i = o.merge(this.options, {
                ...
                h = i.effectOption,
                l = new s({
                    highlightStyle: o.clone(h)
                });
            return l.highlightStyle.color = h.color || n.getLinearGradient(h.x, h.y, h.x + h.width, h.y + h.height, [
                [0, "#ff6400"],
                [.5, "#ffe100"],
                [1, "#b1ff00"]
            ]), null != i.progress ? (t(a), l.highlightStyle.width = this.adjust(i.progress, [0, 1]) * i.effectOption.width, t(l), t(r), void e()) : (l.highlightStyle.width = 0, setInterval(function () {
                t(a), l.highlightStyle.width < h.width ? l.highlightStyle.width += 8 : l.highlightStyle.width = 0, t(l), t(r), e()
            }, h.timeInterval))
        }, e
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            for (var i = o.merge(this.options, {
                ...
                }), r = this.createTextShape(i.textStyle), a = this.createBackgroundShape(i.backgroundColor), h = i.effect, l = h.n, d = h.brushType, c = h.lineWidth, p = [], u = this.canvasWidth, g = this.canvasHeight, f = 0; l > f; f++) {
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            for (var i = o.merge(this.options, {
                ...
                }), r = this.createTextShape(i.textStyle), a = this.createBackgroundShape(i.backgroundColor), h = i.effectOption, l = h.n, d = h.lineWidth, c = [], p = this.canvasWidth, u = this.canvasHeight, g = 0; l > g; g++) {
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            ...
            for (var l = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), c = a.x, p = a.y, u = a.r0 + 6, g = a.r - 6, f = a.color, m = n.lift(f, .1), _ = new s({
                    highlightStyle: o.clone(a)
                }), y = [], x = n.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), v = 15, b = 240, S = 0; 16 > S; S++) y.push(new r({
                highlightStyle: {
                    x: c,
                    y: p,
                    r0: u,
                ...
                _color: n.getLinearGradient(c + u * Math.cos(b, !0), p - u * Math.sin(b, !0), c + u * Math.cos(b - v, !0), p - u * Math.sin(b - v, !0), [
                    [0, x[2 * S]],
                    [1, x[2 * S + 1]]
                ])
            })), b -= v;
            b = 360;
            for (var S = 0; 4 > S; S++) y.push(new r({
                highlightStyle: {
                    x: c,
                    y: p,
                    r0: u,
            ...
            var T = 0;
            if (null != i.progress) {
                t(d), T = 100 * this.adjust(i.progress, [0, 1]).toFixed(2) / 5, _.highlightStyle.text = 5 * T + "%", t(_);
                for (var S = 0; 20 > S; S++) y[S].highlightStyle.color = T > S ? y[S]._color : m, t(y[S]);
                return t(l), void e()
            }
            return setInterval(function () {
                t(d), T += T >= 20 ? -20 : 1, t(_);
                for (var i = 0; 20 > i; i++) y[i].highlightStyle.color = T > i ? y[i]._color : m, t(y[i]);
                t(l), e()
            }, a.timeInterval)
        }, e
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            var i = o.merge(this.options, {
                ...
                h = 10,
                l = s.getTextWidth(a.highlightStyle.text, a.highlightStyle.textFont),
                d = s.getTextHeight(a.highlightStyle.text, a.highlightStyle.textFont),
                ...
                p = this.getLocation(this.options.textStyle, l + h + 2 * c.r, Math.max(2 * c.r, d));
            c.x = p.x + c.r, c.y = a.highlightStyle.y = p.y + p.height / 2, a.highlightStyle.x = c.x + c.r + h;
            for (var u = this.createBackgroundShape(i.backgroundColor), g = c.n, f = c.x, m = c.y, _ = c.r0, y = c.r, x = c.color, v = [], b = Math.round(180 / g), S = 0; g > S; S++) v[S] = new r({
                highlightStyle: {
                    x: f,
                    y: m,
                    r0: _,
        ...
        return o.inherits(e, i), e.prototype._start = function (t, e) {
            var i = o.merge(this.options, {
                ...
                l = 10,
                d = n.getTextWidth(h.highlightStyle.text, h.highlightStyle.textFont),
                c = n.getTextHeight(h.highlightStyle.text, h.highlightStyle.textFont),
                ...
                u = this.getLocation(this.options.textStyle, d + l + 2 * p.r, Math.max(2 * p.r, c));
        ...
        function e(t, e, o, n, s) {
            i.call(this, t, e, o, n, s), this.dom = s.dom, this._magicType = {}, this._magicMap = {}, this._isSilence = !1, this._iconList, this._iconShapeMap = {}, this._featureTitle = {}, this._featureIcon = {}, this._featureColor = {}, this._featureOption = {}, this._enableColor = "red", this._disableColor = "#ccc", this._markShapeList = [];
            var r = this;
        ...
        return e.prototype = {
            ...
            _buildShape: function () {
                ...
                for (var o in e)
                    if (e[o].show) switch (o) {
                        case "mark":
                            ...
                            break;
                        case "magicType":
                            for (var n = 0, s = e[o].type.length; s > n; n++) e[o].title[e[o].type[n] + "Chart"] = e[o].title[e[o].type[n]], e[o].option && (e[o].option[e[o].type[n] + "Chart"] = e[o].option[e[o].type[n]]), i.push({
                                key: o,
                ...
                if (i.length > 0) {
                    for (var r, o, n = 0, s = i.length; s > n; n++) r = i[n].name, o = i[n].key, this._iconList.push(r), this._featureTitle[r] = e[o].title[r] || e[o].title, e[o].icon && (this._featureIcon[r] = e[o].icon[r] || e[o].icon), e[o].color && (this._featureColor[r] = e[o].color[r] || e[o].color), e[o].option && (this._featureOption[r] = e[o].option[r] || e[o].option);
                    this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), this._buildItem();
                    for (var n = 0, s = this.shapeList.length; s > n; n++) this.zr.addShape(this.shapeList[n]);
            ...
            _buildItem: function () {
                var e, i, o, s, a = this.option.toolbox,
                ...
                "horizontal" === a.orient ? (i = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "bottom" : "top", o = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "left" : "right", s = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "top" : "bottom") : i = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "right" : "left", this._iconShapeMap = {};
                for (var f = this, m = 0; h > m; m++) {
                    switch (e = {
                        ...
                        style: {
                            ...
                            lineWidth: 1,
                            strokeColor: this._featureColor[this._iconList[m]] || u[m % u.length],
                            brushType: "stroke"
                        },
                        highlightStyle: {
                            lineWidth: 1,
                    ...
                    "icon" === e.type ? e = new r(e) : "image" === e.type && (e = new n(e)), this.shapeList.push(e), this._iconShapeMap[this._iconList[m]] = e, "horizontal" === a.orient ? l += c + p : d += c + p
                }
            },
            _buildBackground: function () {
                var t = this.option.toolbox,
                    e = this.reformCssArray(this.option.toolbox.padding);
                this.shapeList.push(new s({
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
            ...
            _getItemGroupLocation: function () {
                var t = this.option.toolbox,
                    ...
                    s = 0,
                    r = 0;
                "horizontal" === t.orient ? (s = (n + o) * i - o, r = n) : (r = (n + o) * i - o, s = n);
            ...
            __onmousemove: function (t) {
                this._marking && (this._markShape.style.xEnd = d.getX(t.event), this._markShape.style.yEnd = d.getY(t.event), this.zr.addHoverShape(this._markShape)), this._zooming && (this._zoomShape.style.width = d.getX(t.event) - this._zoomShape.style.x, this._zoomShape.style.height = d.getY(t.event) - this._zoomShape.style.y, this.zr.addHoverShape(this._zoomShape), this.dom.style.cursor = "crosshair", d.stop(t.event)), this._zoomStart && "pointer" != this.dom.style.cursor && "move" != this.dom.style.cursor && (this.dom.style.cursor = "crosshair")
            },
            ...
            __onSaveAsImage: function () {
                ...
                n.href = i, n.setAttribute("download", (t.name ? t.name : this.option.title && (this.option.title.text || this.option.title.subtext) ? this.option.title.text || this.option.title.subtext : "ECharts") + "." + e), n.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "右键->图片另存为" : t.lang ? t.lang[0] : "点击保存") + '"/>', o.appendChild(n), document.body.appendChild(o), n = null, o = null, setTimeout(function () {
            ...
            reset: function (t, e) {
                if (e && this.clear(), this.query(t, "toolbox.show") && this.query(t, "toolbox.feature.magicType.show")) {
                    ...
                    o = t.series.length;
                    for (var n, s; o--;) n = t.series[o].type, this._magicMap[n] && (s = t.xAxis instanceof Array ? t.xAxis[t.series[o].xAxisIndex || 0] : t.xAxis, s && "category" === (s.type || "category") && (s.__boundaryGap = null != s.boundaryGap ? s.boundaryGap : !0), s = t.yAxis instanceof Array ? t.yAxis[t.series[o].yAxisIndex || 0] : t.yAxis, s && "category" === s.type && (s.__boundaryGap = null != s.boundaryGap ? s.boundaryGap : !0), t.series[o].__type = n, t.series[o].__itemStyle = h.clone(t.series[o].itemStyle || {})), (this._magicMap[c] || this._magicMap[p]) && (t.series[o].__stack = t.series[o].stack)
                }
            ...
            getMagicOption: function () {
                ...
                if (this._defaultMagic(a.CHART_TYPE_CHORD, a.CHART_TYPE_FORCE), this._defaultMagic(a.CHART_TYPE_PIE, a.CHART_TYPE_FUNNEL), this._magicType[c] || this._magicType[p])
                    for (var o = 0, n = this.option.series.length; n > o; o++) this._magicType[c] ? (this.option.series[o].stack = "_ECHARTS_STACK_KENER_2014_", e = c) : this._magicType[p] && (this.option.series[o].stack = null, e = p), this._featureOption[e + "Chart"] && h.merge(this.option.series[o], this._featureOption[e + "Chart"] || {}, !0);
                return this.option
            },
        ...
        return e.prototype = {
            ...
            buildPath: function (t, e) {
                ...
                if (t.moveTo(e.xStart, e.yStart), e.curveness > 0) {
                    ...
                    o && t.setLineDash && t.setLineDash(o), t.quadraticCurveTo(e.cpX1, e.cpY1, e.xEnd, e.yEnd)
            ...
            isCover: function (t, e) {
                var i = this.transformCoordToLocal(t, e);
                return t = i[0], e = i[1], this.isCoverRect(t, e) ? this.style.curveness > 0 ? h.isInside(a, this.style, t, e) : h.isInside(s, this.style, t, e) : !1
            }
        }, d.inherits(e, i), e
        ...
        return i.prototype = {
            ...
            brush: function (t, e) {
                ...
                for (var o = 0; o < i.shapeList.length; o++) {
                    var n = i.shapeList[o],
                        s = n.style;
                    e && (s = n.getHighlightStyle(s, n.highlightStyle || {}, n.brushTypeOnly)), n.buildPath(t, s)
                }
                switch (i.brushType) {
                    case "both":
                        t.fill();
            ...
            getRect: function (t) {
                if (t.__rect) return t.__rect;
                for (var e = 1 / 0, i = -1 / 0, o = 1 / 0, n = -1 / 0, s = 0; s < t.shapeList.length; s++) var r = t.shapeList[s],
                    a = r.getRect(r.style),
                    e = Math.min(a.x, e),
                    o = Math.min(a.y, o),
        ...
        function e(t, e, i, o, n) {
            var s, r = i.style.pointList,
                a = r.length;
            if (!e) {
                if (s = [], "vertical" != i._orient)
                    for (var h = r[0][1], l = 0; a > l; l++) s[l] = [r[l][0], h];
                else
                    for (var d = r[0][0], l = 0; a > l; l++) s[l] = [d, r[l][1]];
                "half-smooth-polygon" == i.type && (s[a - 1] = g.clone(r[a - 1]), s[a - 2] = g.clone(r[a - 2])), e = {
                    style: {
                        pointList: s
                    }
                }
            ...
            s = e.style.pointList;
            var c = s.length;
            i.style.pointList = c == a ? s : a > c ? s.concat(r.slice(c)) : s.slice(0, a), t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {
                pointList: r
            }).during(function () {
        ...
        function o(t, e, o, n, s) {
            ...
            i(o, e, "x", "y", "width", "height"), o.position = e.position, t.addShape(o), (c[0] != e.position[0] || c[1] != e.position[1]) && t.animate(o.id, "").when(n, {
                position: c
            }).start(s), o.__animating = !0, t.animate(o.id, "style").when(n, {
                x: a,
                y: h,
                width: l,
                height: d
        ...
        function n(t, e, i, o, n) {
            ...
            var r = i.style.y;
            i.style.y = e.style.y, t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {
                y: r
            }).done(function () {
                i.__animating = !1
            }).start(n)
        ...
        function s(t, e, i, o, n) {
            var s = i.style.x,
                ...
                a = i.style.r0,
                h = i.style.r;
            i.__animating = !0, "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, s, r], t.addShape(i), t.animate(i.id, "style").when(o, {
                r0: a,
                r: h
            }).done(function () {
                i.__animating = !1
            }).start(n), t.animate(i.id, "").when(o, {
                rotation: [0, s, r]
            }).start(n)) : (i.style.r0 = i.style.r, t.addShape(i), t.animate(i.id, "style").when(o, {
                r0: a
            }).done(function () {
                i.__animating = !1
            }).start(n))
        ...
        function r(t, e, o, n, s) {
            ...
            var r = o.style.startAngle,
                a = o.style.endAngle;
            i(o, e, "startAngle", "endAngle"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                startAngle: r,
                endAngle: a
            }).done(function () {
                o.__animating = !1
        ...
        function a(t, e, o, n, s) {
            ...
            var r = o.style.x,
                a = o.style.y;
            i(o, e, "x", "y"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                x: r,
                y: a
            }).done(function () {
                o.__animating = !1
        ...
        function h(e, i, o, n, s) {
            var r = t("zrender/shape/Polygon").prototype.getRect(o.style),
                a = r.x + r.width / 2,
                h = r.y + r.height / 2;
            o.scale = [.1, .1, a, h], e.addShape(o), o.__animating = !0, e.animate(o.id, "").when(n, {
                scale: [1, 1, a, h]
            }).done(function () {
                o.__animating = !1
            }).start(s)
        ...
        function l(t, e, o, n, s) {
            ...
            var r = o.style.source0,
                ...
                h = o.style.target0,
                l = o.style.target1;
            e.style && i(o, e, "source0", "source1", "target0", "target1"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                source0: r,
                source1: a,
                target0: h,
                target1: l
        ...
        function d(t, e, i, o, n) {
            ...
            var s = i.style.angle;
            i.style.angle = e.style.angle, t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(o, {
                angle: s
            }).done(function () {
                i.__animating = !1
            }).start(n)
        ...
        function c(t, e, i, n, s, r) {
            if (i.style._x = i.style.x, i.style._y = i.style.y, i.style._width = i.style.width, i.style._height = i.style.height, e) o(t, e, i, n, s);
            else {
                var a = i._x || 0,
                    h = i._y || 0;
                i.scale = [.01, .01, a, h], t.addShape(i), i.__animating = !0, t.animate(i.id, "").delay(r).when(n, {
                    scale: [1, 1, a, h]
                }).done(function () {
                    i.__animating = !1
                }).start(s || "QuinticOut")
        ...
        function p(t, e, o, n, s) {
            ...
            var r = o.style.xStart,
                ...
                h = o.style.yStart,
                l = o.style.yEnd;
            i(o, e, "xStart", "xEnd", "yStart", "yEnd"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                xStart: r,
                xEnd: a,
                yStart: h,
                yEnd: l
        ...
        function u(t, e, i, o, n) {
            ...
            if (s.curveness > 0) {
                ...
                t.animation.animate(c).when(o, {
                    p: 1
                }).during(function () {
                    _(a, p, l, c.p, g), _(h, u, d, c.p, m), s.cpX1 = g[1], s.cpY1 = m[1], s.xEnd = g[2], s.yEnd = m[2], t.modShape(i)
                }).done(r).start(n)
        ...
        function e(t, e, i, o) {
            ...
            "image" !== i.type ? (n = new l({
                ...
                draggable: !1,
                hoverable: !1
            }), "pin" == i.style.iconType && (n.style.y += n.style.height / 2 * 1.5), g && (n.style.image = t.shapeToImage(n, n.style.width + 2 * u + 2, n.style.height + 2 * u + 2).style.image, n = new a({
                zlevel: n.zlevel,
                style: n.style,
                draggable: !1,
                hoverable: !1
                ...
                draggable: !1,
                hoverable: !1
            }), s.clone(i, n), n.position = i.position, e.push(n), t.addShape(n);
            var f = "image" !== i.type ? window.devicePixelRatio || 1 : 1,
                m = (n.style.width / f - i.style._width) / 2;
            n.style.x = i.style._x - m, n.style.y = i.style._y - m, "pin" == i.style.iconType && (n.style.y -= i.style.height / 2 * 1.5);
            ...
            "scale" === r.type ? (t.modShape(n.id, {
                scale: [.1, .1, y, x]
            }), t.animate(n.id, "", r.loop).when(_, {
                scale: [1, 1, y, x]
            }).done(function () {
                i.effect.show = !1, t.delShape(n.id)
            }).start()) : t.animate(n.id, "style", r.loop).when(_, {
                y: n.style.y - p
            }).when(2 * _, {
                y: n.style.y
            }).done(function () {
        ...
        function i(t, e, i, o) {
            ...
            e.push(c), t.addShape(c), t.modShape(i.id, {
                invisible: !0
            });
            for (var p = Math.round(100 * n.period), u = {}, g = {}, f = 0; 20 > f; f++) c.style["randomMap" + f] = 0, u = {}, u["randomMap" + f] = 100, g = {}, g["randomMap" + f] = 0, c.style["randomMap" + f] = 100 * Math.random(), t.animate(c.id, "style", !0).when(p, u).when(2 * p, g).when(3 * p, u).when(4 * p, u).delay(Math.random() * p * f).start()
        }
        ...
        function o(t, e, i, o, n) {
            ...
            if (g && !n) {
                var o = _.zlevel;
                _ = t.shapeToImage(_, 2 * (f + m), 2 * (f + m)), _.zlevel = o, _.hoverable = !1, y = m
            }
            n || (s.clone(i, _), _.position = i.position, e.push(_), t.addShape(_));
            var x = function () {
                n || (i.effect.show = !1, t.delShape(_.id)), _.effectAnimator = null
            };
            if (i instanceof p) {
                for (var v = [0], b = 0, S = l.pointList, T = l.controlPointList, z = 1; z < S.length; z++) {
                    if (T) {
                        var C = T[2 * (z - 1)],
                            L = T[2 * (z - 1) + 1];
                ...
                for (var w = {
                        p: 0
                    }, E = t.animation.animate(w, {
                        loop: a.loop
                    }), z = 0; z < v.length; z++) E.when(v[z] * a.period, {
                    p: z
                });
                E.during(function () {
                    var e, i, o = Math.floor(w.p);
                    if (o == S.length - 1) e = S[o][0], i = S[o][1];
                        ...
                        if (T) {
                            var l = T[2 * o],
                                d = T[2 * o + 1];
                            e = h.cubicAt(r[0], l[0], d[0], a[0], s), i = h.cubicAt(r[1], l[1], d[1], a[1], s)
                        } else e = (a[0] - r[0]) * s + r[0], i = (a[1] - r[1]) * s + r[1]
                    }
                    _.style.x = e, _.style.y = i, n || t.modShape(_)
                }).done(x).start(), E.duration = b * a.period, _.effectAnimator = E
            } else {
                var M = l.xStart - y,
                    A = l.yStart - y,
                    k = l.xEnd - y,
                ...
                if (i.style.curveness > 0) {
                    ...
                    _.effectAnimator = t.animation.animate(_, {
                        ...
                        _.style.x = h.quadraticAt(M, R, k, i), _.style.y = h.quadraticAt(A, D, O, i), n || t.modShape(_)
                    }).done(x).start()
        ...
        function n(t, e, i, n) {
            ...
            for (var h = 0, l = [], d = 0; d < r.length; d++) {
                ...
                var p = o(t, null, r[d], n, !0),
                    u = p.effectAnimator;
                s.style.shapeList.push(p), u.duration > h && (h = u.duration), 0 === d && (s.style.color = p.style.color, s.style.shadowBlur = p.style.shadowBlur, s.style.shadowColor = p.style.shadowColor), l.push(u)
            }
            ...
            if (h) {
                s.__dummy = 0;
                var f = t.animate(s.id, "", a.loop).when(h, {
                        __dummy: 1
                    }).during(function () {
                        t.modShape(s)
                    }).done(function () {
        ...
        function e(t, e, n, s, r) {
            this.ecTheme = t, this.messageCenter = e, this.zr = n, this.option = s, this.series = s.series, this.myChart = r, this.component = r.component, this.shapeList = [], this.effectList = [];
            var a = this;
            a._onlegendhoverlink = function (t) {
                if (a.legendHoverLink)
                    for (var e, n = t.target, s = a.shapeList.length - 1; s >= 0; s--) e = a.type == i.CHART_TYPE_PIE || a.type == i.CHART_TYPE_FUNNEL ? o.get(a.shapeList[s], "name") : (o.get(a.shapeList[s], "series") || {}).name, e != n || a.shapeList[s].invisible || a.shapeList[s].__animating || a.zr.addHoverShape(a.shapeList[s])
        ...
        return e.prototype = {
            ...
            reformOption: function (t) {
                return t = r.merge(r.merge(t || {}, r.clone(this.ecTheme[this.type] || {})), r.clone(i[this.type] || {})), this.z = t.z, this.zlevel = t.zlevel, t
            },
        ...
        function o(t) {
            var e = t.points;
            e[0][1] < e[1][1] || t instanceof i ? (this.array = [e[0][0], e[0][1], e[1][0], e[1][1]], this._startPoint = e[0], this._endPoint = e[1]) : (this.array = [e[1][0], e[1][1], e[0][0], e[0][1]], this._startPoint = e[1], this._endPoint = e[0]), this.ink = d(e[0], e[1]), this.edge = t, this.group = null
        }
        ...
        var r = t("../data/KDTree"),
            ...
            c = a.copy,
            p = a.clone;
        return o.prototype.getStartPoint = function () {
            ...
            run: function (t) {
                ...
                function o(t, i) {
                    for (var o = [], n = 0, s = 0; s < t.length; s++) n > 0 && e(t[s], o[n - 1]) || (o[n++] = p(t[s]));
                    return i[0] && !e(o[0], i[0]) && (o = o.reverse()), o
                }
                for (var n = this._iterate(t), s = 0; s++ < this.maxIteration;) {
                    for (var r = [], a = 0; a < n.groups.length; a++) r.push(new i(n.groups[a]));
                    ...
                    c = function (t, e) {
                        for (var n, s = 0; s < t.length; s++) {
                            ...
                            if (r.edgeList[0] && r.edgeList[0].edge instanceof i) {
                                for (var a = [], h = 0; h < r.edgeList.length; h++) a.push(r.edgeList[h].edge.group);
                                n = e ? e.slice() : [], n.unshift(r.mp0), n.push(r.mp1), c(a, n)
                            } else
                                for (var h = 0; h < r.edgeList.length; h++) {
                                    var l = r.edgeList[h];
                                    n = e ? e.slice() : [], n.unshift(r.mp0), n.push(r.mp1), n.unshift(l.getStartPoint()), n.push(l.getEndPoint()), d.push({
            ...
            _iterate: function (t) {
                ...
                for (var p = new r(i, 4), u = [], g = h(), f = h(), m = 0, _ = h(), y = h(), x = 0, l = 0; l < i.length; l++) {
                    var d = i[l];
                    if (!d.group) {
                        p.nearestN(d, this.maxNearestEdge, e, u);
                        for (var v = 0, b = null, S = null, T = 0; T < u.length; T++) {
                            var z = u[T],
                                C = 0;
                            z.group ? z.group !== S && (S = z.group, m = this._calculateGroupEdgeInk(z.group, d, g, f), C = z.group.ink + d.ink - m) : (m = this._calculateEdgeEdgeInk(d, z, g, f), C = z.ink + d.ink - m), C > v && (v = C, b = z, c(y, f), c(_, g), x = m)
                        }
                        if (b) {
                            a += v;
                            var L;
                            b.group || (L = new n, s.push(L), L.addEdge(b)), L = b.group, c(L.mp0, _), c(L.mp1, y), L.ink = x, b.group.addEdge(d)
                        } else {
                            var L = new n;
                            s.push(L), c(L.mp0, d.getStartPoint()), c(L.mp1, d.getEndPoint()), L.ink = d.ink, L.addEdge(d)
                        }
                    }
                }
                return {
            ...
            _calculateEdgeEdgeInk: function () {
                ...
                return function (i, o, n, s) {
                    t[0] = i.getStartPoint(), t[1] = o.getStartPoint(), e[0] = i.getEndPoint(), e[1] = o.getEndPoint(), this._calculateMeetPoints(t, e, n, s);
                    var r = d(t[0], n) + d(n, s) + d(s, e[0]) + d(t[1], n) + d(s, e[1]);
                    return r
                }
            }(),
            _calculateGroupEdgeInk: function (t, e, i, o) {
                ...
                n.push(e.getStartPoint()), s.push(e.getEndPoint()), this._calculateMeetPoints(n, s, i, o);
                for (var h = d(i, o), r = 0; r < n.length; r++) h += d(n[r], i) + d(s[r], o);
                return h
            },
            _calculateMeetPoints: function () {
                ...
                return function (i, o, n, s) {
                    ...
                    a.scale(e, e, 1 / r), this._limitTurningAngle(i, t, e, n), this._limitTurningAngle(o, e, t, s)
                }
            }(),
        ...
        return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : ! function () {
            ...
            function u(t) {
                var e, i, o, n, s, r;
                if (n = parseFloat(t[0]) / 360 % 360, 0 > n && n++, s = p(c(t[1]), 0, 1), r = p(c(t[2]), 0, 1), 0 == s) e = i = o = r;
                else {
                    var a = .5 > r ? r * (1 + s) : r + s - r * s,
                        h = 2 * r - a;
                    e = g(h, a, n + 1 / 3), i = g(h, a, n), o = g(h, a, n - 1 / 3)
                }
            ...
            function f(t) {
                ...
                if (t = String(t), "#" == t.charAt(0)) e = t;
                    ...
                    for (var o, n = d(t), e = "#", s = 0; 3 > s; s++) o = -1 != n[s].indexOf("%") ? Math.floor(255 * c(n[s])) : +n[s], e += W[p(o, 0, 255)];
                    i = +n[3]
                } else if (/^hsl/.test(t)) {
                    var n = d(t);
                    e = u(n), i = n[3]
            ...
            function _(t, e) {
                ...
                var n = parseFloat(e.currentStyle.fontSize),
                    s = parseFloat(t.size);
                return i.size = "number" == typeof t.size ? t.size : -1 != t.size.indexOf("px") ? s : -1 != t.size.indexOf("em") ? n * s : -1 != t.size.indexOf("%") ? n / 100 * s : -1 != t.size.indexOf("pt") ? s / .75 : n, i
            }
            ...
            function v(t) {
                this.m_ = a(), this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = "#000", this.fillStyle = "#000", this.lineWidth = 1, this.lineJoin = "miter", this.lineCap = "butt", this.miterLimit = 1 * B, this.globalAlpha = 1, this.font = "12px 微软雅黑", this.textAlign = "left", this.textBaseline = "alphabetic", this.canvas = t;
            ...
            function S(t, e) {
                ...
                1 > s && (n *= s), e.push("<g_vml_:stroke", ' opacity="', n, '"', ' joinstyle="', t.lineJoin, '"', ' miterlimit="', t.miterLimit, '"', ' endcap="', x(t.lineCap), '"', ' weight="', s, 'px"', ' color="', o, '" />')
            }
                ...
                if (n instanceof w) {
                    ...
                    if ("gradient" == n.type_) {
                        var u = n.x0_ / s,
                            ...
                            v = x.x - y.x,
                            b = x.y - y.y;
                        l = 180 * Math.atan2(v, b) / Math.PI, 0 > l && (l += 360), 1e-6 > l && (l = 0)
                    } else {
                    ...
                    for (var C = T.length, L = T[0].color, M = T[C - 1].color, A = T[0].alpha * t.globalAlpha, k = T[C - 1].alpha * t.globalAlpha, I = [], P = 0; C > P; P++) {
                        var R = T[P];
                        I.push(R.offset * p + c + " " + R.color)
                    }
                    e.push('<g_vml_:fill type="', n.type_, '"', ' method="none" focus="100%"', ' color="', L, '"', ' color2="', M, '"', ' colors="', I.join(","), '"', ' opacity="', k, '"', ' g_o_:opacity2="', A, '"', ' angle="', l, '"', ' focusposition="', d.x, ",", d.y, '" />')
                } else if (n instanceof E) {
                    if (a && h) {
                        var D = -i.x,
                            H = -i.y;
                        e.push("<g_vml_:fill", ' position="', D / a * s * s, ",", H / h * r * r, '"', ' type="tile"', ' src="', n.src_, '" />')
                    }
                } else {
                    var N = f(t.fillStyle),
                        F = N.color,
            ...
            function A(t) {
                t && 1 == t.nodeType && "IMG" == t.tagName || M("TYPE_MISMATCH_ERR"), "complete" != t.readyState && M("INVALID_STATE_ERR")
            }
            ...
            var Y = {
                ...
                initElement: function (e) {
                    if (!e.getContext) {
                        e.getContext = t, n(e.ownerDocument), e.innerHTML = "", e.attachEvent("onpropertychange", s), e.attachEvent("onresize", r);
                        var i = e.attributes;
            ...
            for (var W = [], X = 0; 16 > X; X++)
                for (var G = 0; 16 > G; G++) W[16 * X + G] = X.toString(16) + G.toString(16);
            var q = {
                    aliceblue: "#F0F8FF",
                    antiquewhite: "#FAEBD7",
                    aquamarine: "#7FFFD4",
            ...
            j.clearRect = function () {
                ...
                return r.x0_ = t, r.y0_ = e, r.r0_ = i, r.x1_ = o, r.y1_ = n, r.r1_ = s, r
            }, j.drawImage = function (t) {
                var e, i, o, n, s, r, a, h, l = t.runtimeStyle.width,
                    d = t.runtimeStyle.height;
                t.runtimeStyle.width = "auto", t.runtimeStyle.height = "auto";
                var c = t.width,
                    p = t.height;
                if (t.runtimeStyle.width = l, t.runtimeStyle.height = d, 3 == arguments.length) e = arguments[1], i = arguments[2], s = r = 0, a = o = c, h = n = p;
                else if (5 == arguments.length) e = arguments[1], i = arguments[2], o = arguments[3], n = arguments[4], s = r = 0, a = c, h = p;
                else {
                    if (9 != arguments.length) throw Error("Invalid number of arguments");
                    s = arguments[1], r = arguments[2], a = arguments[3], h = arguments[4], e = arguments[5], i = arguments[6], o = arguments[7], n = arguments[8]
                }
                var u = z(this, e, i),
                    g = [],
                    f = 10,
                    m = 10,
                    _ = x = 1;
                if (g.push(" <g_vml_:group", ' coordsize="', B * f, ",", B * m, '"', ' coordorigin="0,0"', ' style="width:', f, "px;height:", m, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                    var y = [],
                        _ = this.scaleX_,
                        x = this.scaleY_;
                    y.push("M11=", this.m_[0][0] / _, ",", "M12=", this.m_[1][0] / x, ",", "M21=", this.m_[0][1] / _, ",", "M22=", this.m_[1][1] / x, ",", "Dx=", I(u.x / B), ",", "Dy=", I(u.y / B), "");
                    var v = u,
                        b = z(this, e + o, i),
                        S = z(this, e, i + n),
                        T = z(this, e + o, i + n);
                    v.x = O.max(v.x, b.x, S.x, T.x), v.y = O.max(v.y, b.y, S.y, T.y), g.push("padding:0 ", I(v.x / B), "px ", I(v.y / B), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
                } else g.push("top:", I(u.y / B), "px;left:", I(u.x / B), "px;");
                g.push(' ">'), (s || r) && g.push('<div style="overflow: hidden; width:', Math.ceil((o + s * o / a) * _), "px;", " height:", Math.ceil((n + r * n / h) * x), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -s * o / a * _, ",Dy=", -r * n / h * x, ');">'), g.push('<div style="width:', Math.round(_ * c * o / a), "px;", " height:", Math.round(x * p * n / h), "px;", " filter:"), this.globalAlpha < 1 && g.push(" progid:DXImageTransform.Microsoft.Alpha(opacity=" + 100 * this.globalAlpha + ")"), g.push(" progid:DXImageTransform.Microsoft.AlphaImageLoader(src=", t.src, ',sizingMethod=scale)">'), (s || r) && g.push("</div>"), g.push("</div></div>"), this.element_.insertAdjacentHTML("BeforeEnd", g.join(""))
            }, j.stroke = function (t) {
                var e = [],
                    i = 10,
                    o = 10;
                ...
                for (var n = {
                    ...
                    h && ((null == n.x || h.x < n.x) && (n.x = h.x), (null == s.x || h.x > s.x) && (s.x = h.x), (null == n.y || h.y < n.y) && (n.y = h.y), (null == s.y || h.y > s.y) && (s.y = h.y))
                }
                e.push(' ">'), t ? T(this, e, n, s) : S(this, e), e.push("</g_vml_:shape>"), this.element_.insertAdjacentHTML("beforeEnd", e.join(""))
            }, j.fill = function () {
                this.stroke(!0)
                ...
                c.push('<g_vml_:line from="', -h, ' 0" to="', l, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !s, '" stroked="', !!s, '" style="position:absolute;width:1px;height:1px;">'), s ? S(this, c) : T(this, c, {
                    x: -h,
                    y: 0
                }, {
                    x: l,
                ...
                var v = r[0][0].toFixed(3) + "," + r[1][0].toFixed(3) + "," + r[0][1].toFixed(3) + "," + r[1][1].toFixed(3) + ",0,0",
                    b = I(x.x / B) + "," + I(x.y / B);
                c.push('<g_vml_:skew on="t" matrix="', v, '" ', ' offset="', b, '" origin="', h, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', i(t), '" style="v-text-align:', f, ";font:", i(u), '" /></g_vml_:line>'), this.element_.insertAdjacentHTML("beforeEnd", c.join(""))
            ...
            K.INDEX_SIZE_ERR = 1, K.DOMSTRING_SIZE_ERR = 2, K.HIERARCHY_REQUEST_ERR = 3, K.WRONG_DOCUMENT_ERR = 4, K.INVALID_CHARACTER_ERR = 5, K.NO_DATA_ALLOWED_ERR = 6, K.NO_MODIFICATION_ALLOWED_ERR = 7, K.NOT_FOUND_ERR = 8, K.NOT_SUPPORTED_ERR = 9, K.INUSE_ATTRIBUTE_ERR = 10, K.INVALID_STATE_ERR = 11, K.SYNTAX_ERR = 12, K.INVALID_MODIFICATION_ERR = 13, K.NAMESPACE_ERR = 14, K.INVALID_ACCESS_ERR = 15, K.VALIDATION_ERR = 16, K.TYPE_MISMATCH_ERR = 17, G_vmlCanvasManager = Y, CanvasRenderingContext2D = v, CanvasGradient = w, CanvasPattern = E, DOMException = k
        }(), G_vmlCanvasManager
        ...
        function e(e, o, n, s, r, a, h) {
            ...
            for (var c = 0, p = o.length; p > c; c++) e.fillText(o[c], n, s), s += d
        }
        ...
        return d.prototype.doClip = function (t) {
            if (this.__clipShapes && !o)
                for (var e = 0; e < this.__clipShapes.length; e++) {
                    ...
                    if (i.needTransform) {
                        var s = i.transform;
                        n.invert(p, s), t.transform(s[0], s[1], s[2], s[3], s[4], s[5])
                    }
            ...
            "stroke" != e.brushType ? (n.strokeColor = a, n.lineWidth = (e.lineWidth || 1) + this.getHighlightZoom(), n.brushType = "both") : "stroke" != o ? (n.strokeColor = a, n.lineWidth = (e.lineWidth || 1) + this.getHighlightZoom()) : n.strokeColor = i.strokeColor || r.mix(e.strokeColor, r.toRGB(a));
            ...
            return e = o[0], i = o[1], this.isCoverRect(e, i) ? t("../tool/area").isInside(this, this.style, e, i) : !1
                ...
                switch (d) {
                    ...
                    case "right":
                        if (this.getRect) {
                            ...
                            switch (d) {
                                case "inside":
                                    a = c.x + c.width / 2, h = c.y + c.height / 2, s = "center", r = "middle", "stroke" != i.brushType && n == i.color && (t.fillStyle = "#fff");
                                    break;
                                case "left":
                                    a = c.x - l, h = c.y + c.height / 2, s = "end", r = "middle";
                                    break;
                                case "right":
                                    a = c.x + c.width + l, h = c.y + c.height / 2, s = "start", r = "middle";
                                    break;
                                case "top":
                                    a = c.x + c.width / 2, h = c.y - l, s = "center", r = "bottom";
                                    break;
                                case "bottom":
                                    a = c.x + c.width / 2, h = c.y + c.height + l, s = "center", r = "top"
                            }
                        }
                        break;
                    case "start":
                    case "end":
                        ...
                        switch (d) {
                            case "start":
                                g = p[1][0], f = p[0][0], m = p[1][1], _ = p[0][1];
                                break;
                            case "end":
                                g = p[u - 2][0], f = p[u - 1][0], m = p[u - 2][1], _ = p[u - 1][1]
                        }
                        a = f, h = _;
                        var y = Math.atan((m - _) / (f - g)) / Math.PI * 180;
                        0 > f - g ? y += 180 : 0 > m - _ && (y += 360), l = 5, y >= 30 && 150 >= y ? (s = "center", r = "bottom", h -= l) : y > 150 && 210 > y ? (s = "right", r = "middle", a -= l) : y >= 210 && 330 >= y ? (s = "center", r = "top", h += l) : (s = "left", r = "middle", a += l);
                        break;
                    case "specific":
                        a = i.textX || 0, h = i.textY || 0, s = "start", r = "middle"
                }
                null != a && null != h && e(t, i.text, a, h, i.textFont, i.textAlign || s, i.textBaseline || r)
            }
        ...
        }, r.merge(d.prototype, h.prototype, !0), r.merge(d.prototype, l.prototype, !0), d
        ...
        return t.prototype.one = function (t, e, i) {
            ...
            if (e) {
                if (i[t]) {
                    for (var o = [], n = 0, s = i[t].length; s > n; n++) i[t][n].h != e && o.push(i[t][n]);
                    i[t] = o
                }
            ...
            if (this._handlers[t]) {
                ...
                for (var o = e[e.length - 1], n = this._handlers[t], s = n.length, r = 0; s > r;) {
                    switch (i) {
                        case 1:
                            n[r].h.call(o);
                            break;
            ...
            e = {
                ...
                rotate: function (t, e, i) {
                    var o = e[0],
                        ...
                        l = Math.sin(i),
                        d = Math.cos(i);
                    return t[0] = o * d + r * l, t[1] = -o * l + r * d, t[2] = n * d + a * l, t[3] = -n * l + d * a, t[4] = d * s + l * h, t[5] = d * h - l * s, t
                },
                ...
                invert: function (t, e) {
                    var i = e[0],
                        ...
                        a = e[5],
                        h = i * r - s * o;
                    return h ? (h = 1 / h, t[0] = r * h, t[1] = -s * h, t[2] = -o * h, t[3] = i * h, t[4] = (o * a - r * n) * h, t[5] = (s * n - i * a) * h, t) : null
                }
            };
        return e
        ...
        return h.prototype = {
                ...
                if (this.needTransform = this.needLocalTransform || t, this.needTransform) {
                    ...
                    if (o.identity(e), this.needLocalTransform) {
                        ...
                        if (i(n[0]) || i(n[1])) {
                            s[0] = -n[2] || 0, s[1] = -n[3] || 0;
                            var a = i(s[0]) || i(s[1]);
                            a && r(e, e, s), o.scale(e, e, n), a && (s[0] = -s[0], s[1] = -s[1], r(e, e, s))
                        }
                        if (this.rotation instanceof Array) {
                            if (0 !== this.rotation[0]) {
                                s[0] = -this.rotation[1] || 0, s[1] = -this.rotation[2] || 0;
                                var a = i(s[0]) || i(s[1]);
                                a && r(e, e, s), o.rotate(e, e, this.rotation[0]), a && (s[0] = -s[0], s[1] = -s[1], r(e, e, s))
                            }
                        } else 0 !== this.rotation && o.rotate(e, e, this.rotation);
                        (i(this.position[0]) || i(this.position[1])) && r(e, e, this.position)
                    }
                    t && (this.needLocalTransform ? o.mul(e, this.parent.transform, e) : o.copy(e, this.parent.transform)), this.transform = e, this.invTransform = this.invTransform || o.create(), o.invert(this.invTransform, e)
                }
            },
            ...
            lookAt: function () {
                ...
                return function (i) {
                    ...
                    if (n.sub(t, i, this.position), !e(t[0]) || !e(t[1])) {
                        n.normalize(t, t);
                        var r = this.scale;
                        s[2] = t[0] * r[1], s[3] = t[1] * r[1], s[0] = t[1] * r[0], s[1] = -t[0] * r[0], s[4] = this.position[0], s[5] = this.position[1], this.decomposeTransform()
                    }
                }
            }(),
            decomposeTransform: function () {
                if (this.transform) {
                    ...
                    i(r - 1) && (r = Math.sqrt(r)), o[0] = t[4], o[1] = t[5], n[0] = e, n[1] = r, n[2] = n[3] = 0, s[0] = Math.atan2(-t[1] / r, t[0] / e), s[1] = s[2] = 0
                }
            },
            transformCoordToLocal: function (t, e) {
                var i = [t, e];
                return this.needTransform && this.invTransform && n.applyTransform(i, i, this.invTransform), i
            }
        }, h
        ...
        var n = t("./config"),
            ...
            l = function (t, i) {
                ...
                var o = document.createElement("div");
                this._domRoot = o, o.style.position = "relative", o.style.overflow = "hidden", o.style.width = this._width + "px", o.style.height = this._height + "px", t.appendChild(o), this._layers = {}, this._zlevelList = [], this._layerConfig = {}, this._loadingEffect = new a({}), this.shapeToImage = this._createShapeToImageProcessor(), this._bgDom = document.createElement("div"), this._bgDom.style.cssText = ["position:absolute;left:0px;top:0px;width:", this._width, "px;height:", this._height + "px;", "-webkit-user-select:none;user-select;none;", "-webkit-touch-callout:none;"].join(""), this._bgDom.setAttribute("data-zr-dom-id", "bg"), this._bgDom.className = n.elementClassName, o.appendChild(this._bgDom), this._bgDom.onselectstart = e;
                var s = new h("_zrender_hover_", this);
                this._layers.hover = s, o.appendChild(s.dom), s.initContext(), s.dom.onselectstart = e, s.dom.style["-webkit-user-select"] = "none", s.dom.style["user-select"] = "none", s.dom.style["-webkit-touch-callout"] = "none", this.refreshNextFrame = null
            };
        return l.prototype.render = function (t) {
            ...
            for (var a = 0, h = t.length; h > a; a++) {
                var l = t[a];
                if (o !== l.zlevel && (i && (i.needTransform && s.restore(), s.flush && s.flush()), o = l.zlevel, i = this.getLayer(o), i.isBuildin || r("ZLevel " + o + " has been used by unkown layer " + i.id), s = i.ctx, i.unusedCount = 0, (i.dirty || e) && i.clear(), i.needTransform && (s.save(), i.setTransform(s))), (i.dirty || e) && !l.invisible && (!l.onbrush || l.onbrush && !l.onbrush(s, !1)))
                    if (n.catchBrushException) try {
            ...
            i && (i.needTransform && s.restore(), s.flush && s.flush()), this.eachBuildinLayer(this._postProcessLayer)
        }, l.prototype.getLayer = function (t) {
            var e = this._layers[t];
            return e || (e = new h(t, this), e.isBuildin = !0, this._layerConfig[t] && s.merge(e, this._layerConfig[t], !0), e.updateTransform(), this.insertLayer(t, e), e.initContext()), e
        }, l.prototype.insertLayer = function (t, e) {
            if (this._layers[t]) return void r("ZLevel " + t + " has been used already");
            ...
            if (e) {
                this._layerConfig[t] ? s.merge(this._layerConfig[t], e, !0) : this._layerConfig[t] = e;
            ...
            e && (this.modLayer(t, {
                ...
                rotation: e.rotation,
                scale: e.scale
            }), e.dom.parentNode.removeChild(e.dom), delete this._layers[t], this._zlevelList.splice(s.indexOf(this._zlevelList, t), 1))
            ...
            this.storage.iterShape(function (t) {
                if (!t.invisible && (!t.onbrush || t.onbrush && !t.onbrush(s, !1)))
                    if (n.catchBrushException) try {
            ...
            var r = document.createElement("canvas"),
                a = r.getContext("2d");
            r.style.width = o + "px", r.style.height = n + "px", r.setAttribute("width", o * s), r.setAttribute("height", n * s), a.clearRect(0, 0, o * s, n * s);
            var h = {
                position: i.position,
                rotation: i.rotation,
                scale: i.scale
        ...
        return s.prototype.iterShape = function (t, e) {
            if (e || (e = n), e.hover)
            ...
            for (var i = [], o = 0, n = this._hoverElements.length; n > o; o++) {
                ...
                if (s) {
                    ...
                    for (var a = 0, h = s.length; h > a; a++) r = s[a].id ? s[a] : this.get(s[a]), r && i.push(r)
                }
            }
            if (i.sort(e), t)
            ...
            if ("string" == typeof t && (t = this._elements[t]), t && (t.modSelf(), e))
                if (e.parent || e._storage || e.__clipShapes) {
                    var o = {};
                    for (var n in e) "parent" !== n && "_storage" !== n && "__clipShapes" !== n && e.hasOwnProperty(n) && (o[n] = e[n]);
                    i.merge(t, o, !0)
                } else i.merge(t, e, !0);
            return this
            ...
            if (t instanceof Array)
                ...
                a >= 0 && (this.delFromMap(r.id), this._roots.splice(a, 1), r instanceof o && r.delChildrenFromStorage(this))
            }
        ...
        function n(t, e, i, n, s) {
            var r = t.length;
            if (1 == s)
                for (var a = 0; r > a; a++) n[a] = o(t[a], e[a], i);
            else
        ...
        function r(t, e, i, o, n, s, r, h, l) {
            var d = t.length;
            if (1 == l)
                for (var c = 0; d > c; c++) h[c] = a(t[c], e[c], i[c], o[c], n, s, r);
            else
                for (var p = t[0].length, c = 0; d > c; c++)
                    for (var u = 0; p > u; u++) h[c][u] = a(t[c][u], e[c][u], i[c][u], o[c][u], n, s, r)
        }

        function a(t, e, i, o, n, s, r) {
            var a = .5 * (i - t),
                h = .5 * (o - e);
            return (2 * (e - i) + a + h) * r + (-3 * (e - i) - 2 * a - h) * s + a * n + e
        }
        ...
        var d = t("./Clip"),
            ...
            g = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (t) {
                setTimeout(t, 16)
            },
            f = Array.prototype.slice,
            m = function (t) {
                t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function () {}, this._clips = [], this._running = !1, this._time = 0, u.call(this)
            };
        m.prototype = {
            add: function (t) {
                this._clips.push(t)
            ...
            _update: function () {
                for (var t = (new Date).getTime(), e = t - this._time, i = this._clips, o = i.length, n = [], s = [], r = 0; o > r; r++) {
                    var a = i[r];
                    a.__inStep = !0;
                    var h = a.step(t);
                    a.__inStep = !1, h && (n.push(h), s.push(a))
                }
                for (var r = 0; o > r;) i[r].__needsRemove ? (i[r] = i[o - 1], i.pop(), o--) : r++;
                o = n.length;
        ...
        var _ = function (t, o, n, s) {
            this._tracks = {}, this._target = t, this._loop = o || !1, this._getter = n || e, this._setter = s || i, this._clipCount = 0, this._delay = 0, this._doneList = [], this._onframeList = [], this._clipList = []
        };
        return _.prototype = {
            when: function (t, e) {
                        ...
                        if (m) {
                            ...
                            if (m) {
                                ...
                                for (var S = [], T = [], z = 0; m > z; z++) {
                                    S.push(g[z].time / b);
                                    var C = g[z].value;
                                    "string" == typeof C && (C = c.toArray(C), 0 === C.length && (C[0] = C[1] = C[2] = 0, C[3] = 1), x = !0), T.push(C)
                                }
                                var L, z, w, E, M, A, k, O = 0,
                                    I = 0;
                                if (x) var P = [0, 0, 0, 0];
                                var R = function (t, s) {
                                        if (I > s) {
                                            for (L = Math.min(O + 1, m - 1), z = L; z >= 0 && !(S[z] <= s); z--);
                                            z = Math.min(z, m - 2)
                                        } else {
                                            for (z = O; m > z && !(S[z] > s); z++);
                                            z = Math.min(z - 1, m - 2)
                                        ...
                                        if (0 !== d) {
                                            if (w = (s - S[z]) / d, p)
                                                if (M = T[z], E = T[0 === z ? z : z - 1], A = T[z > m - 2 ? m - 1 : z + 1], k = T[z > m - 3 ? m - 1 : z + 2], y) r(E, M, A, k, w, w * w, w * w * w, h(t, f), v);
                                                else {
                                                    var c;
                                                    x ? (c = r(E, M, A, k, w, w * w, w * w * w, P, 1), c = l(P)) : c = a(E, M, A, k, w, w * w, w * w * w), i(t, f, c)
                                                }
                                            else if (y) n(T[z], T[z + 1], w, h(t, f), v);
                                            else {
                                                var c;
                                                x ? (n(T[z], T[z + 1], w, P, 1), c = l(P)) : c = o(T[z], T[z + 1], w), i(t, f, c)
                                            }
                                            for (z = 0; z < e._onframeList.length; z++) e._onframeList[z](t, s)
                                        }
                                    },
                                    D = new d({
                                        target: e._target,
        ...
        var s = t("./config"),
            ...
            c = s.EVENT,
            p = t("./mixin/Eventful"),
            u = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"],
            g = function (t) {
            ...
            f = {
                ...
                click: function (t, e) {
                    if (g(t) || e) {
                        ...
                        (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, c.CLICK, t), this._mousemoveHandler(t)
                    }
                },
                dblclick: function (t, e) {
                    if (g(t) || e) {
                        ...
                        var i = this._lastHover;
                        (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, c.DBLCLICK, t), this._mousemoveHandler(t)
                    }
                },
                    ...
                    if (g(t) || e) {
                        ...
                        this.painter.eachBuildinLayer(function (e) {
                            ...
                            if (e.zoomable) {
                                e.__zoom = e.__zoom || 1;
                                var h = e.__zoom;
                                h *= o, h = Math.max(Math.min(e.maxZoom, h), e.minZoom), o = h / e.__zoom, e.__zoom = h, i[0] -= (s - i[0]) * (o - 1), i[1] -= (r - i[1]) * (o - 1), e.scale[0] *= o, e.scale[1] *= o, e.dirty = !0, n = !0, a.stop(t)
                            }
                ...
                mousemove: function (t, e) {
                    if ((g(t) || e) && !this.painter.isLoading()) {
                        ...
                        var n = "default";
                        if (this._draggingTarget) this.storage.drift(this._draggingTarget.id, i, o), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++;
                        else if (this._isMouseDown) {
                            var s = !1;
                            this.painter.eachBuildinLayer(function (t) {
                                t.panable && (n = "move", t.position[0] += i, t.position[1] += o, s = !0, t.dirty = !0)
                            }), s && this.painter.refresh()
                        }
                        this._draggingTarget || this._hasfound && this._lastHover.draggable ? n = "move" : this._hasfound && this._lastHover.clickable && (n = "pointer"), this.root.style.cursor = n, this._dispatchAgency(this._lastHover, c.MOUSEMOVE, t), (this._draggingTarget || this._hasfound || this.storage.hasHoverShape()) && this.painter.refreshHover()
                    }
                },
                ...
                mousedown: function (t, e) {
                    if (g(t) || e) {
                        ...
                        this._lastMouseDownMoment = new Date, t = this._zrenderEventFixed(t), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, c.MOUSEDOWN, t), this._lastDownButton = t.button
                    }
                },
                mouseup: function (t, e) {
                    (g(t) || e) && (t = this._zrenderEventFixed(t), this.root.style.cursor = "default", this._isMouseDown = 0, this._mouseDownTarget = null, this._dispatchAgency(this._lastHover, c.MOUSEUP, t), this._processDrop(t), this._processDragEnd(t))
                },
                touchstart: function (t, e) {
                    (g(t) || e) && (t = this._zrenderEventFixed(t, !0), this._lastTouchMoment = new Date, this._mobileFindFixed(t), this._mousedownHandler(t))
                },
                touchmove: function (t, e) {
                    (g(t) || e) && (t = this._zrenderEventFixed(t, !0), this._mousemoveHandler(t), this._isDragging && a.stop(t))
                },
                touchend: function (t, e) {
                    if (g(t) || e) {
                        t = this._zrenderEventFixed(t, !0), this._mouseupHandler(t);
                        var i = new Date;
                        i - this._lastTouchMoment < c.touchClickDelay && (this._mobileFindFixed(t), this._clickHandler(t), i - this._lastClickMoment < c.touchClickDelay / 2 && (this._dblclickHandler(t), this._lastHover && this._lastHover.clickable && a.stop(t)), this._lastClickMoment = i), this.painter.clearHover()
                    }
                }
            },
            m = function (t, e, s) {
                p.call(this), this.root = t, this.storage = e, this.painter = s, this._lastX = this._lastY = this._mouseX = this._mouseY = 0, this._findHover = i(n, this), this._domHover = s.getDomHover(), o(this), window.addEventListener ? (window.addEventListener("resize", this._resizeHandler), r.os.tablet || r.os.phone ? (t.addEventListener("touchstart", this._touchstartHandler), t.addEventListener("touchmove", this._touchmoveHandler), t.addEventListener("touchend", this._touchendHandler)) : (t.addEventListener("click", this._clickHandler), t.addEventListener("dblclick", this._dblclickHandler), t.addEventListener("mousewheel", this._mousewheelHandler), t.addEventListener("mousemove", this._mousemoveHandler), t.addEventListener("mousedown", this._mousedownHandler), t.addEventListener("mouseup", this._mouseupHandler)), t.addEventListener("DOMMouseScroll", this._mousewheelHandler), t.addEventListener("mouseout", this._mouseoutHandler)) : (window.attachEvent("onresize", this._resizeHandler), t.attachEvent("onclick", this._clickHandler), t.ondblclick = this._dblclickHandler, t.attachEvent("onmousewheel", this._mousewheelHandler), t.attachEvent("onmousemove", this._mousemoveHandler), t.attachEvent("onmouseout", this._mouseoutHandler), t.attachEvent("onmousedown", this._mousedownHandler), t.attachEvent("onmouseup", this._mouseupHandler))
            };
        m.prototype.on = function (t, e, i) {
            ...
            var t = this.root;
            window.removeEventListener ? (window.removeEventListener("resize", this._resizeHandler), r.os.tablet || r.os.phone ? (t.removeEventListener("touchstart", this._touchstartHandler), t.removeEventListener("touchmove", this._touchmoveHandler), t.removeEventListener("touchend", this._touchendHandler)) : (t.removeEventListener("click", this._clickHandler), t.removeEventListener("dblclick", this._dblclickHandler), t.removeEventListener("mousewheel", this._mousewheelHandler), t.removeEventListener("mousemove", this._mousemoveHandler), t.removeEventListener("mousedown", this._mousedownHandler), t.removeEventListener("mouseup", this._mouseupHandler)), t.removeEventListener("DOMMouseScroll", this._mousewheelHandler), t.removeEventListener("mouseout", this._mouseoutHandler)) : (window.detachEvent("onresize", this._resizeHandler), t.detachEvent("onclick", this._clickHandler), t.detachEvent("dblclick", this._dblclickHandler), t.detachEvent("onmousewheel", this._mousewheelHandler), t.detachEvent("onmousemove", this._mousemoveHandler), t.detachEvent("onmouseout", this._mouseoutHandler), t.detachEvent("onmousedown", this._mousedownHandler), t.detachEvent("onmouseup", this._mouseupHandler)), this.root = this._domHover = this.storage = this.painter = null, this.un()
            ...
            var n = "on" + e,
                ...
                r = t;
            for (o && (s.dragged = o); r && (r[n] && (s.cancelBubble = r[n](s)), r.dispatch(e, s), r = r.parent, !s.cancelBubble););
            if (t) s.cancelBubble || this.dispatch(e, s);
                ...
                this.dispatch(e, a), this.painter.eachOtherLayer(function (t) {
                    "function" == typeof t[n] && t[n](a), t.dispatch && t.dispatch(e, a)
                })
            }
        }, m.prototype._iterateAndFindHover = function () {
            var t = d.create();
            return function () {
                for (var e, i, o = this.storage.getShapeList(), n = [0, 0], s = o.length - 1; s >= 0; s--) {
                    var r = o[s];
                    if (e !== r.zlevel && (i = this.painter.getLayer(r.zlevel, i), n[0] = this._mouseX, n[1] = this._mouseY, i.needTransform && (d.invert(t, i.transform), l.applyTransform(n, n, t))), this._findHover(r, n[0], n[1])) break
                }
            }
        }();
        var _ = [{
        ...
        }, h.merge(m.prototype, p.prototype, !0), m
            ...
            if (e(c) && e(p))
                ...
                if (e(m)) {
                    ...
                    var b = Math.sqrt(m),
                        S = c * h + 1.5 * a * (-p + b),
                        T = c * h + 1.5 * a * (-p - b);
                    S = 0 > S ? -Math.pow(-S, y) : Math.pow(S, y), T = 0 > T ? -Math.pow(-T, y) : Math.pow(T, y);
                    var f = (-h - (S + T)) / (3 * a);
                    f >= 0 && 1 >= f && (r[g++] = f)
                } else {
                    ...
                    f >= 0 && 1 >= f && (r[g++] = f), v >= 0 && 1 >= v && (r[g++] = v), E >= 0 && 1 >= E && (r[g++] = E)
                }
            }
            return g
        }
        ...
        function a(t, e, i, o, n, s) {
            var r = (e - t) * n + t,
                ...
                d = (h - a) * n + a,
                c = (d - l) * n + l;
            s[0] = t, s[1] = r, s[2] = l, s[3] = c, s[4] = c, s[5] = d, s[6] = h, s[7] = o
        }
        ...
        function h(t, e, i, n, s, r, a, h, l, d, c) {
            ...
            return c && (c[0] = o(t, i, s, a, p), c[1] = o(e, n, r, h, p)), Math.sqrt(g)
        }
        ...
        function g(t, e, i, o, n, s, r, a, h) {
            ...
            return h && (h[0] = l(t, i, n, d), h[1] = l(e, o, s, d)), Math.sqrt(p)
        }
        var f = t("./vector"),
            m = 1e-4,
            _ = Math.sqrt(3),
        ...
        function i(t, e, i) {
            var o = document.createElement(e),
                n = i.getWidth(),
                s = i.getHeight();
            return o.style.position = "absolute", o.style.left = 0, o.style.top = 0, o.style.width = n + "px", o.style.height = s + "px", o.width = n * r.devicePixelRatio, o.height = s * r.devicePixelRatio, o.setAttribute("data-zr-dom-id", t), o
        }
        var o = t("./mixin/Transformable"),
            ...
            r = t("./config"),
            a = function (t, n) {
                this.id = t, this.dom = i(t, "canvas", n), this.dom.onselectstart = e, this.dom.style["-webkit-user-select"] = "none", this.dom.style["user-select"] = "none", this.dom.style["-webkit-touch-callout"] = "none", this.dom.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)", this.dom.className = r.elementClassName, s && s.initElement(this.dom), this.domBack = null, this.ctxBack = null, this.painter = n, this.unusedCount = 0, this.config = null, this.dirty = !0, this.elCount = 0, this.clearColor = 0, this.motionBlur = !1, this.lastFrameAlpha = .7, this.zoomable = !1, this.panable = !1, this.maxZoom = 1 / 0, this.minZoom = 0, o.call(this)
            };
        return a.prototype.initContext = function () {
            ...
            if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(t, 0, 0, i / l, o / l)), e.clearRect(0, 0, i / l, o / l), n && (e.save(), e.fillStyle = this.clearColor, e.fillRect(0, 0, i / l, o / l), e.restore()), a) {
                var d = this.domBack;
                e.save(), e.globalAlpha = h, e.drawImage(d, 0, 0, i / l, o / l), e.restore()
            }
        }, n.merge(a.prototype, o.prototype), a
            ...
            buildPath: function (t, e) {
                ...
                if (s && !(2 > s)) {
                    var r = e.x,
                        ...
                        h = e.r,
                        l = e.r0;
                    null == l && (l = s > 4 ? h * o(2 * n / s) / o(n / s) : h / 3);
                    var d = n / s,
                        c = -n / 2,
                        p = r + h * o(c),
                        u = a + h * i(c);
                    ...
                    var g = e.pointList = [];
                    g.push([p, u]);
                    for (var f, m = 0, _ = 2 * s - 1; _ > m; m++) f = m % 2 === 0 ? l : h, g.push([r + f * o(c), a + f * i(c)]), c += d;
        ...
        return n.prototype = {
            ...
            isCover: function (t, e) {
                var i = this.transformCoordToLocal(t, e);
                return t = i[0], e = i[1], this.isCoverRect(t, e) ? o.isInsidePath(this._pathProxy.pathCommands, this.style.lineWidth, this.style.brushType, t, e) : void 0
            }
        ...
        return s.prototype.ignore = !1, s.prototype.children = function () {
            ...
            t != this && t.parent != this && (t.parent && t.parent.removeChild(t), this._children.push(t), t.parent = this, this._storage && this._storage !== t._storage && (this._storage.addToMap(t), t instanceof s && t.addChildrenToStorage(this._storage)))
        }, s.prototype.removeChild = function (t) {
            var e = i.indexOf(this._children, t);
            e >= 0 && this._children.splice(e, 1), t.parent = null, this._storage && (this._storage.delFromMap(t.id), t instanceof s && t.delChildrenFromStorage(this._storage))
        }, s.prototype.clearChildren = function () {
            for (var t = 0; t < this._children.length; t++) {
                var e = this._children[t];
                this._storage && (this._storage.delFromMap(e.id), e instanceof s && e.delChildrenFromStorage(this._storage))
            }
            ...
            this.__dirty = !0
        }, i.merge(s.prototype, o.prototype, !0), i.merge(s.prototype, n.prototype, !0), s
        ...
        return o.prototype.fastBoundingRect = function () {
            ...
            for (var o = 0; o < this.pathCommands.length; o++) {
                ...
                switch (n.command) {
                    ...
                    case "L":
                        ...
                        break;
                    case "C":
                        for (var r = 0; 6 > r; r += 2) t[0] = Math.min(t[0], t[0], s[r]), t[1] = Math.min(t[1], t[1], s[r + 1]), i[0] = Math.max(i[0], i[0], s[r]), i[1] = Math.max(i[1], i[1], s[r + 1]);
                        break;
                    case "Q":
                        for (var r = 0; 4 > r; r += 2) t[0] = Math.min(t[0], t[0], s[r]), t[1] = Math.min(t[1], t[1], s[r + 1]), i[0] = Math.max(i[0], i[0], s[r]), i[1] = Math.max(i[1], i[1], s[r + 1]);
                        break;
                    case "A":
                        var a = s[0],
                            h = s[1],
            ...
            return this.pathCommands.push(new i("C", [t, e, o, n, s, r])), this._ctx && this._ctx.bezierCurveTo(t, e, o, n, s, r), this
            ...
            return this.pathCommands.push(new i("A", [t, e, o, o, n, s - n, 0, r ? 0 : 1])), this._ctx && this._ctx.arc(t, e, o, n, s, r), this
        ...
        return e.prototype = {
            step: function (t) {
                ...
                if (!(0 > e)) {
                    e = Math.min(e, 1);
                    var o = "string" == typeof this.easing ? i[this.easing] : this.easing,
                        n = "function" == typeof o ? o(e) : e;
                    return this.fire("frame", n), 1 == e ? this.loop ? (this.restart(), "restart") : (this.__needsRemove = !0, "destroy") : null
                }
            },
            restart: function () {
        ...
        return i.prototype = {
            ...
            getRect: function (t) {
                ...
                var e = Math.min(t.xStart, t.xEnd, t.cpX1),
                    ...
                    s = t.cpX2,
                    r = t.cpY2;
                "undefined" != typeof s && "undefined" != typeof r && (e = Math.min(e, s), i = Math.min(i, r), o = Math.max(o, s), n = Math.max(n, r));
                var a = t.lineWidth || 1;
                return t.__rect = {
                    x: e - a,
                    y: i - a,
        ...
        return function (e, i, o, n, s, r) {
            if (e.setLineDash) return t[0] = t[1] = r, e.setLineDash(t), e.moveTo(i, o), void e.lineTo(n, s);
        ...
        var i = t("../../tool/vector");
        return function (t, o) {
            for (var n = t.length, s = [], r = 0, a = 1; n > a; a++) r += i.distance(t[a - 1], t[a]);
            var h = r / 5;
            h = n > h ? n : h;
            for (var a = 0; h > a; a++) {
                var l, d, c, p = a / (h - 1) * (o ? n : n - 1),
                    u = Math.floor(p),
                    g = p - u,
                    f = t[u % n];
                o ? (l = t[(u - 1 + n) % n], d = t[(u + 1) % n], c = t[(u + 2) % n]) : (l = t[0 === u ? u : u - 1], d = t[u > n - 2 ? n - 1 : u + 1], c = t[u > n - 3 ? n - 1 : u + 2]);
                var m = g * g,
                    _ = g * m;
                s.push([e(l[0], f[0], d[0], c[0], g, m, _), e(l[1], f[1], d[1], c[1], g, m, _)])
            }
            return s
        }
        ...
        return function (t, i, o, n) {
            ...
            for (var g = 0, f = t.length; f > g; g++) {
                ...
                var _ = e.distance(m, s),
                    y = e.distance(m, r),
                    x = _ + y;
                0 !== x && (_ /= x, y /= x), e.scale(c, d, -_), e.scale(p, d, y);
                var v = e.add([], m, c),
                    b = e.add([], m, p);
                u && (e.max(v, v, a), e.min(v, v, h), e.max(b, b, a), e.min(b, b, h)), l.push(v), l.push(b)
            }
        ...
        function o(t, i) {
            for (var o, s = t.length; s--;) {
                var r = e(t[s], i);
                "undefined" != typeof r && ("undefined" == typeof o ? o = n.clone(r) : n.merge(o, r, !0))
            }
            return o
        }
        ...
        return o.prototype._buildTree = function (t, o, n, s) {
            if (o > n) return null;
            ...
            var a = t[r],
                h = new e(s, a);
            return s = (s + 1) % this.dimension, n > o && (h.left = this._buildTree(t, o, r - 1, s), h.right = this._buildTree(t, r + 1, n, s)), h
            ...
            var i = this.root,
                ...
                s = 1 / 0,
                r = null;
            for (i.data !== t && (s = e(i.data, t), r = i), t.array[i.axis] < i.data.array[i.axis] ? (i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (i.left && (o[n++] = i.left), i.right && (o[n++] = i.right)); n--;) {
                i = o[n];
                var a = t.array[i.axis] - i.data.array[i.axis],
                    h = 0 > a,
                    l = !1;
                a *= a, s > a && (a = e(i.data, t), s > a && i.data !== t && (s = a, r = i), l = !0), h ? (l && i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (l && i.left && (o[n++] = i.left), i.right && (o[n++] = i.right))
            }
            return r.data
        }, o.prototype._addNearest = function (t, e, i) {
            for (var o = this._nearstNList, n = t - 1; n > 0 && !(e >= o[n - 1].dist); n--) o[n].dist = o[n - 1].dist, o[n].node = o[n - 1].node;
            o[n].dist = e, o[n].node = i
        }, o.prototype.nearestN = function (t, e, i, o) {
            if (0 >= e) return o.length = 0, o;
            for (var n = this.root, s = this._stack, r = 0, a = this._nearstNList, h = 0; e > h; h++) a[h] || (a[h] = {}), a[h].dist = 0, a[h].node = null;
            var l = i(n.data, t),
                d = 0;
            for (n.data !== t && (d++, this._addNearest(d, l, n)), t.array[n.axis] < n.data.array[n.axis] ? (n.right && (s[r++] = n.right), n.left && (s[r++] = n.left)) : (n.left && (s[r++] = n.left), n.right && (s[r++] = n.right)); r--;) {
                n = s[r];
                var l = t.array[n.axis] - n.data.array[n.axis],
                    c = 0 > l,
                    p = !1;
                l *= l, (e > d || l < a[d - 1].dist) && (l = i(n.data, t), (e > d || l < a[d - 1].dist) && n.data !== t && (e > d && d++, this._addNearest(d, l, n)), p = !0), c ? (p && n.right && (s[r++] = n.right), n.left && (s[r++] = n.left)) : (p && n.left && (s[r++] = n.left), n.right && (s[r++] = n.right))
            }
        ...
        return e.prototype = {
            ...
            _optionToContent: function () {
                ...
                if (this.option.xAxis)
                    for (a = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis], t = 0, n = a.length; n > t; t++)
                        if ("category" == (a[t].type || "category")) {
                            for (r = [], e = 0, i = a[t].data.length; i > e; e++) r.push(this.getDataFromOption(a[t].data[e]));
                            h += r.join(", ") + "\n\n"
                        } if (this.option.yAxis)
                    for (a = this.option.yAxis instanceof Array ? this.option.yAxis : [this.option.yAxis], t = 0, n = a.length; n > t; t++)
                        if ("category" == a[t].type) {
                            for (r = [], e = 0, i = a[t].data.length; i > e; e++) r.push(this.getDataFromOption(a[t].data[e]));
                            h += r.join(", ") + "\n\n"
                        } var l, d = this.option.series;
                for (t = 0, n = d.length; n > t; t++) {
                    for (r = [], e = 0, i = d[t].data.length; i > e; e++) s = d[t].data[e], l = d[t].type == o.CHART_TYPE_PIE || d[t].type == o.CHART_TYPE_MAP ? (s.name || "-") + ":" : "", d[t].type == o.CHART_TYPE_SCATTER && (s = this.getDataFromOption(s).join(", ")), r.push(l + this.getDataFromOption(s));
            ...
            _save: function () {
                ...
                if ("function" != typeof t) {
                    for (var e = this._textArea.value.split("\n"), i = [], n = 0, s = e.length; s > n; n++) e[n] = this._trim(e[n]), "" !== e[n] && i.push(e[n]);
                    this._contentToOption(i)
                } else t(this._textArea, this.option);
                this.hide();
                var r = this;
                setTimeout(function () {
                    r.messageCenter && r.messageCenter.dispatch(o.EVENT.DATA_VIEW_CHANGED, null, {
                        option: r.option
                    }, r.myChart)
            ...
            _contentToOption: function (t) {
                var e, i, n, s, r, a, h, l = [],
                    d = 0;
                if (this.option.xAxis)
                    for (l = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis], e = 0, s = l.length; s > e; e++)
                        if ("category" == (l[e].type || "category")) {
                            for (a = t[d].split(","), i = 0, n = l[e].data.length; n > i; i++) h = this._trim(a[i] || ""), r = l[e].data[i], "undefined" != typeof l[e].data[i].value ? l[e].data[i].value = h : l[e].data[i] = h;
                            d++
                        } if (this.option.yAxis)
                    for (l = this.option.yAxis instanceof Array ? this.option.yAxis : [this.option.yAxis], e = 0, s = l.length; s > e; e++)
                ...
                for (e = 0, s = c.length; s > e; e++)
                    if (d++, c[e].type == o.CHART_TYPE_SCATTER)
                        for (var i = 0, n = c[e].data.length; n > i; i++) a = t[d], h = a.replace(" ", "").split(","), "undefined" != typeof c[e].data[i].value ? c[e].data[i].value = h : c[e].data[i] = h, d++;
                    else {
                        a = t[d].split(",");
    ...
    }), i("echarts/component/valueAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/date", "zrender/tool/util", "../util/smartSteps", "../util/accMath", "../util/smartLogSteps", "../component"], function (t) {
        function e(t, e, o, n, s, r, a) {
            if (!a || 0 === a.length) return void console.err("option.series.length == 0.");
            i.call(this, t, e, o, n, s), this.series = a, this.grid = this.component.grid;
        ...
        return e.prototype = {
            ...
            _buildAxisTick: function () {
                ...
                if (this.isHorizontal())
                    for (var h, l = "bottom" === this.option.position ? o.inside ? this.grid.getYend() - s - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - s - 1, d = 0; i > d; d++) h = this.subPixelOptimize(this.getCoord(e[d]), a), t = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                    ...
                    for (var c, p = "left" === this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - s - 1 : o.inside ? this.grid.getXend() - s - 1 : this.grid.getXend() + 1, d = 0; i > d; d++) c = this.subPixelOptimize(this.getCoord(e[d]), a), t = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
            ...
            _buildAxisLabel: function () {
                ...
                if (this.isHorizontal()) {
                    var h, l;
                    "bottom" === this.option.position ? (h = this.grid.getYend() + s, l = "top") : (h = this.grid.getY() - s, l = "bottom");
                    for (var d = 0; i > d; d++) t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                    ...
                    }, n && (t.style.textAlign = n > 0 ? "bottom" === this.option.position ? "right" : "left" : "bottom" === this.option.position ? "left" : "right", t.rotation = [n * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(r, t)))
                } else {
                    var c, p;
                    "left" === this.option.position ? (c = this.grid.getX() - s, p = "right") : (c = this.grid.getXend() + s, p = "left");
                    for (var d = 0; i > d; d++) t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                    ...
                    }, n && (t.rotation = [n * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(r, t)))
                }
            },
            _buildSplitLine: function () {
                ...
                var h = a.length;
                if (this.isHorizontal())
                    for (var l, d = this.grid.getY(), c = this.grid.getYend(), p = 0; i > p; p++) l = this.subPixelOptimize(this.getCoord(e[p]), r), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
                    ...
                    for (var u, g = this.grid.getX(), f = this.grid.getXend(), p = 0; i > p; p++) u = this.subPixelOptimize(this.getCoord(e[p]), r), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
            ...
            _buildSplitArea: function () {
                ...
                if (e instanceof Array) {
                    ...
                    if (this.isHorizontal())
                        for (var r, a = this.grid.getY(), h = this.grid.getHeight(), l = this.grid.getX(), d = 0; n >= d; d++) r = n > d ? this.getCoord(o[d]) : this.grid.getXend(), t = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                        ...
                        }, this.shapeList.push(new s(t)), l = r;
                    else
                        for (var c, p = this.grid.getX(), u = this.grid.getWidth(), g = this.grid.getYend(), d = 0; n >= d; d++) c = n > d ? this.getCoord(o[d]) : this.grid.getY(), t = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                        ...
                        }, this.shapeList.push(new s(t)), g = c
                } else t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
            ...
            _calculateValue: function () {
                if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                    for (var t, e, i = {}, o = this.component.legend, n = 0, s = this.series.length; s > n; n++) !(this.series[n].type != r.CHART_TYPE_LINE && this.series[n].type != r.CHART_TYPE_BAR && this.series[n].type != r.CHART_TYPE_SCATTER && this.series[n].type != r.CHART_TYPE_K && this.series[n].type != r.CHART_TYPE_EVENTRIVER || o && !o.isSelected(this.series[n].name) || (t = this.series[n].xAxisIndex || 0, e = this.series[n].yAxisIndex || 0, this.option.xAxisIndex != t && this.option.yAxisIndex != e || !this._calculSum(i, n)));
                    var a;
                    for (var n in i) {
                        a = i[n];
            ...
            _calculSum: function (t, e) {
                ...
                if (this.series[e].stack) {
                    ...
                    t[s] = t[s] || [], t[h] = t[h] || [], t[n] = t[n] || [], o = this.series[e].data;
                    for (var l = 0, d = o.length; d > l; l++) i = this.getDataFromOption(o[l]), "-" !== i && (i -= 0, i >= 0 ? null != t[s][l] ? t[s][l] += i : t[s][l] = i : null != t[h][l] ? t[h][l] += i : t[h][l] = i, this.option.scale && t[n].push(i))
                } else if (t[n] = t[n] || [], this.series[e].type != r.CHART_TYPE_EVENTRIVER) {
                    o = this.series[e].data;
                    for (var l = 0, d = o.length; d > l; l++) i = this.getDataFromOption(o[l]), this.series[e].type === r.CHART_TYPE_K ? (t[n].push(i[0]), t[n].push(i[1]), t[n].push(i[2]), t[n].push(i[3])) : i instanceof Array ? (-1 != this.option.xAxisIndex && t[n].push("time" != this.option.type ? i[0] : a.getNewDate(i[0])), -1 != this.option.yAxisIndex && t[n].push("time" != this.option.type ? i[1] : a.getNewDate(i[1]))) : t[n].push(i)
                } else {
                    o = this.series[e].data;
                    for (var l = 0, d = o.length; d > l; l++)
                        for (var c = o[l].evolution, p = 0, u = c.length; u > p; p++) t[n].push(a.getNewDate(c[p].time))
                }
            },
            _reformValue: function (e) {
                ...
                o = null != o ? o : n.secs, this._min = n.min, this._max = n.max, this._valueList = n.pnts, this._reformLabelData()
            },
            ...
            _reformLabelData: function (t) {
                ...
                if (e)
                    for (var i = 0, o = this._valueList.length; o > i; i++) "function" == typeof e ? this._valueLabel.push(t ? e.call(this.myChart, this._valueList[i], t) : e.call(this.myChart, this._valueList[i])) : "string" == typeof e && this._valueLabel.push(t ? a.format(e, this._valueList[i]) : e.replace("{value}", this._valueList[i]));
                else
                    for (var i = 0, o = this._valueList.length; o > i; i++) this._valueLabel.push(t ? t(this._valueList[i]) : this.numAddCommas(this._valueList[i]))
            },
        ...
        function e(t, e, i) {
            if (0 !== t.length) {
                for (var o = t[0][0], n = t[0][0], s = t[0][1], r = t[0][1], a = 1; a < t.length; a++) {
                    var h = t[a];
                    h[0] < o && (o = h[0]), h[0] > n && (n = h[0]), h[1] < s && (s = h[1]), h[1] > r && (r = h[1])
                }
        ...
        function i(t, e, i, o, n, r) {
            ...
            for (var h = 0; h < a.length; h++) a[h] = s.cubicAt(t[0], e[0], i[0], o[0], a[h]);
            var l = [];
            s.cubicExtrema(t[1], e[1], i[1], o[1], l);
            for (var h = 0; h < l.length; h++) l[h] = s.cubicAt(t[1], e[1], i[1], o[1], l[h]);
        ...
        function o(t, e, i, o, n) {
            ...
            o[0] = Math.min(t[0], i[0], d, p), o[1] = Math.min(t[1], i[1], c, u), n[0] = Math.max(t[0], i[0], d, p), n[1] = Math.max(t[1], i[1], c, u)
        }
        var n = t("./vector"),
            s = t("./curve"),
            r = n.create(),
            ...
            l = function (t, e, i, o, s, l, d, c) {
                if (Math.abs(o - s) >= 2 * Math.PI) return d[0] = t - i, d[1] = e - i, c[0] = t + i, void(c[1] = e + i);
                if (r[0] = Math.cos(o) * i + t, r[1] = Math.sin(o) * i + e, a[0] = Math.cos(s) * i + t, a[1] = Math.sin(s) * i + e, n.min(d, r, a), n.max(c, r, a), o %= 2 * Math.PI, 0 > o && (o += 2 * Math.PI), s %= 2 * Math.PI, 0 > s && (s += 2 * Math.PI), o > s && !l ? s += 2 * Math.PI : s > o && l && (o += 2 * Math.PI), l) {
                    var p = s;
                    s = o, o = p
                }
                for (var u = 0; s > u; u += Math.PI / 2) u > o && (h[0] = Math.cos(u) * i + t, h[1] = Math.sin(u) * i + e, n.min(d, h, d), n.max(c, h, c))
            };
        ...
        return e.prototype = {
                        ...
                        if (o > 3) {
                            ...
                            for (d = 1 > d ? 1 : d, t = Math.floor(15 / r); !l && o > t;) {
                                ...
                                for (var c = Math.floor((o - 1) / t) * t; c >= 0; c -= t) {
                                    ...
                                    else if (i[c].textStyle) s = h.getTextWidth(this._getReformedLabel(c), this.getFont(a.merge(i[c].textStyle, this.option.axisLabel.textStyle)));
                                    else {
            ...
            _buildAxisTick: function () {
                var t, e = this.option.data,
                    ...
                    r = o.lineStyle.color,
                    a = o.lineStyle.width,
                    h = "function" == typeof o.interval ? o.interval : "auto" == o.interval && "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1,
                    l = h ? 1 : "auto" == o.interval ? this._interval : o.interval - 0 + 1,
                    d = o.onGap,
                    c = d ? this.getGap() / 2 : "undefined" == typeof d && this.option.boundaryGap ? this.getGap() / 2 : 0,
                    p = c > 0 ? -l : 0;
                if (this.isHorizontal())
                    for (var u, g = "bottom" == this.option.position ? o.inside ? this.grid.getYend() - s - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - s - 1, f = p; i > f; f += l)(!h || h(f, e[f])) && (u = this.subPixelOptimize(this.getCoordByIndex(f) + (f >= 0 ? c : 0), a), t = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                    ...
                    for (var m, _ = "left" == this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - s - 1 : o.inside ? this.grid.getXend() - s - 1 : this.grid.getXend() + 1, f = p; i > f; f += l)(!h || h(f, e[f])) && (m = this.subPixelOptimize(this.getCoordByIndex(f) - (f >= 0 ? c : 0), a), t = {
                        _axisShape: "axisTick",
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
            ...
            _buildAxisLabel: function () {
                ...
                if (this.isHorizontal()) {
                    var p, u;
                    "bottom" == this.option.position ? (p = this.grid.getYend() + h, u = "top") : (p = this.grid.getY() - h, u = "bottom");
                    for (var g = 0; n > g; g += this._interval) c && !c(g, i[g]) || "" === this._getReformedLabel(g) || (e = a.merge(i[g].textStyle || {}, d), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                        style: {
                    ...
                    }, r && (t.style.textAlign = r > 0 ? "bottom" == this.option.position ? "right" : "left" : "bottom" == this.option.position ? "left" : "right", t.rotation = [r * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(l, t))))
                } else {
                    var f, m;
                    "left" == this.option.position ? (f = this.grid.getX() - h, m = "right") : (f = this.grid.getXend() + h, m = "left");
                    for (var g = 0; n > g; g += this._interval) c && !c(g, i[g]) || "" === this._getReformedLabel(g) || (e = a.merge(i[g].textStyle || {}, d), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase() + 3,
                        hoverable: !1,
                        style: {
                            ...
                            textFont: this.getFont(e),
                            textAlign: e.align || m,
                            textBaseline: e.baseline || 0 === g && "" !== this.option.name ? "bottom" : g == n - 1 && "" !== this.option.name ? "top" : "middle"
                        }
                    }, r && (t.rotation = [r * Math.PI / 180, t.style.x, t.style.y]), this.shapeList.push(new o(this._axisLabelClickable(l, t))))
                }
            },
            _buildSplitLine: function () {
                var t, e = this.option.data,
                ...
                if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())
                    for (var p, u = this.grid.getY(), g = this.grid.getYend(), f = 0; i > f; f += this._interval)(!l || l(f, e[f])) && (p = this.subPixelOptimize(this.getCoordByIndex(f) + c, r), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
                    ...
                    for (var m, _ = this.grid.getX(), y = this.grid.getXend(), f = 0; i > f; f += this._interval)(!l || l(f, e[f])) && (m = this.subPixelOptimize(this.getCoordByIndex(f) - c, r), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
            ...
            _buildSplitArea: function () {
                ...
                if (o instanceof Array) {
                    ...
                    if (this.isHorizontal())
                        for (var d, c = this.grid.getY(), p = this.grid.getHeight(), u = this.grid.getX(), g = 0; r >= g; g += this._interval) a && !a(g, e[g]) && r > g || (d = r > g ? this.getCoordByIndex(g) + l : this.grid.getXend(), t = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                        ...
                        }, this.shapeList.push(new s(t)), u = d);
                    else
                        for (var f, m = this.grid.getX(), _ = this.grid.getWidth(), y = this.grid.getYend(), g = 0; r >= g; g += this._interval) a && !a(g, e[g]) && r > g || (f = r > g ? this.getCoordByIndex(g) - l : this.grid.getY(), t = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                        ...
                        }, this.shapeList.push(new s(t)), y = f)
                } else t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
            ...
            getCoord: function (t) {
                for (var e = this.option.data, i = e.length, o = this.getGap(), n = this.option.boundaryGap ? o / 2 : 0, s = 0; i > s; s++) {
                    if (this.getDataFromOption(e[s]) == t) return n = this.isHorizontal() ? this.grid.getX() + n : this.grid.getYend() - n;
                    n += o
                }
            },
        ...
        function t(t, e, i) {
            ...
            for (var o, n, s, r, a = 0, h = d.length; h > a; a++)
                if (o = d[a].value, n = Math.ceil(e / o) * o - Math.floor(t / o) * o, Math.round(n / o) <= 1.2 * i) {
                    s = d[a].formatter, r = d[a].value;
                    break
                } return null == s && (s = "year", o = 317088e5, n = Math.ceil(e / o) * o - Math.floor(t / o) * o, r = Math.round(n / (i - 1) / o) * o), {
                formatter: s,
                gapValue: r
            }
        }
        ...
        function i(t, i) {
            ...
            var o = l(i),
                ...
                h = o.getMinutes(),
                d = o.getSeconds();
            return t = t.replace("MM", e(s)), t = t.toLowerCase(), t = t.replace("yyyy", n), t = t.replace("yy", n % 100), t = t.replace("dd", e(r)), t = t.replace("d", r), t = t.replace("hh", e(a)), t = t.replace("h", a), t = t.replace("mm", e(h)), t = t.replace("m", h), t = t.replace("ss", e(d)), t = t.replace("s", d)
        }
        ...
        function o(t, e, o, n) {
            x = n || {}, v = x.steps || z, b = x.secs || C, o = w(+o || 0) % 99, t = +t || 0, e = +e || 0, S = T = 0, "min" in x && (t = +x.min || 0, S = 1), "max" in x && (e = +x.max || 0, T = 1), t > e && (e = [t, t = e][0]);
            var s = e - t;
        ...
        function n(t, i, o, n) {
            ...
            var a = s((i - t) / o, -1),
                ...
                l = s(i, -1),
                d = L.min(a.e, h.e, l.e);
            0 === h.c ? d = L.min(a.e, l.e) : 0 === l.c && (d = L.min(a.e, h.e)), r(a, {
                c: 0,
                e: d
            }), r(h, a, 1), r(l, a), n += d, t = h.c, i = l.c;
            for (var c = (i - t) / o, p = e(n), u = 0, g = [], f = o + 1; f--;) g[f] = (t + c * f) * p;
            if (0 > n) {
        ...
        function s(o, n, s) {
            n = w(n % 10) || 2, 0 > n && (i(o) ? n = ("" + A(o)).replace(/0+$/, "").length || 1 : (o = o.toFixed(15).replace(/0+$/, ""), n = o.replace(".", "").replace(/^[-0]+/, "").length, o = +o));
            var r = E(t(o)) - n + 1,
                a = +(o * e(-r)).toFixed(15) || 0;
            return a = s ? E(a) : M(a), !a && (r = 0), ("" + A(a)).length > n && (r += 1, a /= 10), {
                c: a,
                e: r
            }
        }
        ...
        function l(t, e, o) {
            var a, l = o || +b.slice(-1),
                ...
                y = s(t, -1, 1),
                x = s(e, -1);
            if (r(m, g), r(y, g, 1), r(x, g), o ? a = c(y, x, l) : l = d(y, x), i(t) && i(e) && t * e >= 0) {
                if (l > e - t) return u(t, e, l);
                l = p(t, e, o, y, x, l)
            }
            var z = f(t, e, y.c, x.c);
            return y.c = z[0], x.c = z[1], (S || T) && _(t, e, y, x), n(y.c, x.c, l, x.e)
        }

        function d(t, i) {
            for (var o, n, s, r, a = [], l = b.length; l--;) o = b[l], n = h((i.c - t.c) / o, v), n = n.c * e(n.e), s = E(t.c / n) * n, r = M(i.c / n) * n, a[l] = {
                min: s,
                max: r,
                step: n,
                span: r - s
        ...
        function c(t, i, o) {
            for (var n, s, r = i.c, a = (i.c - t.c) / o - 1; r > t.c;) a = h(a + 1, v), a = a.c * e(a.e), n = a * o, s = M(i.c / a) * a, r = s - n;
            var l = t.c - r,
                d = s - i.c,
                c = l - d;
            return c > 1.1 * a && (c = w(c / a / 2) * a, r += c, s += c), t.c = r, i.c = s, a
        }

        function p(t, o, n, s, r, a) {
            var h = r.c - s.c,
                l = h / a * e(r.e);
            if (!i(l) && (l = E(l), h = l * a, o - t > h && (l += 1, h = l * a, !n && l * (a - 1) >= o - t && (a -= 1, h = l * a)), h >= o - t)) {
                var d = h - (o - t);
        ...
        function g(t, e, i) {
            ...
            return S ? e = t + o : T ? t = e - o : (t -= o, e += o), l(t, e, i)
        }
        ...
        function _(t, e, i, o) {
            if (S) {
                ...
                i.e - n.e > 6 && (n = {
                    c: 0,
                    e: i.e
                }), a(i, n), a(o, n), o.c += n.c - i.c, i.c = n.c
            } else if (T) {
                var r = s(e, 4);
                o.e - r.e > 6 && (r = {
                    c: 0,
                    e: o.e
                }), a(i, r), a(o, r), i.c += r.c - o.c, o.c = r.c
            }
        }
        ...
        function y(t, e, i) {
            var o = i ? [i] : b,
                a = e - t;
            if (0 === a) return e = s(e, 3), i = o[0], e.c = w(e.c + i / 2), n(e.c - i, e.c, i, e.e);
            ...
            for (var _ = o.length; _--;) {
                i = o[_], h = M(a / i), l = h * i - a, d = 3 * (l + 3), d += 2 * (i - o[0] + 2), i % 5 === 0 && (d -= 10);
                for (var y = c.length; y--;) h % c[y][0] === 0 && (d /= c[y][1]);
                u[_] = [i, h, l, d].join(), p[_] = {
                    secs: i,
                    step: h,
                    delta: l,
                    score: d
            ...
            }), p = p[0], f.c = w(f.c - p.delta / 2), m.c = w(m.c + p.delta / 2), n(f.c, m.c, p.secs, g.e)
        }
        var x, v, b, S, T, z = [10, 20, 25, 50],
            C = [4, 5, 6],
            L = Math,
            w = L.round,
            E = L.floor,
        ...
        function o() {
            u = m.logLabelBase, null == u ? (g = "plain", u = 10, f = A) : (u = +u, 1 > u && (u = 10), g = "exponent", f = z(u)), _ = m.splitNumber, null == _ && (_ = P);
            var t = parseFloat(m.dataMin),
                e = parseFloat(m.dataMax);
            isFinite(t) || isFinite(e) ? isFinite(t) ? isFinite(e) ? t > e && (e = [t, t = e][0]) : e = t : t = e : t = e = 1, p = m.logPositive, null == p && (p = e > 0 || 0 === t), x = p ? t : -e, v = p ? e : -t, I > x && (x = I), I > v && (v = I)
        }
        ...
        function n() {
            ...
            function e() {
                for (var t = i(l, 0), e = t + 2; e > t && n(t + 1) + o(t + 1) * O < r;) t++;
                for (var h = i(a, 0), e = h - 2; h > e && n(h - 1) + o(h - 1) * O > s;) h--;
                y = -(n(t) * A + o(t) * k);
                for (var d = t; h >= d; d++) {
                    var c = n(d),
                        p = o(d);
        ...
        function s() {
            for (var t = [], e = 0, i = b.length; i > e; e++) t[e] = (p ? 1 : -1) * b[e];
            !p && t.reverse();
            var o = a(),
                n = o.value2Coord,
                s = n(t[0]),
        ...
        function a() {
            ...
            return {
                value2Coord: function (i) {
                    return null == i || isNaN(i) || !isFinite(i) ? i : (i = parseFloat(i), isFinite(i) ? t && I > i ? i = I : !t && i > -I && (i = -I) : i = I, i = L(i), (t ? 1 : -1) * (z(i) + e))
                },
                coord2Value: function (i) {
                    return null == i || isNaN(i) || !isFinite(i) ? i : (i = parseFloat(i), isFinite(i) || (i = I), t ? C(M, i - e) : -C(M, -i + e))
                }
            }
        }
        ...
        var p, u, g, f, m, _, y, x, v, b, S = t("./number"),
            T = Math,
            z = T.log,
            C = T.pow,
            L = T.abs,
    ...
    }), i("echarts/util/shape/HandlePolygon", ["require", "zrender/shape/Base", "zrender/shape/Polygon", "zrender/tool/util"], function (t) {
        function e(t) {
            i.call(this, t)
        }
        var i = t("zrender/shape/Base"),
        ...
        return e.prototype = {
            ...
            isCover: function (t, e) {
                ...
                return t >= o.x && t <= o.x + o.width && e >= o.y && e <= o.y + o.height ? !0 : !1
            }
        }, n.inherits(e, i), e
        ...
        return e.prototype = {
            ...
            buildLinePath: function (t, e) {
                var i = e.x,
                    ...
                    s = e.width,
                    r = e.height / 2 - 10;
                if (t.moveTo(i, o), t.lineTo(i, o + r), t.moveTo(i + s, o), t.lineTo(i + s, o + r), t.moveTo(i, o + r / 2), e.lineType && "solid" != e.lineType) {
                    if ("dashed" == e.lineType || "dotted" == e.lineType) {
            ...
            _updateTextTransform: function (t, e) {
                ...
                if (r.identity(i), 0 !== e[0]) {
                    var o = e[1] || 0,
                        n = e[2] || 0;
                    (o || n) && r.translate(i, i, [-o, -n]), r.rotate(i, i, e[0]), (o || n) && r.translate(i, i, [o, n])
                }
    ...
    var n = e("echarts");
    return n.config = e("echarts/config"), e("echarts/chart/bar"), e("echarts/chart/line"), e("echarts/chart/pie"), e("echarts/chart/scatter"), e("echarts/chart/gauge"), e("echarts/chart/funnel"), t.echarts = n, t.zrender = o, n
}(window);