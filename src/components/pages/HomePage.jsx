                ...
                <div className="col-xs-12">
                  <div className="transaction-wraper">
                    ...
                    <span className="transaction-opration">
                      <i
                        className="fa fa-arrow-right cancelled"
                        aria-hidden="true"
                      ></i>
                    </span>
                    ...
                    <span className="transaction-opration">
                      <i
                        className="fa fa-arrow-left complete"
                        aria-hidden="true"
                      ></i>
                    </span>
                    <div className="transaction-info">
                    ...
                    <div className="col-xs-12">
                      <a href="#" className="all-transaction text-center block">
                        <strong>
                          <i className="fa fa-plus" aria-hidden="true"></i> View
                          all
                        </strong>
                      </a>
                    </div>
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <i
                              className="fa fa-plus complete normal"
                              aria-hidden="true"
                            ></i>
                            0.00113 BTC
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <i
                              className="fa fa-plus complete normal f-s-10"
                              aria-hidden="true"
                            ></i>
                            3.90244 LTC
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <i
                              className="fa fa-minus cancelled normal f-s-10"
                              aria-hidden="true"
                            ></i>
                            0.00121 LTC
                          </td>
